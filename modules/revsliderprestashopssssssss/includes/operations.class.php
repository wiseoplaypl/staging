...
public static function getWildcardsSettings()
	...
	public function getDynamicCss(){
		...
		$styles = RevSliderCssParser::parseDbArrayToCss($result, "\n");
	...
	public function previewOutput($sliderID,$output = null){
		...
		$urlPreviewPattern = $ajaxurl."&client_action=preview_slider&sliderid=".$sliderID."&lang=[lang]&nonce=[nonce]";
		//$urlPreviewPattern ='';
		...
		?>
			<html>
				<head>
					...
					<script type='text/javascript' src='<?php echo $urlPlugin; ?>js/jquery.themepunch.tools.min.js'></script>
				...
				<body style="padding:0px;margin:0px;width:100%;height:100%;position:relative;">
					...
					<?php
						...
						$current_lang = RevSliderFunctions::getPostGetVariable("lang");
                                                if($current_lang == 'all' || $current_lang == null || $current_lang == '' ){
                                                    $current_lang = RevSliderWpml::getCurrentLang(); 
                                                } 
                                               // var_dump($currentLang);die();
                                                $output->putSliderBase($sliderID, '', array(), array(), array(),$current_lang);
