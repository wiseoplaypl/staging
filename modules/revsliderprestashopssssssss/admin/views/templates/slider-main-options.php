...
<div class="wrap settings_wrap">
    ...
    <div class="settings_panel">
        <div class="settings_panel_left <?php echo 'settings_wrapper' . $settings_wrapper_class; ?>">
            <form name="form_slider_main" id="form_slider_main" onkeypress="return event.keyCode != 13;">
                ...
                <div id="content_source_sb" class="setting_box">
                    <?php
                    $headline = '<h3><span class="setting-step-number">1</span><span>' . __("Content Source", 'revslider') . '</span></h3>';
                    echo $headline;
                    ?>
                    <div class="inside" style="padding:0px;">
                        <div class="source-selector-wrapper">
                            ...
                            <span class="rs-source-selector selected">
                                ...
                                <input type="radio" id="source_type_2" value="gallery" name="source_type" <?php checked($source_type, 'gallery'); ?> />
                            ...
                            <span class="rs-source-selector">
                                ...
                                <input type="radio" id="source_type_10" value="posts" name="source_type" <?php checked($source_type, 'posts'); ?> />
                                <span class="rs-source-label">Category Based Products</span>
                            </span>
                            <span class="rs-source-selector">
                                <span class="rs-source-image rssi-post"></span>
                                <input type="radio" id="source_type_11" value="specific_posts" name="source_type" <?php checked($source_type, 'specific_posts'); ?> />
...
<?php $posts_sort_direction = UniteFunctionsRev::getVal($arrFieldsParams, 'posts_sort_direction', 'DESC'); ?>
                ...
                <div id="slider_title_sb" class="setting_box" style="background:#fff">
                    <?php
                    $headline = '<h3><span class="setting-step-number">2</span><span>' . __("Slider Title & Hook", 'revslider') . '</span></h3>';
                    echo $headline;
                    ?>
                    <div class="inside">
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery("document").ready(function () {
                            ...
                            jQuery('body').on("click", '.rs-slidertype', function () {
                                ...
                                bt.addClass("selected").find('input[name="slider-type"]').prop('checked', true);

                                if (jQuery('input[name="slider-type"]:checked').val() !== "hero" || jQuery('#ddd_parallax').prop("checked"))
                        ...
                        <script>
                            jQuery("document").ready(function () {
                                ...
                                jQuery('input[name="slider_type"]').on("change", function () {
                                    var s_fs = jQuery('#slider_type_3').prop("checked");
                                    if (s_fs) {
                                    ...
                                    var s_fs = jQuery('#slider_type_1').prop("checked");
                                ...
                                function get_preview_resp_sizes() {
                                    ...
                                    s.n = jQuery('#enable_custom_size_notebook').prop("checked");
                                    s.t = jQuery('#enable_custom_size_tablet').prop("checked");
                                    s.m = jQuery('#enable_custom_size_iphone').prop("checked");
                                ...
                                function setLayoutDesign(element, bw, bh, sw, sh, bm, ww, mm, fh, tt) {
                                    ...
                                    if (fh === 1)
                                        ...
                                        if (jQuery('#auto_height').prop("checked"))
                                ...
                                function readLayoutValues(goon) {
                                    ...
                                    if (jQuery('#slider_type_2').prop("checked") || jQuery('#slider_type_3').prop("checked")) {
                                        o.dw = 187; o.dm = 23;
                                        o.nw = 160; o.nm = 10;
                                        o.tw = 140; o.tm = 7;
                                        o.mw = 80; o.mm = 5;
                                    ...
                                    if (jQuery('#slider_type_3').prop("checked")) {
                                        o.dh = 1;
                                        o.nh = 1;
                                        o.th = 1;
                                        o.mh = 1;
                            ...
                            jQuery(document).on("ready", function () {
                                function rsSelectorFun(firsttime) {
                                    ...
                                    if (firsttime === 1) {
                                        ...
                                        if (jQuery('#force_full_width').prop("checked") && jQuery('#slider_type_1').prop("checked")) {
                                            jQuery('#slider_type_1').prop('checked', false).change();
                                            jQuery('#slider_type_2').prop('checked', true).change();
                                        }

                                        if (!jQuery('#force_full_width').prop("checked") && jQuery('#slider_type_2').prop("checked")) {
                                            jQuery('#slider_type_2').prop('checked', false).change();
                                            jQuery('#slider_type_1').prop('checked', true).change();
                                        }
                                    }

                                    // FORCE FULLWIDTH ON FULLWIDTH AND FULLSCREEN
                                    if (jQuery('#slider_type_2').prop("checked") || jQuery('#slider_type_3').prop("checked"))
                                        jQuery('#force_full_width').prop('checked', true).change();
                                    else
...
//				}
                if (!RevSliderFunctionsWP::isAdminUser()) {
                    $hidebox = 'display: none;';
                }
                ?>
        ...
        <div class="settings_panel_right">
            <script type="text/javascript">
                function drawToolBarPreview() {
                    ...
                    // MAKE ddd_IF NEEDED
                    if (jQuery('#ddd_parallax').prop("checked") && jQuery('#use_parallax').prop("checked")) {
                        punchgs.TweenLite.to(tslideprev, 0.5, {transformPerspective: 800, rotationY: 30, rotationX: 10, scale: 0.8});
                        if (jQuery('#ddd_parallax_shadow').prop("checked")) {
                    ...
                    if (jQuery('#show_background_image').prop("checked"))	// DRAWING BACKGROUND IMAGE
                    ...
                    // SHOW / HIDE ARROWS
                    if (!jQuery('#enable_arrows').prop("checked")) {
                        tla.hide();
                        tra.hide();
                    } else {
                        tla.show();
                    ...
                    // SHOW HIDE BULLETS
                    if (!jQuery('#enable_bullets').prop("checked")) {
                        tbuls.hide();
                    } else {
                        tbuls.show();
                    ...
                    if (!jQuery('#enable_thumbnails').prop("checked")) {
                        tthumbs.hide();
                    } else {
                        tthumbs.show();
                        ...
                        if (jQuery('#span_thumbnails_wrapper').prop("checked"))
                    ...
                    // SHOW HIDE TABS
                    if (!jQuery('#enable_tabs').prop("checked")) {
                        ttabs.hide();
                    } else {
                        ttabs.show();
                        ...
                        if (jQuery('#span_tabs_wrapper').prop("checked"))
                    ...
                    <div class="setting_box">
                        ...
                        <div class="inside" style="display:none;">
                            ...
                            <div id="general-misc" style="display:none">
                                ...
                                ?>
                                <!-- MULTI LANGUANGE -->
                                <span id="label_use_wpml" class="label" origtitle="<?php _e("Show multi language controls across the slider. Only available when wpml plugin exists.", 'revslider'); ?>"><?php _e("Use Multi Language", 'revslider'); ?> </span>
                    ...
                    <div class="setting_box dontshowonhero" id="navigation-settings-wrapper">
											...
											jQuery(document).ready(function() {
												...
												function checkMetis(){
													...
													if (v.indexOf('metis')>=0) {
														...
														jQuery('#span_tabs_wrapper').prop('checked',true);
							...
							<script>
								...
								jQuery('.showhidewhat_truefalse').on("change",function() {
										var sbi = jQuery(this);
										if (sbi.val() === true || sbi.val() === "true" || sbi.prop("checked")) {
...
?>
                            ...
                            <script>
                                jQuery('#carousel_stretch').on("change", function () {
                                    var sbi = jQuery(this);
                                    if (sbi.prop("checked") && jQuery('#carousel_maxitems option[value="1"]').attr("selected") === undefined) {
                                ...
                                jQuery('#carousel_maxitems').on("change", function () {
                                    if (jQuery('#carousel_stretch').prop("checked") && jQuery('#carousel_maxitems option[value="1"]').attr("selected") === undefined) {
                    ...
                    <div class="setting_box">
                        ...
                        <script>
                            ...
                            jQuery('#ddd_parallax').on("change", function () {
                                drawToolBarPreview();
                                var sbi = jQuery(this);
                                if (sbi.prop("checked") && jQuery('#use_parallax').prop("checked")) {
                                    ...
                                    jQuery('.hide_on_ddd_parallax').show();
                                    jQuery('.show_on_ddd_parallax').hide();
                                    if (jQuery('input[name="slider-type"]:checked').val() === "hero")
                                        jQuery('#fadeinoutparallax').show();
                                }
                            });
    ...
    ?>
                        ...
                        <div class="setting_box" id="v_sp_mo">
                            ...
                            <div class="inside" style="display:none;">
                                ...
                                <?php /* $seo_opti = RevSliderFunctions::getVal($arrFieldsParams, 'seo_optimization', 'none');
                                  ?>
                    ...
                    <div class="setting_box" id="phandlings">
                        ...
                        <script>
                            ...
                            if (jQuery('#jquery_debugmode').prop("checked"))
                                jQuery('#phandlings').addClass("debugmodeon");
                            else
                                jQuery('#phandlings').removeClass("debugmodeon");
                                    ...
                                    foreach ($gf as $mgf => $mgv) {
                                        ...
                                        if (!empty($mgv['slide'])) {
                                            ...
                                            foreach ($mgv['slide'] as $mgskey => $mgsval) {
                                                echo '<option value="' . self::getViewUrl(RevSliderAdmin::VIEW_SLIDE, 'id=' . $mgsval['id'] . '&slider=' . intval($sliderID)) . '">' . __('Edit:', 'revslider') . ' ' . $mgsval['title'] . '</option>';
                                            }
                                            echo '</select>';
                                        }
                  ...
                  //  var_dump($revslider_addon);die();
                    if (!empty($revslider_addon)) {
                        foreach ($revslider_addon as $addon_handle => $addon_values) {
                            ?>
                        <!-- ADDON <?php echo $addon_values['title']; ?> SETTINGS -->
                            <div class="setting_box" id="addon-settings-wrapper">
                                <h3 class="box_closed"><i class="rs-rp-accordion-icon <?php echo (isset($addon_values['icon'])) ? $addon_values['icon'] : 'eg-icon-plus-circled'; ?>"></i>
                                    <div class="setting_box-arrow"></div>
                                    <span><?php echo $addon_values['title']; ?></span>
                                </h3>
...
//									}
                                if (!RevSliderFunctionsWP::isAdminUser()) {
                                    ...
                                    ?>
                                    <form name="import_slider_form" id="rs_import_slider_form" action="<?php echo RevLoader::getConstants('ajaxurl'); ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="setting_box rs-cm-refresh" id="v_api_se">
                        ...
                        <div class="inside" style="display:none">
                            ...
                            <div id="api-events" style="display:none">
                                ...
                                <textarea class="api_area" style="height:80px;" readonly><?php echo $api ?>.bind("revolution.slide.onloaded",function (e) {
    	console.log("slider loaded");});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Slider swapped to an other slide", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:100px;" readonly><?php echo $api ?>.bind("revolution.slide.onchange",function (e,data) {
    	...
    	//data.prevslide - <?php _e('Previous Slide as jQuery Object', 'revslider'); ?>  });</textarea>
                                <h4 style="margin-top:15px"><?php _e("Slider paused", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:80px;" readonly><?php echo $api ?>.bind("revolution.slide.onpause",function (e,data) {
    	console.log("timer paused");});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Slider is Playing after pause", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:80px;" readonly><?php echo $api ?>.bind("revolution.slide.onresume",function (e,data) {
    	console.log("timer resume");});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Video is playing in slider", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:130px;" readonly><?php echo $api ?>.bind("revolution.slide.onvideoplay",function (e,data) {
    	...
    	//data.settings - <?php _e('Video Settings', 'revslider'); ?>});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Video stopped in slider", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:130px;" readonly><?php echo $api ?>.bind("revolution.slide.onvideostop",function (e,data) {
    	...
    	//data.settings - <?php _e('Video Settings', 'revslider'); ?>});</textarea>
                                ...
                                <textarea class="api_area" style=" height:80px;" readonly><?php echo $api ?>.bind("revolution.slide.onstop",function (e,data) {
    	console.log("slider stopped");});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Prepared for slide change", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:100px;" readonly><?php echo $api ?>.bind("revolution.slide.onbeforeswap",function (e) {
    	console.log("Slider Before Swap");
    	//data.currentslide - <?php _e('Current Slide as jQuery Object', 'revslider'); ?>

    	//data.nextslide - <?php _e('Coming Slide as jQuery Object', 'revslider'); ?>});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Finnished with slide change", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:100px;" readonly><?php echo $api ?>.bind("revolution.slide.onafterswap",function (e) {
    	console.log("Slider After Swap");
    	//data.currentslide - <?php _e('Current Slide as jQuery Object', 'revslider'); ?>

    	//data.previousslide - <?php _e('Previous Slide as jQuery Object', 'revslider'); ?>});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Last slide starts", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:80px;" readonly><?php echo $api ?>.bind("revolution.slide.slideatend",function (e) {
    	console.log("slide at end");});</textarea>
                                <h4 style="margin-top:15px"><?php _e("Layer Events", 'revslider') ?></h4>
                                <textarea class="api_area" style=" height:130px;" readonly><?php echo $api ?>.bind("revolution.slide.layeraction",function (e) {
            ...
            jQuery(document).ready(function ($) {
                ...
                function rs_trigger_color_picker() {
                    jQuery('.my-color-field').not('.rev-cpicker-component').tpColorPicker({
                        ...
                        change: function (inputElement, color, gradientObj) {
                            drawToolBarPreview();
                            try {
                                inputElement.closest('.placeholder-single-wrapper').find('.placeholder-checkbox').prop('checked', true);
                            } catch (e) {
                ...
                function convertAnytoRGBorRGBA(a, c) {
                    if (a === "color" || a === "color-rgba") {
                        ...
                        if (a === "color-rgba" && c.split(",").length < 4)
                            c = c + ",1";
                        ...
                        jQuery.each(sfor, function (i, sf) {
                            ...
                            jQuery.each(settings.placeholders, function (i, o) {
                                if (sf === o.handle && o["nav-type"] === "arrows") {
                                    var rwith = ""
                                    if (jQuery('input[name="ph-' + mclass + '-arrows-' + o.handle + '-' + o.type + '-def"]').prop("checked"))
                        ...
                        jQuery.each(sfor, function (i, sf) {
                            jQuery.each(settings.placeholders, function (i, o) {
                                if (sf === o.handle && o["nav-type"] === "bullets") {
                                    var rwith = "";
                                    if (jQuery('input[name="ph-' + mclass + '-bullets-' + o.handle + '-' + o.type + '-def"]').prop("checked"))
                        ...
                        jQuery.each(sfor, function (i, sf) {
                            jQuery.each(settings.placeholders, function (i, o) {
                                if (sf === o.handle && o["nav-type"] === "tabs") {
                                    var rwith = "";
                                    if (jQuery('input[name="ph-' + mclass + '-tabs-' + o.handle + '-' + o.type + '-def"]').prop("checked"))
                        ...
                        jQuery.each(sfor, function (i, sf) {
                            jQuery.each(settings.placeholders, function (i, o) {
                                if (sf === o.handle && o["nav-type"] === "thumbs") {
                                    var rwith = "";
                                    if (jQuery('input[name="ph-' + mclass + '-thumbs-' + o.handle + '-' + o.type + '-def"]').prop("checked"))
...
?>
                                    ...
                                    for (var kkey in rs_navigations[key]['settings']['placeholders']) {
                                        ...
                                        switch (m['type']) {
                                            case 'color':
                                                ...
                                                jQuery('input[name="ph-' + sel_value + '-' + type + '-' + m['handle'] + '-color-def"]').prop('checked', false);
                                            ...
                                            case 'font_family':
                                                ...
                                                jQuery('input[name="ph-' + sel_value + '-' + type + '-' + m['handle'] + '-font-family-def"]').prop('checked', false);
                                                break;
                                            case 'custom':
                                                jQuery('input[name="ph-' + sel_value + '-' + type + '-' + m['handle'] + '-custom"]').val(m['data']['custom']);
                                                jQuery('input[name="ph-' + sel_value + '-' + type + '-' + m['handle'] + '-custom-def"]').prop('checked', false);
                                                break;
                                        }
                                    }
                                }
                        ...
                        if (phpfullresets !== null && phpfullresets[sel_value] !== undefined && phpfullresets[sel_value][type] !== undefined && phpfullresets[sel_value][type][myv] !== undefined) {
                            if (phpfullresets[sel_value][type][myv]['values'] !== undefined) {
                                for (var key in phpfullresets[sel_value][type][myv]['values']) {
                                    ...
                                    jQuery('input[name="' + key + '-def"]').prop('checked',true);
                                }
                            }
                        }
                    }
                    ...
                    for (var key in navs) {
                        if (navs[key]['settings'] !== null && navs[key]['settings'] !== undefined && navs[key]['settings']['presets'] !== undefined) {
                            ...
                            for (var kkey in navs[key]['settings']['presets']) { //push values into phpfullresets
                                ...
                                if (phpfullresets[navs[key]['handle']][m['type']] == undefined)
                                    phpfullresets[navs[key]['handle']][m['type']] = {};
                ...
                jQuery('body').on('click', '.placeholder-single-wrapper input.custom-preset-val', function () {
                    if (!jQuery(this).is(":checkbox"))
                        jQuery(this).closest('.placeholder-single-wrapper').find('.placeholder-checkbox').prop('checked', true);
                    return true;
                });
...
<div class="rs-dialog-embed-slider" style="display: none;">
    <div class="revyellow"><i class="revicon-arrows-ccw"></i></div>
    <div style="margin:5px 0px; padding-left: 55px;">
			...
			<?php echo "For adding revslider into"; ?> <b><?php echo "articles"; ?></b> <?php echo "insert the shortcode:"; ?> <code class="rs-example-alias-1"></code>
