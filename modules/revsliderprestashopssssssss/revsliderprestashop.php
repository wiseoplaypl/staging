                ...
                foreach ($sliders as $slider):
                    ...
                    if (@RevsliderPrestashop::getIsset($params->template) && $params->template != 'false') {
                        ...
                        if (@RevsliderPrestashop::getIsset($params->id_shop) && $params->id_shop != Shop::getContextShopID()) {
                            ...
                            $tp = (array)$params;
                            if (@RevsliderPrestashop::getIsset($params->displayhook) && strtolower($params->displayhook) === strtolower($hookPosition)) {
                            ...
                            }elseif (@RevsliderPrestashop::getIsset($tp['displayhook']) && strtolower($tp['displayhook']) === strtolower($hookPosition)) {
                                if(_PS_VERSION_ < 1.7){
                                    RevSliderFront::rev_head_front(); 
                                }
                                $current_lang = RevSliderWpml::getCurrentLang(); 
