...
class UId
{
    ...
    public function getBuiltLangIdList()
    {
        ...
        if (self::TEMPLATE === $this->id_type) {
            ...
            $ids = array_map('intval', \Language::getLanguages(true, false, true));
        } else {
    ...
    public static function parse($id)
    {
        ...
        if (!is_numeric($id) || strlen($id = (string) $id) <= 6) {
            return false;
        }
    ...
    switch ($uid->id_type) {
        ...
        case UId::CONTENT:
            ...
            if (strpos($hook, 'shoppingcart') !== false) {
                ...
                $layouts = $GLOBALS['context']->shop->theme->get('theme_settings')['layouts'];
