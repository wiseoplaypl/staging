 ...
 *}
{if isset($CE_CMS_CATEGORY)}
	{$ce_layout=$layout}
{elseif file_exists("{$smarty.const._PS_THEME_DIR_}templates/cms/category.tpl")}
...
{if isset($CE_CMS_CATEGORY)}
	{block name='content'}<section id="content">{$CE_CMS_CATEGORY|cefilter}</section>{/block}
{else}
