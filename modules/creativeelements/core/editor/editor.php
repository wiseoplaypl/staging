    ...
    public function enqueueScripts()
    {
        ...
        */
        ...
        $config = [
            ...
            'docs_elementor_site' => __('https://docs.webshopworks.com/creative-elements'),
            'help_the_content_url' => 'https://docs.webshopworks.com/creative-elements/the-content-missing',
            'help_right_click_url' => 'https://docs.webshopworks.com/creative-elements/meet-right-click',
            'help_flexbox_bc_url' => 'https://docs.webshopworks.com/creative-elements/flexbox-layout-bc',
            'elementPromotionURL' => '',
            'dynamicPromotionURL' => '',
            ...
            'preview' => [
                'help_preview_http_error_url' => 'https://docs.webshopworks.com/creative-elements/preview-not-loaded#permissions',
                'help_preview_http_error_500_url' => 'https://docs.webshopworks.com/creative-elements/500-error',
            ...
            'i18n' => [
                ...
                'edit' => __('Edit', 'Admin.Actions'),
                'delete' => __('Delete', 'Admin.Actions'),
                'cancel' => __('Cancel', 'Admin.Actions'),
                'clear' => __('Clear'),
                'got_it' => __('Got It'),
                'tab' => __('Tab'),
                ...
                'preview_el_not_found_message' => __('You must insert the required description into the template in order to edit it with Creative Elements.'),
                'preview_el_not_found_preview' => __('Try to modify the Preview Settings, then click on [APPLY & PREVIEW]'),
                'preview_hook_not_found_message' => __('You must insert the selected module position (hook) into the template in order to edit it with Creative Elements.'),
