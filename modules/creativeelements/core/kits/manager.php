...
class CoreXKitsXManager
{
    ...
    private function addBodyClass()
    {
        $id_kit = (int) \Configuration::get(self::OPTION_ACTIVE);

        if ($id_kit) {
            $vars = &$GLOBALS['smarty']->tpl_vars;
            isset($vars['page']) && $vars['page']->value['body_classes']["ce-kit-$id_kit"] = 1;
        }
    }
    ...
    public function __construct()
    {
        ...
        // add_action('elementor/frontend/after_enqueue_styles', [$this, 'frontendBeforeEnqueueStyles'], 0);
