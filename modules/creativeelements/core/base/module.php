...
abstract class CoreXBaseXModule extends CoreXBaseXBaseObject
{
     ...
     * @param bool $custom_file
     * @param string $css_subfolder (Optional)
     *
     * @return string frontend file URL
     */
    public function getFrontendFileUrl($frontend_file_name, $custom_file, $css_subfolder = '')
    {
        if ($custom_file) {
            ...
            $frontend_file->getMeta('time') || $frontend_file->update();

            return $frontend_file->getUrl();
        }

        return _CE_ASSETS_URL_ . 'css/' . $css_subfolder . $frontend_file_name;
    }
