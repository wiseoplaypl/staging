        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-nav--dropdown a:not(#e):focus, ' .
                    '{{WRAPPER}} a.elementor-menu-toggle:not(#e):hover, ' .
                    '{{WRAPPER}} a.elementor-menu-toggle:not(#e):focus' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-nav--dropdown a.highlighted, ' .
                    '{{WRAPPER}} .elementor-nav--dropdown a:hover, ' .
                    '{{WRAPPER}} .elementor-nav--dropdown a:focus' => 'background-color: {{VALUE}}',
                ],
                'separator' => 'none',
            ]
        );
