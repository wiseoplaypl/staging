...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/88-widgets/site-widgets/364-breadcrumb-widget';
    ...
    {
        return ['shop', 'store', 'breadcrumbs', 'internal links', 'seo'];
    }
    ...
    protected function render()
    {
        ...
        <nav class="ce-breadcrumb" data-depth="<?php echo (int) $count; ?>" aria-label="<?php esc_attr_e('Breadcrumb'); ?>">
            <ol class="elementor-row">
            <?php foreach ($breadcrumb['links'] as $i => $link) { ?>
                <li class="ce-breadcrumb__item">
                <?php if ($i + 1 < $count) { ?>
                    <a href="<?php escape($link['url']); ?>"><?php echo $link['title']; ?></a>
                <?php } else { ?>
                    <span aria-current="page"><?php echo $link['title']; ?></span>
                <?php } ?>
                </li>
            <?php } ?>
            </ol>
