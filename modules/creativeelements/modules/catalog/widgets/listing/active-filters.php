...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/107-widgets/listing-widgets/425-active-filters-widget';
    ...
    protected function registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::SWITCHER,
                'selectors' => [
                    '{{WRAPPER}} .ce-active-filters' => 'flex-wrap: nowrap;',
    ...
    protected function render()
    {
        ...
        if ('' !== $settings['title_text']) {
            ...
            $this->addRenderAttribute('_container', 'aria-label', __('Active filters', 'Shop.Theme.Global'));
        } ?>
        <div class="ce-active-filters ce-scrollbar-x--auto" role="list">
        <?php foreach ($activeFilters as &$filter) { ?>
            <div class="elementor-button-wrapper" role="listitem">
                <a href="<?php escape($filter['nextEncodedFacetsURL']); ?>" class="js-search-link elementor-button elementor-size-<?php escape($settings['button_size']); ?>" role="button">
                    <span class="elementor-button-content-wrapper">
                        <span class="screen-reader-text"><?php _e('Remove', 'Shop.Theme.Actions'); ?></span>
                        <span class="elementor-button-icon elementor-align-icon-<?php escape($settings['icon_align']); ?>" aria-hidden="true"><?php echo $remove_icon; ?></span>
                        <span class="elementor-button-text"><?php echo $show_label && !empty($filter['facetLabel']) ? __('%1$s: ', 'Shop.Theme.Catalog', [$filter['facetLabel']]) : '', $filter['label']; ?></span>
                    </span>
                </a>
            </div>
        <?php } ?>
        <?php if ($settings['show_clear']) { ?>
            <div class="elementor-button-wrapper" role="listitem">
                <a href="<?php escape(Helper::getClearFiltersLink()); ?>" class="js-search-link ce-active-filters__clear elementor-button elementor-size-<?php escape($settings['button_size']); ?>" role="button">
                    <span class="elementor-button-content-wrapper">
