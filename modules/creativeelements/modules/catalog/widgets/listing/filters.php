...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/107-widgets/listing-widgets/424-filters-widget';
    ...
    {
        return ['widget-form', 'widget-listing-filters'];
    }
    ...
    protected function registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'placeholder' => \Translate::getModuleTranslation('creativeelements', 'Filters', ''),
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'placeholder' => Helper::$translator->trans('Clear all', [], 'Shop.Theme.Actions'),
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__toggle a.elementor-button:not(#e):hover, {{WRAPPER}} .ce-filters__toggle a.elementor-button:not(#e):focus' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__toggle .elementor-button:hover, {{WRAPPER}} .ce-filters__toggle .elementor-button:focus' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__toggle .elementor-button:hover, {{WRAPPER}} .ce-filters__toggle .elementor-button:focus' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addGroupControl(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ce-filters__toggle .elementor-button:hover, {{WRAPPER}} .ce-filters__toggle .elementor-button:focus',
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__toggle .elementor-button' => 'transition-duration: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__clear a.elementor-button:not(#e):hover, {{WRAPPER}} .ce-filters__clear a.elementor-button:not(#e):focus' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__clear .elementor-button:hover, {{WRAPPER}} .ce-filters__clear .elementor-button:focus' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__clear .elementor-button:hover, {{WRAPPER}} .ce-filters__clear .elementor-button:focus' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->addGroupControl(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ce-filters__clear .elementor-button:hover, {{WRAPPER}} .ce-filters__clear .elementor-button:focus',
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__clear .elementor-button' => 'transition-duration: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} [aria-expanded=true]>.ce-filters__title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .ce-filters__title:after' => 'padding-inline-start: {{SIZE}}{{UNIT}};',
                ],
                'default' => [
                    'size' => 0.2,
                    'unit' => 'em',
        ...
        $this->addControl(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .elementor-field-label:after' => 'padding-inline-start: {{SIZE}}{{UNIT}};',
                ],
                'default' => [
                    'size' => 0.2,
                    'unit' => 'em',
    ...
    {
        $facets = array_filter(Helper::getFacets(), function ($facet) {
            return $facet['displayed'];
        });
        if (!$facets) {
            return empty(${'_GET'}['q']) ? null : print '<!-- listing-filters -->';
        }
        $settings = $this->getSettingsForDisplay();
        $heading_tag = '' !== $settings['heading'] ? Utils::validateHtmlTag($settings['heading_tag']) : '';
        ...
        if ($heading_tag) {
            $this->addRenderAttribute('heading', [
                'class' => 'elementor-heading-title',
                'id' => $heading_id = 'ce-filters__heading-' . $this->getId(),
            ]);
        ...
        <dialog <?php $this->printRenderAttributeString('container'); ?> role="form" tabindex="-1" aria-label="<?php escape($settings['heading'] ?: __('Filters')); ?>">
            <div class="ce-filters ce-scrollbar-y--auto">
                <i class="dialog-lightbox-close-button ceicon-close" role="button" tabindex="0" aria-label="<?php esc_attr_e('Close', 'Shop.Theme.Global'); ?>"></i>
                <?php $heading_tag && print "<$heading_tag {$this->getRenderAttributeString('heading')}>$settings[heading]</$heading_tag>"; ?>
            <?php if ($settings['show_clear'] && !empty(${'_GET'}['q']) && $clear_all_link = Helper::getClearFiltersLink()) { ?>
                <div class="ce-filters__clear<?php $settings['clear_type'] && escape(' elementor-button-' . $settings['clear_type']); ?>">
                    <a href="<?php escape($clear_all_link); ?>" class="js-search-link elementor-button elementor-size-<?php escape($settings['clear_size']); ?>" role="button">
                        <span class="elementor-button-content-wrapper">
                        <?php if (!empty($settings['clear_icon']['value'])) { ?>
                            <span class="elementor-button-icon elementor-align-icon-<?php escape($settings['clear_icon_align']); ?>" aria-hidden="true"><?php IconsManager::renderIcon($settings['clear_icon']); ?></span>
                        <?php } ?>
            ...
            <?php foreach ($facets as &$facet) {
                ...
                <div class="elementor-field-group elementor-field-type-<?php echo esc_attr($facet['widgetType']), $is_color ? ' elementor-field-type-color' : ''; ?>">
                    <<?php Utils::printValidatedHtmlTag($settings['title_tag']); ?> class="<?php escape($title_class); ?>" data-type="<?php escape($facet_type); ?>" tabindex="0" role="button" aria-expanded="<?php echo $is_active ? 'true' : 'false'; ?>">
                        <span class="ce-filters__title" data-count="<?php echo (int) $active_count; ?>"><?php echo $facet['label']; ?></span>
                    ...
                    <div class="elementor-field-subgroup ce-scrollbar-y--auto" role="region" aria-hidden="<?php echo $is_active ? 'false' : 'true'; ?>">
        ...
        <div class="ce-filters__toggle<?php $settings['toggle_type'] && escape(' elementor-button-' . $settings['toggle_type']); ?>">
            <a href="#ce-action=toggle&target=filters" class="elementor-button elementor-size-<?php escape($settings['toggle_size']); ?>" role="button" aria-expanded="false">
                <span class="elementor-button-content-wrapper">
                <?php if (!empty($settings['toggle_icon']['value'])) { ?>
                    <span class="elementor-button-icon elementor-align-icon-<?php escape($settings['toggle_icon_align']); ?>" aria-hidden="true"><?php IconsManager::renderIcon($settings['toggle_icon']); ?></span>
                <?php } ?>
    ...
    protected function renderDropdown(array &$facet)
    {
        ...
        <div class="elementor-select-wrapper">
            <select class="elementor-field elementor-field-textual elementor-size-<?php escape($this->getSettings('select_size')); ?>">
                <option value="" data-url="<?php escape($this->getActiveFilterUrl($facet['filters'])); ?>"><?php _e('(no filter)', 'Shop.Theme.Global'); ?></option>
            <?php foreach ($facet['filters'] as &$filter) { ?>
                <option value="<?php echo (int) $filter['value']; ?>" data-url="<?php escape($filter['nextEncodedFacetsURL']); ?>"<?php $filter['active'] && print ' selected'; ?>>
                    <?php echo esc_html($show_magnitude ? "$filter[label] ($filter[magnitude])" : $filter['label']); ?>
                </option>
            <?php } ?>
            </select>
        </div>
    ...
    protected function renderSlider(array &$facet)
    {
        ...
        $this->setRenderAttribute('range', 'style', 'left: ' . max(0, ($min_value - $min) / ($max - $min) * 100) . '%;');
        $this->addRenderAttribute('range', 'style', 'right: ' . max(0, ($max - $max_value) / ($max - $min) * 100) . '%;');
        ?>
        <div class="ce-dual-range" data-label="<?php escape($facet['label']); ?>" data-unit="<?php escape($facet['properties']['unit']); ?>"
            data-url="<?php escape($filter['nextEncodedFacetsURL']); ?>" data-specifications="<?php escape(json_encode($specs)); ?>">
            <div class="ce-dual-range__selected" <?php $this->printRenderAttributeString('range'); ?>></div>
            <input type="range" class="ce-dual-range__min" min="<?php echo (float) $min; ?>" max="<?php echo (float) $max; ?>" step="<?php echo (float) $step; ?>" value="<?php echo (float) $min_value; ?>" aria-label="<?php esc_attr_e('Minimum', 'Shop.Theme.Checkout'); ?>" aria-valuetext="<?php escape($filter_label[0]); ?>">
            <input type="range" class="ce-dual-range__max" min="<?php echo (float) $min; ?>" max="<?php echo (float) $max; ?>" step="<?php echo (float) $step; ?>" value="<?php echo (float) $max_value; ?>" aria-label="<?php esc_attr_e('Max'); ?>" aria-valuetext="<?php escape($filter_label[1]); ?>">
        </div>
        <span class="elementor-field-label" aria-hidden="true">
            <span><?php echo $filter_label[0]; ?></span> - <span><?php echo $filter_label[1]; ?></span>
        </span>
        <?php
    }
    ...
    protected function renderOptions(array &$facet)
    {
        foreach ($facet['filters'] as &$filter) {
            ...
            $this->removeRenderAttribute('icon', 'style');
            $this->setRenderAttribute('icon', 'class', 'checkbox' === $type || $filter['properties'] ? 'ce-checkbox ceicon ceicon-check' : 'ce-radio');

            if (isset($filter['properties']['color'])) {
                self::isColorLight($filter['properties']['color']) && $this->addRenderAttribute('icon', 'class', 'ce-color--light');
                $this->addRenderAttribute('icon', 'style', 'background-color:' . $filter['properties']['color'], true);
            } elseif (isset($filter['properties']['texture'])) {
                $texture = $filter['properties']['texture'];
                $this->addRenderAttribute('icon', 'style', 'background-image:url' . "($texture)", true);
            } ?>
            <a href="<?php escape($filter['nextEncodedFacetsURL']); ?>" rel="nofollow" class="elementor-field-option js-search-link" role="<?php escape($type); ?>" aria-checked="<?php echo $filter['active'] ? 'true' : 'false'; ?>">
                <input type="<?php escape($type); ?>"<?php $filter['active'] && print ' checked'; ?> hidden>
                <i <?php $this->printRenderAttributeString('icon'); ?> aria-hidden="true"></i>
                <span class="elementor-field-label" data-magnitude="<?php echo (int) $filter['magnitude']; ?>">
                    <?php echo $filter['label']; ?><span class="screen-reader-text"><?php _e('%count% items', 'Shop.Theme.Checkout', ['%count%' => $filter['magnitude']]); ?></span>
                </span>
            </a>
            <?php
        }
