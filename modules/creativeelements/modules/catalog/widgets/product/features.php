...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/89-widgets/product-widgets/379-product-features-widget';
    ...
    protected function render()
    {
        ...
        if ('' !== $settings['title']) {
            ...
            $this->addRenderAttribute('title', [
                ...
                'id' => $title_id = 'ce-product-features__title-' . $this->getId(),
            ]);
            ...
            $this->addRenderAttribute('table', 'aria-labelledby', $title_id);
        } else {
            $this->addRenderAttribute('table', 'aria-label', __('Product Features'));
        } ?>
        <table class="ce-product-features" <?php $this->printRenderAttributeString('table'); ?>>
    ...
    public function renderSmarty()
    {
        ...
        <table class="ce-product-features"<?php '' === $settings['title'] && print ' aria-label="{CE\__(\'Product Features\')}"'; ?>>
