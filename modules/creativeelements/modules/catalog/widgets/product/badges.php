...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/89-widgets/product-widgets/366-product-badges-widget';
    ...
    protected function registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::TEXT,
                'placeholder' => Helper::$translator->trans('On sale!', [], 'Shop.Theme.Catalog'),
                'conditions' => [
                    'terms' => [
                        [
                            'name' => 'badges',
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ce-product-badges' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <?php foreach ($badges as $badge => $label) { ?>
            <div class="ce-product-badge ce-product-badge-<?php escape($badge); ?>"><?php echo $label; ?></div>
        <?php } ?>
        </div>
        <?php
    }
    ...
    protected function renderSmarty()
    {
        ...
        <?php foreach ($settings['badges'] as $badge) { ?>
            {if !empty($product.flags[<?php var_export($this->flags[$badge]); ?>])}
                <div class="ce-product-badge ce-product-badge-<?php echo $badge; ?>">
                    <?php echo $settings[$badge . '_text'] ?: '{$product.flags[' . var_export($this->flags[$badge], true) . '].label}'; ?>
                </div>
            {/if}
        <?php } ?>
        </div>
