...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/89-widgets/product-widgets/368-product-image-widget';
    ...
    protected function registerControls()
    {
        ...
        $this->updateControl('section_style_caption', [
            'condition' => [
                'show_caption!' => '',
            ],
        ]);
    ...
    protected function render()
    {
        ...
        $imageBySize = &$image['bySize'][$settings['image_size']];
