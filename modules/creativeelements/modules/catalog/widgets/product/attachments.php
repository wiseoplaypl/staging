...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/89-widgets/product-widgets/382-product-attachments-widget';
    ...
    {
        return ['widget-icon-box', 'widget-product'];
    }
    ...
    protected function render()
    {
        ...
        if ('' !== $settings['title_text']) {
            $this->addRenderAttribute('title_text', [
                ...
                'id' => $title_id = 'ce-attachments__title-' . $this->getId(),
            ]);
            ...
            ?>
            <<?php Utils::printValidatedHtmlTag($settings['title_size']); ?> <?php $this->printRenderAttributeString('title_text'); ?>>
            ...
            $this->addRenderAttribute('_container', 'aria-label', __('Attachments', 'Shop.Theme.Catalog'));
        }
        foreach ($product['attachments'] as $attachment) {
            ...
            <?php if ($icon) { ?>
                <div class="elementor-icon-box-icon" aria-hidden="true">
                    <a <?php $this->printRenderAttributeString('icon'); ?> href="<?php escape($url); ?>" tabindex="-1"><?php echo $icon; ?></a>
                </div>
            <?php } ?>
                <div class="elementor-icon-box-content">
                    <a class="elementor-icon-box-title" href="<?php escape($url); ?>"><?php echo $attachment['name']; ?></a>
