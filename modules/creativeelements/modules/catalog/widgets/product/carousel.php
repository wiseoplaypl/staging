...
class ModulesXCatalogXWidgetsXProductXCarousel extends ProductBase
{
    ...
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/105-widgets/catalog-widgets/326-product-carousel-widget';
    ...
    {
        return ['swiper', 'widget-image-carousel', 'widget-product-box'];
    }
    ...
    protected function registerControls()
    {
        ...
        $this->addResponsiveControl(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .swiper:not(.swiper-initialized) .swiper-wrapper' => 'column-gap: {{SIZE}}{{UNIT}};',
                ],
