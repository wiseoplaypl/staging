...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/87-widgets/premium-widgets/323-call-to-action-widget';
    ...
    protected function registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-button:not(#e)' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'type' => ControlsManager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-button:not(#e):hover, {{WRAPPER}} .elementor-button:not(#e):focus' => 'color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <<?php Utils::printValidatedHtmlTag($wrapper_tag); ?> <?php $this->printRenderAttributeString('wrapper'); ?>>
        <?php if ($print_bg) { ?>
        ...
        <?php if ($print_content) { ?>
            ...
            <?php if ('' !== $settings['title']) { ?>
                <<?php Utils::printValidatedHtmlTag($title_tag); ?> <?php $this->printRenderAttributeString('title'); ?>>
            ...
            <?php if ('' !== $settings['button']) { ?>
                <div class="elementor-cta-button-wrapper elementor-content-item <?php escape($animation['class']); ?>">
                    <<?php Utils::printValidatedHtmlTag($btn_tag); ?> <?php $this->printRenderAttributeString('btn'); ?>>
                    ...
                    </<?php Utils::printValidatedHtmlTag($btn_tag); ?>>
                </div>
            <?php } ?>
            </div>
        <?php } ?>
    ...
    protected function contentTemplate()
    {
        ...
        <# if ( printContent ) { #>
            ...
            <# } #>
            <# if ( settings.title ) { #>
                <{{{ elementor.helpers.validateHTMLTag(settings.title_tag) }}} {{{ view.getRenderAttributeString( 'title' ) }}}>
                    {{{ settings.title }}}
