...
class ModulesXPremiumXWidgetsXTrustedshopsReviews extends WidgetBase
{
    ...
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/87-widgets/premium-widgets/332-truestedshops-reviews-widget';
    ...
    {
        return ['swiper', 'widget-image-carousel', 'widget-trustedshops-reviews'];
    }
    ...
    protected function render()
    {
        ...
        $star = '<i class="ceicon-star" aria-hidden="true"></i>';
        $unstar = '<i class="ceicon-' . esc_attr($settings['rating_unmarked_style']) . ' elementor-unmarked-star" aria-hidden="true"></i>';
        $slides = [];
        ...
        foreach ($reviews as &$review) {
            ...
            if ($rating >= (int) $settings['min_rating'] && (!$hide_empty || $review['comment'])) {
                ...
                <div class="swiper-slide" role="group" aria-roledescription="slide">
                    <article class="elementor-trustedshops-review">
                        <div class="elementor-trustedshops-reviews-header">
                            <time class="elementor-trustedshops-reviews-date" datetime="<?php escape($review['changeDate']); ?>">
                                <?php echo date($date_format, strtotime($review['changeDate'])); ?>
                            </time>
                            <div class="elementor-trustedshops-reviews-stars" role="img" aria-label="<?php escape("$rating/5 " . __('Stars')); ?>">
