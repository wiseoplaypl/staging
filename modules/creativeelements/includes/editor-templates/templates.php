    ...
    <div class="elementor-template-library-template-controls elementor-template-library-local-column-5">
        ...
        <div class="elementor-template-library-template-more">
            ...
            <div class="elementor-template-library-template-delete">
                ...
                <span class="elementor-template-library-template-control-title"><?php _e('Delete', 'Admin.Actions'); ?></span>
            </div>
        </div>
    </div>
</script>
...
<script type="text/template" id="tmpl-elementor-template-library-get-pro-button">
    <a class="elementor-template-library-template-action elementor-button elementor-button-go-pro" href="<?php escape(Helper::getSettingsLink()); ?>#license">
...
<script type="text/template" id="tmpl-elementor-template-library-connect">
    ...
    <?php foreach (['left-1', 'left-2', 'right-1', 'right-2'] as $image) { ?>
        <img id="elementor-template-library-connect__background-image-<?php escape($image); ?>" class="elementor-template-library-connect__background-image" src="<?php escape(_CE_ASSETS_URL_ . 'img/library-connect/' . $image); ?>.png" draggable="false">
    <?php } ?>
</script>
