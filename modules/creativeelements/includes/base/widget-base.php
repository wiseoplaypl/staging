...
abstract class WidgetBase extends ElementBase
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        if ($is_type_instance) {
            if (method_exists($this, '_registerSkins')) {
                @trigger_error(get_called_class() . '::_registerSkins is deprecated since version 2.14 Use registerSkins instead.', E_USER_DEPRECATED);
