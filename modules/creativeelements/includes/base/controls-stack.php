...
abstract class ControlsStack extends BaseObject
{
     ...
     * until you close the section using `endControlsSection()` method.
     *
     * This method should be used inside `registerControls()`.
     *
     * @since 1.4.0
     ...
     * method before adding new individual tabs using `startControlsTab()`.
     * Each tab added after this point will be assigned to this group of tabs,
     * until you close it using `endControlsTabs()` method.
     *
     * This method should be used inside `registerControls()`.
     *
     * @since 1.4.0
     ...
     * adding new individual tabs using `startControlsTab()`.
     * Each tab added after this point will be assigned to this group of tabs,
     * until you close it using `endControlsTab()` method.
     *
     * This method should be used inside `registerControls()`.
     *
     * @since 1.4.0
    ...
    public function printTemplate()
    {
        ...
        <script type="text/html" id="tmpl-elementor-<?php escape($this->getName()); ?>-content">
     ...
     * injection using `endInjection()` method.
     *
     * @since 1.7.1
     *
     ...
     *
     * Should be inherited and register new controls using `addControl()`,
     * `addResponsiveControl()` and `addGroupControl()`, inside control
     * wrappers like `startControlsSection()`, `startControlsTabs()` and
     * `startControlsTab()`.
     *
     * @since 1.4.0
     */
     ...
     * Initialize controls.
     *
     * Register all controls added by `registerControls()`.
     *
     * @since 2.0.0
     */
