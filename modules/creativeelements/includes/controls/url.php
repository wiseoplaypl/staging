    ...
    public function contentTemplate()
    {
        ...
        <div class="elementor-control-field elementor-control-url-external-{{{ data.options.length ? 'show' : 'hide' }}}">
            ...
            <div class="elementor-control-input-wrapper elementor-control-dynamic-switcher-wrapper">
                ...
                <input id="<?php escape($control_uid); ?>" class="elementor-control-tag-area elementor-input" data-setting="url" placeholder="{{ data.placeholder }}">
                <div class="elementor-control-url-more tooltip-target elementor-control-unit-1" data-tooltip="<?php esc_attr_e('Link Options'); ?>">
                    <i class="eicon-cog" aria-hidden="true"></i>
                </div>
            </div>
            <div class="elementor-control-url-more-options">
                <div class="elementor-control-url-option">
                    <input id="<?php escape($is_external_control_uid); ?>" type="checkbox" class="elementor-control-url-option-input" data-setting="is_external">
                    <label for="<?php escape($is_external_control_uid); ?>"><?php _e('Open in new window'); ?></label>
                </div>
                <div class="elementor-control-url-option">
                    <input id="<?php escape($nofollow_control_uid); ?>" type="checkbox" class="elementor-control-url-option-input" data-setting="nofollow">
                    <label for="<?php escape($nofollow_control_uid); ?>"><?php _e('Add nofollow'); ?></label>
                </div>
                <div class="elementor-control-url__custom-attributes">
                    <label for="<?php escape($custom_attributes_uid); ?>" class="elementor-control-url__custom-attributes-label"><?php _e('Custom Attributes'); ?></label>
                    <input type="text" id="<?php escape($custom_attributes_uid); ?>" class="elementor-control-unit-5" placeholder="key|value,key|value..." data-setting="custom_attributes">
                </div>
            </div>
        </div>
        <# if ( data.description ) { #>
