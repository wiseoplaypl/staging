    ...
    public function contentTemplate()
    {
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-input-wrapper elementor-control-unit-5 elementor-control-dynamic-switcher-wrapper">
                <input id="<?php escape($control_uid); ?>" class="elementor-date-time-picker elementor-control-tag-area flatpickr" type="text" placeholder="{{ data.placeholder }}" data-setting="{{ data.name }}">
            </div>
        </div>
        <# if ( data.description ) { #>
