    ...
    public function contentTemplate()
    {
        ...
        <div class="elementor-control-field">
            ...
            <# if ( morePresets.length ) { #>
                ...
                <# _.each( morePresets, function( preset ) { #>
                    <div class="elementor-control-structure-preset-wrapper">
                        <input id="<?php escape($preset_control_uid); ?>" type="radio" data-setting="structure" name="elementor-control-structure-preset-{{ data._cid }}" value="{{ preset.key }}">
                        <label for="<?php escape($preset_control_uid); ?>" class="elementor-control-structure-preset">
            ...
            <div class="elementor-control-structure-reset">
                <i class="eicon-undo" aria-hidden="true"></i> <?php _e('Reset'); ?>
            </div>
        </div>
        <# if ( data.description ) { #>
