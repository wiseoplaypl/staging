        ...
        <div class="elementor-control-field elementor-control-inline-icon">
            ...
            <div class="elementor-control-input-wrapper">
                ...
                <# if ( ! data.exclude_inline_options.includes( 'none' ) ) { #>
                    <input id="<?php escape($control_uid); ?>-none" type="radio" value="none">
                    <label class="elementor-choices-label elementor-control-unit-1 tooltip-target elementor-control-icons--inline__none" for="<?php escape($control_uid); ?>-none" data-tooltip="<?php esc_attr_e('None'); ?>" title="<?php esc_attr_e('None'); ?>">
                ...
                if ( ! data.exclude_inline_options.includes( 'svg' ) ) { #>
                    <input id="<?php escape($control_uid); ?>-svg" type="radio" value="svg">
                    <label class="elementor-choices-label elementor-control-unit-1 tooltip-target elementor-control-icons--inline__svg" for="<?php escape($control_uid); ?>-svg" data-tooltip="<?php esc_attr_e('Upload SVG'); ?>" title="<?php esc_attr_e('Upload SVG'); ?>">
                ...
                if ( ! data.exclude_inline_options.includes( 'icon' ) ) { #>
                    <input id="<?php escape($control_uid); ?>-icon" type="radio" value="icon">
                    <label class="elementor-choices-label elementor-control-unit-1 tooltip-target elementor-control-icons--inline__icon" for="<?php escape($control_uid); ?>-icon" data-tooltip="<?php esc_attr_e('Icon Library'); ?>" title="<?php esc_attr_e('Icon Library'); ?>">
