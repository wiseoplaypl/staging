...
class Plugin
{
    ...
    {
        $installed_time = (int) \ConfigurationKPI::getGlobalValue('_elementor_installed_time');

        if (!$installed_time) {
            $installed_time = time();

            \ConfigurationKPI::updateGlobalValue('_elementor_installed_time', $installed_time);
        }
