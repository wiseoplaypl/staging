...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/85-widgets/basic-widgets/296-video-widget';
        ...
        */
        ...
        $this->addControl(
            ...
            [
                ...
                'description' => sprintf(
                    '%1$s <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video#preload">%2$s</a>',
                    __('Preload attribute lets you specify how the video should be loaded when the page loads.'),
                    __('Learn more')
                ),
                'default' => 'metadata',
                'condition' => [
    ...
    protected function render()
    {
        ...
        if (!empty($settings['image_overlay']['url'])) {
            ...
            <?php if ($settings['show_play_icon']) { ?>
                <div class="elementor-custom-embed-play" role="button" tabindex="0" aria-label="<?php esc_attr_e('Play Video'); ?>">
