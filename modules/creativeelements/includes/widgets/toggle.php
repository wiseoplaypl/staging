...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/86-widgets/general-widgets/312-toggle-widget';
        ...
        <?php foreach ($settings['tabs'] as $index => &$item) {
            ...
            <div class="elementor-toggle-item">
                ...
                <?php if ($icon = IconsManager::getBcIcon($settings, 'icon', ['class' => 'elementor-toggle-icon-closed'])) { ?>
                    <span class="elementor-toggle-icon elementor-toggle-icon-<?php escape($settings['icon_align']); ?>" aria-hidden="true">
                        <?php echo $icon, IconsManager::getBcIcon($settings, 'icon_active', ['selected' => 'selected_active_icon', 'class' => 'elementor-toggle-icon-opened']); ?>
                    </span>
                <?php } ?>
                    <a href="javascript://toggle" class="elementor-toggle-title<?php escape($display_class); ?>"><?php echo $item['tab_title']; ?></a>
    ...
    protected function contentTemplate()
    {
        ...
        _.each( settings.tabs, function( item, index ) {
            ...
            #>
            <div class="elementor-toggle-item">
                <{{{ settings.title_html_tag }}} {{{ view.getRenderAttributeString( tabTitleKey ) }}} role="button">
                ...
                <# } #>
                    <a href="javascript://toggle" class="elementor-toggle-title ce-display-{{ settings.title_display }}">{{{ item.tab_title }}}</a>
