...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/85-widgets/basic-widgets/302-icon-widget';
    ...
    protected function render()
    {
        ...
        <<?php Utils::printValidatedHtmlTag($icon_tag); ?> <?php $this->printRenderAttributeString('icon-wrapper'); ?>>
            <?php echo IconsManager::getBcIcon($settings, 'icon', ['aria-hidden' => 'true']); ?>
        </<?php Utils::printValidatedHtmlTag($icon_tag); ?>>
        <?php
    }
