...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/85-widgets/basic-widgets/299-spacer-widget';
    ...
    {
        if (!$this->getSettings('space')['size']) {
            return;
        } ?>
