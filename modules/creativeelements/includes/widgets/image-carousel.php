...
class WidgetImageCarousel extends WidgetBase
{
    ...
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/86-widgets/general-widgets/306-image-carousel-widget';
    ...
    protected function render()
    {
        ...
        foreach ($settings['carousel'] as $index => &$item) {
            ...
            $slide_html = '<div class="swiper-slide" role="group" aria-roledescription="slide">' . $link_tag .
