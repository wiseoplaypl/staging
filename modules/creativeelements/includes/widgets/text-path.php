...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/86-widgets/general-widgets/354-text-path-widget';
    ...
    protected function render()
    {
        ...
        $start_offset = $is_rtl ? 100 - $settings['start_point']['size'] : $settings['start_point']['size'];
        ...
        <svg <?php $this->printRenderAttributeString('svg'); ?>>
            ...
            <text>
                <textPath href="#<?php escape($path_id); ?>" startOffset="<?php echo (int) $start_offset; ?>%">
                <?php if ($has_link) { ?>
                    <a <?php $this->getRenderAttributeString('link'); ?>><?php escape($settings['text']); ?></a>
                <?php } else { ?>
                    <?php escape($settings['text']); ?>
                <?php } ?>
                </textPath>
            </text>
        </svg>
