...
{
    const HELP_URL = 'https://docs.webshopworks.com/creative-elements/85-widgets/basic-widgets/298-divider-widget';
    ...
    protected function render()
    {
        ...
        $svg_code && $this->addRenderAttribute('wrapper', 'style', '--divider-pattern-url: url' .
            '("data:image/svg+xml,' . $this->svgToDataUri($svg_code) . '");');
        ?>
        <div <?php $this->printRenderAttributeString('wrapper'); ?>>
            ...
            <?php } elseif ($has_text) {
                ...
                <<?php Utils::printValidatedHtmlTag($settings['html_tag']); ?> <?php $this->printRenderAttributeString('text'); ?>>
                    <?php echo $settings['text']; ?>
                </<?php Utils::printValidatedHtmlTag($settings['html_tag']); ?>>
            <?php } ?>
            </span>
        </div>
        <?php
