...
use CE\CoreXCommonXModulesXConnectXAppsXLibrary as Library;
...
class Api
{
     ...
     */
    public static $api_info_url = 'https://pagebuilder.webshopworks.com/?api=2&info';
     ...
     */
    private static $api_get_template_content_url = 'https://pagebuilder.webshopworks.com/?api=2&template=%d';
    ...
    private static function getInfoData($force_update = false)
    {
        ...
        if ($force_update || false === $info_data) {
            ...
            if (isset($info_data['latest_version'])) {
                \ConfigurationKPI::updateGlobalValue('CE_LATEST_VERSION', $info_data['latest_version']);
    ...
    {
        add_action('wp_ajax_elementor_reset_library', [__CLASS__, 'ajaxResetApiData']);
    }
}
