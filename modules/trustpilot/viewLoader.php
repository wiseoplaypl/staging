...
class TrustpilotViewLoader
{
    ...
    public function getPageUrls()
    {
        ...
        try {
            ...
            $message = 'Unable to get category link';
        ...
        try {
            ...
            $message = 'Unable to get product link';
            Logger::addLog($message . ' Error: ' . $e->getMessage(), 2);
            Module::getInstanceByName('trustpilot')->logError($e, $message);
        } catch (\Exception $e) {
            $message = 'Unable to get product link';
        ...
        try {
            $landinglink = $this->context->link->getPageLink('index', true);
        } catch (\Throwable $e) {
            $message = 'Unable to get landing page link';
            Logger::addLog($message . ' Error: ' . $e->getMessage(), 2);
            Module::getInstanceByName('trustpilot')->logError($e, $message);
        } catch (\Exception $e) {
            $message = 'Unable to get landing page link';
