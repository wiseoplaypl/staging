                ...
                <div class="amount-wrapper-container table-wrapper {if !$capture.captured_by_amount}d-none{/if}">
                    ...
                    <div class="modal-body modal-body-wrapper">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   ...
                                   value="{$klarnaPaymentOrder.remainingRefundAmount|escape:'htmlall':'UTF-8'}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="action action-btn">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='klarnapayment'}</button>
                                <button type="submit" class="btn btn-primary js-klarnapayment-refund-order submit-order-amount" name="refund-order-amount">{l s='Refund' mod='klarnapayment'}</button>
                            </div>
                        </div>
                    </div>
                </div>
