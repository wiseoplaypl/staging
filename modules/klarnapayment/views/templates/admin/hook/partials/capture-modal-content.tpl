                ...
                <div class="amount-wrapper-container table-wrapper {if !$klarnaPaymentOrder.isZeroComputingPrecision}d-none{/if}">
                    ...
                    <div class="modal-body modal-body-wrapper">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   ...
                                   value="{$klarnaPaymentOrder.remainingCaptureAmount|escape:'htmlall':'UTF-8'}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="action action-btn">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='klarnapayment'}</button>
                                <button type="submit" class="btn btn-primary submit-order-amount js-klarnapayment-capture-order" name="capture-order-amount">{l s='Capture' mod='klarnapayment'}</button>
                            </div>
                        </div>
                    </div>
                </div>
