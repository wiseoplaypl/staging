        ...
        <div class="panel card">
            ...
            <div class="card-body order-management-content">
                ...
                {if $klarnaPaymentOrder.canInteract}
                    ...
                    <div class="row">
                        {if $klarnaPaymentOrder.canReleaseRemainingAuthorization}
                            <div class="col-lg-12">
                                <form id="klarnapayment-admin-form-release" method="post"
                                      action="{$klarnaPaymentOrder.action|escape:'htmlall':'UTF-8'}">
                                    <div class="button-container">
                                        <button class="btn btn-warning w-100 text-uppercase outline-black js-klarnapayment-release-remaining-authorization"
                                                type="submit"
                                                name="release-remaining-authorization">{l s='Release remaining authorization' mod='klarnapayment'} ({$klarnaPaymentOrder.remainingCaptureAmountFormatted|escape:'htmlall':'UTF-8'})</button>
                                    </div>
                                </form>
                            </div>
                        {/if}
