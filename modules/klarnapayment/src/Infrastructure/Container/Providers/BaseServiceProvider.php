...
use KlarnaPayment\Module\Core\Order\Action\UpdateAuthorizationAction;
...
use KlarnaPayment\Module\Core\Payment\Api\Repository\MerchantRepositoryInterface;
...
final class BaseServiceProvider extends AbstractServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->container->add(UpdatePaymentSessionRequestProvider::class, UpdatePaymentSessionRequestProvider::class)
            ->addArgument(PaymentSessionProvider::class);

        $this->container->add(UpdatePaymentSessionAction::class, UpdatePaymentSessionAction::class)
            ->addArgument(LoggerInterface::class)
            ->addArgument(SessionApiRepositoryInterface::class)
            ->addArgument(UpdatePaymentSessionRequestProvider::class);

        $this->container->add(UpdateAuthorizationRequestProvider::class, UpdateAuthorizationRequestProvider::class);

        $this->container->add(UpdateAuthorizationAction::class, UpdateAuthorizationAction::class)
            ->addArgument(LoggerInterface::class)
            ->addArgument(OrderApiRepositoryInterface::class)
            ->addArgument(UpdateAuthorizationRequestProvider::class);

        $this->container->add(UpdateOrderAuthorizationAction::class, UpdateOrderAuthorizationAction::class)
            ->addArgument(LoggerInterface::class)
            ->addArgument(KlarnaPaymentOrderRepositoryInterface::class)
            ->addArgument(GlobalShopContextInterface::class)
            ->addArgument(UpdateAuthorizationAction::class);

        $this->container->add(ActionOrderEditedHook::class, ActionOrderEditedHook::class)
            ->addArgument(LoggerInterface::class)
            ->addArgument(UpdateOrderAuthorizationAction::class)
            ->addArgument(KlarnaPaymentOrderRepositoryInterface::class)
            ->addArgument(GlobalShopContextInterface::class);
    }
}
