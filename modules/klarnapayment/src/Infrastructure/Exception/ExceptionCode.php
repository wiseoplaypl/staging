...
class ExceptionCode
{
    ...
    // Cart related codes starts from 4***
    public const CART_NOT_FOUND = 4001;
    public const CART_UNKNOWN_ERROR = 4002;
    ...
    public const NO_REMAINING_AUTHORIZATION = 7013;
    public const ORDER_UPDATE_AUTHORIZATION_FAILED = 7014;
    public const ORDER_UPDATE_AUTHORIZATION_REQUEST_CREATION_FAILED = 7015;
    public const ORDER_UPDATE_AUTHORIZATION_UNKNOWN_ERROR = 7016;
    public const ORDER_NOT_FOUND = 7017;
    ...
    public const MERCHANT_TYPE_SAVE_EXCEPTION = 9003;
}
