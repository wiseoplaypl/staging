...
class OrderManagementTemplateParameterBuilder implements TemplateParameterBuilderInterface
{
    ...
    /** @var CanReleaseRemainingAuthorization */
    ...
    public function buildParams(): array
    {
        ...
        try {
            $canReleaseRemainingAuthorization = $this->canReleaseRemainingAuthorization->verify($order);
        } catch (CouldNotVerifyOrderAction $exception) {
            $canReleaseRemainingAuthorization = false;
        }
        ...
        return [
            ...
            'canInteract' => $canRefund || $canCapture || $canCancel || $canReleaseRemainingAuthorization,
            'canRefund' => $canRefund,
