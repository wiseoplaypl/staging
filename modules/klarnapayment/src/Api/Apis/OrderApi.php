...
class OrderApi extends BaseApi
{
     ...
     * @throws ApiException
     */
    public function releaseRemainingAuthorization(ReleaseRemainingAuthorizationRequest $body): ApiResponse
    {
        $queryParameters = '/ordermanagement/v1/orders/{order_id}/release-remaining-authorization';
     ...
     * @throws ApiException
     */
    public function updateAuthorization(UpdateAuthorizationRequest $body): ApiResponse
    {
        $queryParameters = '/ordermanagement/v1/orders/{order_id}/authorization';
