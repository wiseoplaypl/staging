...
use KlarnaPayment\Module\Api\Apis\MerchantManagementApi;
...
class ApiClient
{
    private $merchantManagementApi = null;
    ...
    public function getMerchantManagementApi(): MerchantManagementApi
    {
        if ($this->merchantManagementApi == null) {
            $this->merchantManagementApi = new MerchantManagementApi($this);
        }

        return $this->merchantManagementApi;
    }
