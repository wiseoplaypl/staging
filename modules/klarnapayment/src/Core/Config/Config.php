...
class Config
{
    ...
    public const KLARNA_PAYMENT_B2B_ENABLE = [
        'sandbox' => 'KLARNA_PAYMENT_SANDBOX_B2B_ENABLE',
        'production' => 'KLARNA_PAYMENT_PRODUCTION_B2B_ENABLE',
    ];
    ...
    public const KLARNA_PAYMENT_SHARE_SHOPPING_DATA = [
        'sandbox' => 'KLARNA_PAYMENT_SANDBOX_SHARE_SHOPPING_DATA',
        'production' => 'KLARNA_PAYMENT_PRODUCTION_SHARE_SHOPPING_DATA',
    ];
    ...
    public const KLARNA_PAYMENT_ORDER_MANAGEMENT_COOKIE_RELEASED = 'KLARNA_PAYMENT_ORDER_MANAGEMENT_COOKIE_RELEASED';
    ...
    public const KLARNA_PAYMENT_MERCHANT_MANAGEMENT_API_URL = [
        'sandbox' => 'https://api-global.test.klarna.com',
        'production' => 'https://api-global.klarna.com',
    ];

    public const KLARNA_PAYMENT_MERCHANT_DIRECT_KEY = 'KLARNA_PAYMENT_IS_MERCHANT_DIRECT';
    public const KLARNA_PAYMENT_MERCHANT_PARTNER_KEY = 'KLARNA_PAYMENT_IS_MERCHANT_PARTNER';
    ...
    public const KLARNA_WEB_SDK_URL_V2 = 'https://js.klarna.com/web-sdk/v2/klarna.js';
    public const KLARNA_WEB_SDK_URL_V1 = 'https://js.klarna.com/web-sdk/v1/klarna.js';
    ...
    // `clientInstanceName` attribute. Only lowercase letters from a-z and numbers are allowed.
    public const KLARNA_PAYMENT_CLIENT_INSTANCE_NAME = 'klarnapaymentsdkscript';

    public const KLARNA_EXPRESS_CHECKOUT_SCRIPT_ONE_STEP = 'klarna_one_step_express_checkout.js';
    public const KLARNA_EXPRESS_CHECKOUT_SCRIPT_TWO_STEP = 'klarna_express_checkout.js';

    public const KLARNA_PAYMENT_MERCHANT_TYPE = [
        'sandbox' => [
            'EU' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_EU',
            'NA-CA' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_NA-CA',
            'NA-US' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_NA-US',
            'NA-MX' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_NA-MX',
            'AP-AP' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_AP-AP',
            'AP-NZ' => 'KLARNA_PAYMENT_SANDBOX_MERCHANT_TYPE_AP-NZ',
        ],
        'production' => [
            'EU' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_EU',
            'NA-CA' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_NA-CA',
            'NA-US' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_NA-US',
            'NA-MX' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_NA-MX',
            'AP-AP' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_AP-AP',
            'AP-NZ' => 'KLARNA_PAYMENT_PRODUCTION_MERCHANT_TYPE_AP-NZ',
        ],
    ];
}
