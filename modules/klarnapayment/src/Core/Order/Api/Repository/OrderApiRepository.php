...
class OrderApiRepository implements OrderApiRepositoryInterface
{
    ...
    /** {@inheritDoc} */
    public function releaseRemainingAuthorization(ReleaseRemainingAuthorizationRequest $request): void
    {
        $this->apiCaller->getResult(function () use ($request) {
            return $this->apiClient()->getOrderApi()->releaseRemainingAuthorization($request);
        });
    }

    /** {@inheritDoc} */
    public function updateAuthorization(UpdateAuthorizationRequest $request): void
    {
        $this->apiCaller->getResult(function () use ($request) {
            return $this->apiClient()->getOrderApi()->updateAuthorization($request);
        });
    }
