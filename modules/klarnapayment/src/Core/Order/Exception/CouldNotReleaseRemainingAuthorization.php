...
class CouldNotReleaseRemainingAuthorization extends KlarnaPaymentException
{
    public static function verificationFailed(\Throwable $exception): self
    {
        return new self(
            'Failed to verify order action.',
