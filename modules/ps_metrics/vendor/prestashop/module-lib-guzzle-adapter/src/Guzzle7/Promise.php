...
namespace ps_metrics_module_v4_0_10\Prestashop\ModuleLibGuzzleAdapter\Guzzle7;

use GuzzleHttp\Exception as GuzzleExceptions;
use GuzzleHttp\Promise\PromiseInterface;
use Http\Client\Exception as HttplugException;
use ps_metrics_module_v4_0_10\Http\Promise\Promise as HttpPromise;
use ps_metrics_module_v4_0_10\Prestashop\ModuleLibGuzzleAdapter\Guzzle7\Exception\UnexpectedValueException;
