...
function upgrade_module_1_8_4()
{
    // Process Module upgrade to 1.7
    Logger::addLog('upgrade aftermail_module_1_8_4');
    Db::getInstance()->execute('ALTER TABLE `' . _DB_PREFIX_ . 'aftermail_conf` ADD `restrictcustomer`  TINYINT NOT NULL ');
    Configuration::updateValue('AFTERMAIL_VERSION', '1.8.4');
