...
class RevSliderOutput extends RevSliderFunctions {
	...
	public function set_slider_id($sid){
		$this->slider_id = RevLoader::apply_filters('revslider_set_slider_id', $sid, $this);
	}
	...
	public function set_add_to($add_to) {
		$this->add_to = RevLoader::apply_filters('revslider_set_add_to', $add_to, $this);
	}
	...
	public function get_add_to(){
		return RevLoader::apply_filters('revslider_get_add_to', trim(strtolower($this->add_to)), $this);
	}
	...
	public function set_slider($slider){
		$this->slider =RevLoader::apply_filters('revslider_set_slider', $slider, $this);
	}
	...
	public function get_slider(){
		return RevLoader::apply_filters('revslider_get_slider', $this->slider, $this);
	}
	...
	public function get_slider_id(){
		return RevLoader::apply_filters('revslider_get_slider_id', $this->slider_id, $this);
	}
	...
	public function set_html_id($html_id, $check_for_duplication = true){
		...
		$this->html_id = RevLoader::apply_filters('revslider_set_html_id', $html_id, $this);
	}
	...
	public function set_slide_id($slide_id){
		$this->slide_id = RevLoader::apply_filters('revslider_set_slide_id', $slide_id, $this);
	}
	...
	public function get_slide_id(){
		return RevLoader::apply_filters('revslider_get_slide_id', $this->slide_id, $this);
	}
	...
	public function set_layers($layers){
		$this->layers = RevLoader::apply_filters('revslider_set_layers', $layers, $this);
	}
	...
	public function get_layers(){
		return RevLoader::apply_filters('revslider_get_layers', $this->layers, $this);
	}
	...
	public function set_layer($layer){
		$this->layer = RevLoader::apply_filters('revslider_set_layer', $layer, $this);
	}
	...
	public function get_layer(){
		return RevLoader::apply_filters('revslider_get_layer', $this->layer, $this);
	}
	...
	public function get_html_id($raw = true){
		...
		return RevLoader::apply_filters('revslider_get_html_id', $html_id, $this, $raw);
	}
	...
	public function set_static_slide($slide){
		$this->static_slide = RevLoader::apply_filters('revslider_set_static_slide', $slide, $this);
	}
	...
	public function get_static_slide(){
		return RevLoader::apply_filters('revslider_get_static_slide', $this->static_slide, $this);
	}
	...
	public function get_do_static(){
		return RevLoader::apply_filters('revslider_get_do_static_layers', $this->do_static, $this);
	}
	...
	public function set_custom_settings($settings){
		...
		$this->custom_settings = RevLoader::apply_filters('revslider_set_custom_settings', $settings, $this);
	}
	...
	public function get_custom_settings(){
		return RevLoader::apply_filters('revslider_get_custom_settings', $this->custom_settings, $this);
	}
	...
	public function set_custom_skin($skin){
		$this->custom_skin = RevLoader::apply_filters('revslider_set_custom_skin', $skin, $this);
	}
	...
	public function get_custom_skin(){
		return RevLoader::apply_filters('revslider_get_custom_skin', $this->custom_skin, $this);
	}
	...
	public function set_layer_unique_id(){
		...
		$this->uid = RevLoader::apply_filters('revslider_set_layer_unique_id', $uid, $layer, $this);
	}
	...
	public function get_layer_unique_id(){		
		return RevLoader::apply_filters('revslider_get_layer_unique_id', $this->uid, $this);
	}
	...
	public function get_preview_mode(){
		return RevLoader::apply_filters('revslider_get_preview_mode', $this->preview_mode, $this);
	}
	...
	public function set_preview_mode($preview_mode){
		$this->preview_mode = RevLoader::apply_filters('revslider_set_preview_mode', $preview_mode, $this);
	}
	...
	public function set_markup_export($markup_export){
		$this->markup_export = RevLoader::apply_filters('revslider_set_markup_export', $markup_export, $this);
	}
	...
	public function get_markup_export(){
		return RevLoader::apply_filters('revslider_get_markup_export', $this->markup_export, $this);
	}
	...
	public function get_custom_order(){
		return RevLoader::apply_filters('revslider_get_custom_order', $this->custom_order, $this);
	}
	...
	public function get_language(){
		return RevLoader::apply_filters('revslider_get_language', $this->language, $this);
	...
	public function change_language($language){
		$this->language = RevLoader::apply_filters('revslider_change_language', $language, $this);
	}
	...
	public function set_custom_order($order){
		...
		$this->custom_order = RevLoader::apply_filters('revslider_set_custom_settings', $order, $this);
	}
	...
	public function set_only_published($published){
		$this->only_published = RevLoader::apply_filters('revslider_set_published', $published, $this);
	}
	...
	public function get_only_published(){
		return RevLoader::apply_filters('revslider_get_published', $this->only_published);
	}
	...
	public function set_slides_num_index($index){
		$this->slides_num_index = RevLoader::apply_filters('revslider_set_slides_num_index', $index, $this);
	}
	...
	public function get_slides_num_index(){
		return RevLoader::apply_filters('revslider_get_slides_num_index', $this->slides_num_index, $this);
	}
	...
	public function set_gallery_ids($ids){
		$this->gallery_ids = RevLoader::apply_filters('revslider_set_gallery_ids', $ids, $this);
	}
	...
	public function get_gallery_ids(){
		return RevLoader::apply_filters('revslider_get_gallery_ids', $this->gallery_ids, $this);
	}
	...
	public function set_is_single_slide($single){
		$this->is_single_slide = RevLoader::apply_filters('revslider_set_is_single_slide', $single, $this);
	}
	...
	public function get_is_single_slide(){
		return RevLoader::apply_filters('revslider_get_is_single_slide', $this->is_single_slide, $this);
	}
	...
	public function set_slide($slide){
		$this->slide = RevLoader::apply_filters('revslider_set_slide', $slide, $this);
	}
	...
	public function get_slide(){
		return RevLoader::apply_filters('revslider_get_slide', $this->slide, $this);
	}
	...
	public function add_slider_to_stage($sid, $usage = '', $layout = '', $offset = '', $modal = ''){
		...
		RevLoader::do_action('revslider_add_slider_to_stage_pre', $sid, $this);
		...
		RevLoader::do_action('revslider_add_slider_to_stage_post', $sid, $this);
	...
	public function add_slider_base(){
		try{
			...
			RevLoader::do_action('revslider_add_slider_base_pre', $this);
			 ...
			 **/
			if(version_compare($this->get_val($this->slider, array('settings', 'version')), RevLoader::get_option('revslider_update_version', '6.0.0'), '<')){
			...
			$this->slider = RevLoader::apply_filters('revslider_add_slider_base', $this->slider);
			...
			if($this->slider->get_param(array('general', 'disableOnMobile'), false) === true && RevLoader::wp_is_mobile()) return false;
			...
			RevLoader::do_action('revslider_add_slider_base_post', $this);
		}catch(Exception $e){
	...
	public function get_slider_wrapper_div(){
		...
		$bg_color	=  RevLoader::esc_attr(trim($this->slider->get_param(array('layout', 'bg', 'color'))));
		...
		$style .= 'padding:'. RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'padding'), '0')).';';
		...
		if($type != 'fullscreen'){
			...
			if($position != 'center'){
				...
				$style .= ($ma_l !== '') ? 'margin-left:'. RevLoader::esc_attr($ma_l).';' : '';
				$style .= ($ma_r !== '') ? 'margin-right:'. RevLoader::esc_attr($ma_r).';' : '';
			}
			...
			$style .= ($ma_t !== '') ? 'margin-top:'. RevLoader::esc_attr($ma_t).';' : '';
			$style .= ($ma_b !== '') ? 'margin-bottom:'. RevLoader::esc_attr($ma_b).';' : '';
		}
		
		//add background image (banner style)
		if($this->slider->get_param(array('layout', 'bg', 'useImage'), false) == true){
			$bg_img_id =  RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'imageId')));
			$bg_img_type =  RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'imageSourceType'), 'full'));
			$bg_img =  RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'image')));
			...
			if($bg_img !== false){
				...
				$style .= 'background-repeat:'. RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'repeat'), 'no-repeat')).';'; //$this->slider->get_param(array('def', 'background', 'repeat'), 'no-repeat')
				$style .= 'background-size:'. RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'fit'), 'cover')).';'; //$this->slider->get_param(array('def', 'background', 'fit'), 'cover')
				$style .= 'background-position:'. RevLoader::esc_attr($this->slider->get_param(array('layout', 'bg', 'position'), 'center center')).';'; //$this->slider->get_param(array('def', 'background', 'position'), 'center center')
			}
		}
	...
	public function close_slider_wrapper_div(){
		...
		return RevLoader::apply_filters('revslider_close_slider_wrapper_div', $r, $this);
	}
	...
	public function add_unfloat_html(){
		...
		return RevLoader::apply_filters('revslider_add_unfloat_html', $r, $this);
	}
	...
	public function get_slider_div(){
		...
		return RevLoader::apply_filters('revslider_get_slider_div', $r, $this);
	}
	...
	public function close_slider_div(){
		...
		return RevLoader::apply_filters('revslider_close_slider_div', $r, $this);
	}
...
//			$lang	= $this->get_language(); //WPML functionality
			$lang	= RevSliderWpml::getCurrentLang(); //WPML functionality
...
//            die();
		...
		echo RevLoader::apply_filters('revslider_get_slides_pre', RS_T5.'<rs-slides>'."\n", $this);
		...
		foreach($slides as $slide){
			...
			RevLoader::do_action('revslider_add_layer_html', $this->slider, $slide);
		...
		echo RevLoader::apply_filters('revslider_get_slides_post', RS_T5.'</rs-slides>'."\n", $this);
	...
	public function get_timer_bar(){
		...
		$progress_style = ' style="height: '. RevLoader::esc_attr($progress_height).'px; background: '.$progressbar_color.';"';
	...
	public function add_slide_li_pre($index){
		...
		RevLoader::do_action('revslider_add_li_data', $this->slider, $slide);
	...
	public function add_static_slide_html(){
		...
		if($this->get_do_static() && !empty($static_slide)){
			...
			if(!empty($layers)){
				...
				RevLoader::do_action('revslider_add_static_layer_html', $this->get_slider());
	...
	public function get_image_data(){
		...
		if($bg_type != 'external'){
			...
			switch($slide->get_param(array('attributes', 'altOption'), $slide->get_param(array('attributes', 'titleOption'), 'media_library'))){
				...
				break;
				case 'custom':
					$img['alt'] =  RevLoader::esc_attr($slide->get_param(array('attributes', 'alt'), ''));
				break;
			}
			...
			switch($slide->get_param(array('attributes', 'titleOption'), 'media_library')){
				...
				break;
				case 'custom':
					$img['title'] =  RevLoader::esc_attr($slide->get_param(array('attributes', 'title'), ''));
				break;
			}
			...
			$img['src']		=  $slide->get_param(array('bg', 'externalSrc'), '');
			$img['alt']		=  RevLoader::esc_attr($slide->get_param(array('attributes', 'alt'), ''));
			$img['title']	=  RevLoader::esc_attr($slide->get_param(array('attributes', 'title'), ''));
		...
		switch($bg_type){
			...
			case 'solid':
				...
				if(isset($img['alt']) && trim($img['alt']) === ''){
					...
					$img['alt'] = (empty($img['alt'])) ? RevLoader::__('Slide Background', 'revslider') : $img['alt'];
				}
			break;
		}
	...
	private function add_creative_layer(){
		...
		$layers = RevLoader::apply_filters('revslider_putCreativeLayer', $layers, $this, $this->is_static);
		$this->container_mode = '';
	...
	public function get_html_layer_type(){
		...
		return 'data-type="'. RevLoader::esc_attr($type).'"';
	}
	...
	public function add_layer($row_group_uid = false, $special_type = false){
		$layer = RevLoader::apply_filters('revslider_putLayer_pre', $this->get_layer(), $this, $row_group_uid, $this->is_static, $special_type);
		$this->set_layer($layer);
		...
		RevLoader::do_action('revslider_add_layer_attributes', $layer, $this->slide, $this->slider, $this);
		...
		echo ($special_type === false && $layertype !== 'video') ? RevLoader::apply_filters('revslider_layer_content', stripslashes($html_layer), $html_layer, $this->slider->get_id(), $this->slide, $layer).' ' : '';
	...
	public function get_action_link(){
		...
		if(!empty($action)){
			foreach($action as $act){
				...
				$action_type = RevLoader::apply_filters('rs_action_type', $this->get_val($act, 'action'));
				$link_type = RevLoader::apply_filters('rs_action_link_type', $this->get_val($act, 'link_type', ''));
				if($action_type === 'menu'){					
...
rs-module .material-icons {
  ...
  -moz-osx-font-smoothing: grayscale;
	...
	public function get_html_layer_action(&$html_simple_link){
		...
		if(!empty($actions)){
			foreach($actions as $num => $action){
				...
				// Filter the Actions
                $events = RevLoader::apply_filters('rs_action_output_layer_action', $events, $action, $all_actions, $num, $this->slide, $this);
                if(!isset($html_simple_link)){
                    $html_simple_link = ''; 
                }
                $html_simple_link = RevLoader::apply_filters('rs_action_output_layer_simple_link', $html_simple_link, $action, $all_actions, $num, $this->slide, $this->slider, $events, $this);
			}
	...
	public function get_html_class($class, $layer_tag){
		...
		$c = RevLoader::apply_filters('revslider_add_layer_classes', $c, $this->layer, $this->slide, $this->slider);
	...
	public function get_html_audio_data(){
		...
		$mp4 =  RevLoader::esc_attr($this->remove_http($this->get_val($layer, array('media', 'audioUrl'))));
	...
	public function get_html_video_data(){
		...
		$http	 = (RevLoader::is_ssl()) ? 'https://' : 'http://';
		$vid	 = trim($this->get_val($layer, array('media', 'id')));
		$mute	 = $this->get_val($layer, array('media', 'mute'), true);
		$volume	 = $this->get_val($layer, array('media', 'volume'), 100);
	...
	public function get_html_layer(){
		...
		switch($type){
			...
			case 'button':
				...
				$html = RevLoader::apply_filters('revslider_modify_layer_text', $text, $layer);
			...
			case 'image':
				...
				$urlImage = str_replace("revsliderprestashop//","revsliderprestashop/",$urlImage);
				if($urlImage !== ''){
	...
	public function set_placeholders($text){
		...
		$text = str_replace(array('%home_url%', '{{home_url}}'), RevLoader::esc_url(RevLoader::home_url( '/' )), $text);
		//track
		//if(isset($post->ID)) $text = str_replace(array('%current_page_link%', '{{current_page_link}}'), get_permalink($post->ID), $text);
		if(isset($post->ID)) $text = RevLoader::apply_filters('revslider_gallery_set_placeholders', $text, $post->ID);
		return $text;
	}
	...
	public function get_html_slide_title($raw = false){
		...
		return ($title !== '') ? $pre.stripslashes( RevLoader::esc_attr($title)).$post : '';
	}
	...
	public function get_html_slide_description(){
		...
		$description = trim(str_replace(array("\'", '\"'), array("'", '"'),  RevLoader::esc_attr($description)));
	...
	public function get_thumb_url(){
		...
		$url = str_replace("revsliderprestashop//","revsliderprestashop/",$url);
		...
		if($slide->get_param(array('seo', 'set'), false) == true){
			switch($slide->get_param(array('seo', 'type'), 'regular')){
				...
				case 'regular':
					...
					$link	= ($l !== '') ? ' data-link="'.$l.'"'.$target : $link;
				break;
	...
	public function get_html_extra_params(){
		...
		for($mi = 0; $mi < 10; $mi++){
			...
			$mm = $mi + 1;
			$params .= ($pa !== '') ? ' data-p'.$mm.'="'.stripslashes( RevLoader::esc_attr($pa)).'"' : '';
		}
	...
	public function remove_slide_if_mobile($slides){
		...
		$mobile = (RevLoader::wp_is_mobile() || strstr($usragent,'Android') || strstr($usragent,'webOS') || strstr($usragent,'iPhone') ||strstr($usragent,'iPod') || strstr($usragent,'iPad') || strstr($usragent,'Windows Phone')) ? true : false;
	...
	private function modify_settings(){
		...
		$settings = RevLoader::apply_filters('revslider_modify_slider_settings', $settings, $this->get_slider_id());
	...
	private function modify_preview_mode_settings(){
		$js_to_body = RevLoader::apply_filters('revslider_modify_preview_mode_settings', false);
		...
		foreach($gf as $gfk => $gfv){
			...
			if(!empty($gfv['subsets'])){
				foreach($gfv['subsets'] as $ssk => $ssv){
					if(array_search( RevLoader::esc_attr($gfk.'+'.$ssv), $gfsub) !== false){
						$subsets[] = $ssv;
					}
				}
			}
	...
	public function add_no_slides_markup(){
		if($this->slider->is_posts()){
			$text = RevLoader::__('No slides found, please add at least one Slide Template to the choosen language.', 'revslider');
		}else{
			$text = RevLoader::__('No slides found, please add some slides', 'revslider');
		}
	...
	public function get_html_js_start_size($optFullWidth, $optFullScreen){
		...
		$layout	= 'auto';
		$html	= '';
		if(!$this->get_markup_export()){
		    //not needed for html markup export
            $html .= 'if(typeof setREVStartSize!=="undefined"){';
			...
			if($this->slider->get_param('layouttype') == 'fullscreen'){
				$html .= "offsetContainer:'".  RevLoader::esc_attr($this->slider->get_param(array('size', 'fullScreenOffsetContainer'), '')) ."',";
				$html .= "offset:'".  RevLoader::esc_attr($this->slider->get_param(array('size', 'fullScreenOffset'), '')) ."',";
			}
	...
	public function print_error_message($message, $open_page = false){
		...
		$html .= RS_T6.'<div class="rs_error_message_content">'.RevLoader::esc_html($message);
		$html .= (!empty($url)) ? '<br>'.RevLoader::__('Please follow this link to edit the Slider:', 'revslider') : '';
		$html .= '</div>'."\n";
		...
		// 	$html .=  RS_T4.'console.log("'.RevLoader::esc_html($message).'");'."\n";
		// }
	...
	private function add_js(){
		...
		if($js_to_footer === true && $this->preview_mode == false && $me == false){
			...
			RevLoader::add_action('wp_print_footer_scripts', array($this, 'add_inline_js'), 100);
		}
		...
		if($me === true){ //for html markup export
			...
			// 	RevLoader::add_action('wp_footer', array($this, 'add_inline_double_jquery_error'));
			// }
		}
	}
	...
	public function js_get_base_pre(){
		...
		$html .= RS_T6.'}else{'."\n";
		$html = RevLoader::apply_filters('revslider_fe_before_init_script', $html, $this->slider, $html_id); // needed for AddOns
	...
	public function js_get_base_post(){
		...
		$html = '';
		ob_start();
		RevLoader::do_action('revslider_fe_javascript_option_output', $this->slider);
		...
		ob_start();
		RevLoader::do_action('revslider_fe_javascript_output', $this->slider, $this->get_html_id());
		$js_action = ob_get_contents();
		ob_clean();
		ob_end_clean();
	...
	public function get_notices(){
		...
		if($this->orig_html_id !== false){
			$html .= RS_T4.'<script type="text/javascript">'."\n";
			$html .= RS_T5.'console.log("'.sprintf(RevLoader::__('Warning - ID: %s exists already and was converted to: %s', 'revslider'), $this->orig_html_id, $this->get_html_id()).'")'."\n";
			$html .= RS_T4.'</script>'."\n";
		}
	...
	public function js_get_modal() {
		...
		$c['useAsModal'] = true;
		$c['alias'] =  RevLoader::esc_attr($this->slider->get_alias());
	...
	public function js_get_root(){
		...
		$start_delay = RevLoader::apply_filters('revslider_add_js_delay', $start_delay);
		...
		if($this->frontend_action){
			$keys['ajaxUrl'] = array('v' =>  RevLoader::admin_url(), 'd' => '');
			$keys['ajaxNonce'] = array('v' => RevLoader::wp_create_nonce(), 'd' => '');
		}
