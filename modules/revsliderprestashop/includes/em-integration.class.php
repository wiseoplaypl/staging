...
class RevSliderEventsManager extends RevSliderFunctions {
	...
	public function __construct(){
		RevLoader::add_filter('revslider_get_posts_by_category', array($this, 'add_post_query'), 10, 2);
	}
	...
	public static function get_filter_types(){
		return array(
			'none'		=> RevLoader::__('All Events', 'revslider'),
			'today'		=> RevLoader::__('Today', 'revslider'),
			'tomorrow'	=> RevLoader::__('Tomorrow', 'revslider'),
			'future'	=> RevLoader::__('Future', 'revslider'),
			'past'		=> RevLoader::__('Past', 'revslider'),
			'month'		=> RevLoader::__('This Month', 'revslider'),
			'nextmonth'	=> RevLoader::__('Next Month', 'revslider')
		);
	}
	...
	public static function getArrSortBy(){
		return array(
			'event_start_date'	=> RevLoader::__('Event Start Date', 'revslider'),
			'event_end_date'	=> RevLoader::__('Event End Date', 'revslider')
		);
	}
