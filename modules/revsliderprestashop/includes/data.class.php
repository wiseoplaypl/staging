...
class RevSliderData {
	...
	public function get_font_familys(){
		...
		if(!empty($cfl) && is_array($cfl)){
			foreach($cfl as $_cfl){
				$fonts[] = array(
					'type'		=> 'custom',
					'version'	=> RevLoader::__('Custom Fonts', 'revslider'),
		...
		//Web Safe Fonts
		// GOOGLE Loaded Fonts
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Loaded Google Fonts', 'revslider'), 'label' => 'Dont Show Me');

		//Serif Fonts
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Serif Fonts', 'revslider'), 'label' => 'Georgia, serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Serif Fonts', 'revslider'), 'label' => '"Palatino Linotype", "Book Antiqua", Palatino, serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Serif Fonts', 'revslider'), 'label' => '"Times New Roman", Times, serif');

		//Sans-Serif Fonts
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => 'Arial, Helvetica, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => '"Arial Black", Gadget, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => '"Comic Sans MS", cursive, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => 'Impact, Charcoal, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => '"Lucida Sans Unicode", "Lucida Grande", sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => 'Tahoma, Geneva, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => '"Trebuchet MS", Helvetica, sans-serif');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Sans-Serif Fonts', 'revslider'), 'label' => 'Verdana, Geneva, sans-serif');

		//Monospace Fonts
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Monospace Fonts', 'revslider'), 'label' => '"Courier New", Courier, monospace');
		$fonts[] = array('type' => 'websafe', 'version' => RevLoader::__('Monospace Fonts', 'revslider'), 'label' => '"Lucida Console", Monaco, monospace');
		...
		foreach($googlefonts as $f => $val){
			$fonts[] = array('type' => 'googlefont', 'version' => RevLoader::__('Google Fonts', 'revslider'), 'label' => $f, 'variants' => $val['variants'], 'subsets' => $val['subsets'], 'category' => $val['category']);
		}
	...
	public function get_all_image_sizes($type = 'gallery'){
		...
		switch($type){
			case 'flickr':
				$custom_sizes = array(
					'original' => RevLoader::__('Original', 'revslider'),
					'large' => RevLoader::__('Large', 'revslider'),
					'large-square' => RevLoader::__('Large Square', 'revslider'),
					'medium' => RevLoader::__('Medium', 'revslider'),
					'medium-800' => RevLoader::__('Medium 800', 'revslider'),
					'medium-640' => RevLoader::__('Medium 640', 'revslider'),
					'small' => RevLoader::__('Small', 'revslider'),
					'small-320' => RevLoader::__('Small 320', 'revslider'),
					'thumbnail' => RevLoader::__('Thumbnail', 'revslider'),
					'square' => RevLoader::__('Square', 'revslider'),
				);
			break;
			case 'instagram':
				$custom_sizes = array(
					'standard_resolution' => RevLoader::__('Standard Resolution', 'revslider'),
					'thumbnail' => RevLoader::__('Thumbnail', 'revslider'),
					'low_resolution' => RevLoader::__('Low Resolution', 'revslider'),
					'original_size' => RevLoader::__('Original Size', 'revslider'),
					'large' => RevLoader::__('Large Size', 'revslider'),
				);
			break;
			case 'twitter':
				$custom_sizes = array(
					'large' => RevLoader::__('Standard Resolution', 'revslider'),
				);
			break;
			case 'facebook':
				$custom_sizes = array(
					'full' => RevLoader::__('Original Size', 'revslider'),
					'thumbnail' => RevLoader::__('Thumbnail', 'revslider'),
				);
			break;
			case 'youtube':
				$custom_sizes = array(
					'high' => RevLoader::__('High', 'revslider'),
					'medium' => RevLoader::__('Medium', 'revslider'),
					'default' => RevLoader::__('Default', 'revslider'),
					'standard' => RevLoader::__('Standard', 'revslider'),
					'maxres' => RevLoader::__('Max. Res.', 'revslider'),
				);
			break;
			case 'vimeo':
				$custom_sizes = array(
					'thumbnail_large' => RevLoader::__('Large', 'revslider'),
					'thumbnail_medium' => RevLoader::__('Medium', 'revslider'),
					'thumbnail_small' => RevLoader::__('Small', 'revslider'),
				);
			break;
			case 'gallery':
			default:
				$added_image_sizes = RevLoader::get_intermediate_image_sizes();
