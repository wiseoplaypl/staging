...
class RevSliderWooCommerce extends RevSliderFunctions {
	...
	public static function getCustomPostTypes(){
		$arr = array(
			'product'			=> RevLoader::__('Product', 'revslider'),
			'product_variation'	=> RevLoader::__('Product Variation', 'revslider')
		);
	...
	public static function getArrSortBy(){
		...
		$sort_by = array(
			'meta_num__regular_price'	=> RevLoader::__('Regular Price', 'revslider'),
			'meta_num__sale_price'		=> RevLoader::__('Sale Price', 'revslider'),
			'meta_num_total_sales'		=> RevLoader::__('Number Of Sales', 'revslider'),
			//'meta__featured'			=> RevLoader::__('Featured Products', 'revslider'),
			'meta__sku'					=> RevLoader::__('SKU', 'revslider'),
			'meta_num_stock'			=> RevLoader::__('Stock Quantity', 'revslider')
		);
