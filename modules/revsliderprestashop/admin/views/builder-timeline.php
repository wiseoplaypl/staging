	...
	<div id="timeline">
			...
			<div class="timeline_left_container">
				...
				--><div id="tl_gridmanagement_wrap" class="tl_gridmanagement_wrap">
						<div id="general_gridmanagement_wrap">															
							<label_a><?php RevLoader::_e('Adjust by', 'revslider');?></label_a><select id="snap_to_what" class="sliderinput tos2 nosearchbox easyinit callEvent" data-r="snap.adjust" data-show="" data-hide="" data-theme="dark" data-evt="updateSnapVisual">
									<option value="none"><?php RevLoader::_e('None', 'revslider');?></option>
									<option value="grid"><?php RevLoader::_e('Grid', 'revslider');?></option>
									<option value="layers"><?php RevLoader::_e('Same Aligned Layers','revslider');?></option>									
							</select><div class="linebreak"></div>
							<label_a><?php RevLoader::_e('Gap', 'revslider');?></label_a><input data-numeric="true" data-min="0" data-max="2500" data-evt="updateSnapVisual" id="snap_cell_size" data-r="snap.gap" type="text" class="callEvent sliderinput easyinit valueduekeyboard "><div class="linebreak"></div>
				...
				--><div class="tl_magnifying_wrap">
						<div id="general_frame_magnif_wrap">
							<div class="radiooption">
								<div class="magnet_fr_none selected"><input id="magnet_fr_none"  data-select=".st_slider" data-unselect=".magnet_fr_sticky, .magnet_fr_sticky_inh" name="frame_maginfiy_radio" data-evt="magnetframes" data-evtparam="0" type="radio" value="0" class="basicinput callEvent" checked="checked"><label_sub><?php RevLoader::_e('No Sticky Keyframes', 'revslider');?></label_sub><span class="shortcuttext osx"><span class="shortcut_cmdctrl">⌘</span>U</span></div>
								<div  class="magnet_fr_sticky"><input id="magnet_fr_sticky" data-select=".magnet_fr_sticky" data-unselect=".magnet_fr_none, .magnet_fr_sticky_inh" name="frame_maginfiy_radio" data-evt="magnetframes" data-evtparam="1" type="radio" value="1" class="basicinput callEvent"><label_sub><?php RevLoader::_e('Single Layer Sticky', 'revslider');?></label_sub><span class="shortcuttext osx"><span class="shortcut_cmdctrl">⌘</span>I</span></div>
								<div  class="magnet_fr_sticky_inh"><input id="magnet_fr_sticky_inh" data-select=".magnet_fr_sticky_inh" data-unselect=".magnet_fr_none, .magnet_fr_sticky" name="frame_maginfiy_radio" data-evt="magnetframes" data-evtparam="2" type="radio" value="2" class="basicinput callEvent"><label_sub><?php RevLoader::_e('Hierarchy Sticky', 'revslider');?></label_sub><span class="shortcuttext osx"><span class="shortcut_cmdctrl">⌘</span>O</span></div>
							</div>
							<div class="closeme_tl_miniwrapper"><i class="material-icons">close</i></div>
						</div>
				...
				--><div class="tl_multip_wrap">					
					<div id="general_speed_factor_wrap">
						<label_a><?php RevLoader::_e('Set all Timings', 'revslider');?></label_a>
		...
		<div id="tlLayerListWrap">			
			<div id="the_slide_timeline" class="slide_timeline">
				<div class="slide_timeline_element">
					<div class="layerlist_element_innerwrap">
						<div id="the_st_cl" class="context_left"><div id="slide_bg_anim_trigger"><div class="layerlist_element_type" ><i class="material-icons">panorama</i></div><div class="layerlist_element_alias"><?php RevLoader::_e('Slide BG Animation', 'revslider');?></div></div><i id="tl_trigger_slide_options" data-select="#gst_slide_1" data-unselect=".slide_submodule_trigger" data-collapse="true" data-forms='["*slidelayout**mode__slidestyle*#form_slidebg"]' class="material-icons opensettingstrigger">perm_media</i></div>
			...
			<div id="the_global_layers_timeline" class="slide_timeline">
				<div class="slide_timeline_element">
					<div class="layerlist_element_innerwrap">
						<div id="the_fake_cl" class="context_left"><div><div class="layerlist_element_type" ><i class="material-icons">panorama</i></div><div class="layerlist_element_alias"><?php RevLoader::_e('Global Layers Timeline', 'revslider');?></div></div></div>
			...
			<!--<div class="fake_slide_timeline">
				<div class="fake_tllayerlist_element tllayerlist_element_zone">
					<div class="layerlist_element_innerwrap" data-ignore="true">
						<div class="context_left"><div class="layerlist_element_type"></div><div class="layerlist_element_alias"><?php RevLoader::_e('FREE POSITIONED LAYERS', 'revslider');?></div></div>
						<div class="stimeline">							
							<div class="frameswrap"></div>
						</div>
					</div>
