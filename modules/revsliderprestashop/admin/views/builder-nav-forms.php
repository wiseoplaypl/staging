...
<div id="nav_settings" data-root="settings.">
	...
	<div class="form_collector nav_collector" data-type="sliderconfig" data-pcontainer="#nav_settings" data-offset="#rev_builder_wrapper">
		<div class="main_mode_breadcrumb_wrap"><div class="main_mode_submode"><?php RevLoader::_e('Navigation Options', 'revslider');?></div></div>
		<div class="gso_wrap">
			<div id="gst_nav_1" class="nav_submodule_trigger opensettingstrigger selected" data-select="#gst_nav_1" data-unselect=".nav_submodule_trigger" data-collapse="true" data-forms='["#form_nav_pbara"]'><i class="material-icons">timelapse</i><span class="gso_title"><?php RevLoader::_e('Progress', 'revslider');?></span></div><!--
			--><div id="gst_nav_2" data-select="#gst_nav_2" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_arrows"]'><i class="material-icons">swap_horiz</i><span class="gso_title"><?php RevLoader::_e('Arrows', 'revslider');?></span></div><!--
			--><div id="gst_nav_3" data-select="#gst_nav_3" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_bullets"]'><i class="material-icons">more_horiz</i><span class="gso_title"><?php RevLoader::_e('Bullets', 'revslider');?></span></div><!--
			--><div id="gst_nav_4" data-select="#gst_nav_4" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_tabs"]'><i class="material-icons">view_column</i><span class="gso_title"><?php RevLoader::_e('Tabs', 'revslider');?></span></div><!--
			--><div id="gst_nav_5" data-select="#gst_nav_5" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_thumbs"]'><i class="material-icons">filter_frames</i><span class="gso_title"><?php RevLoader::_e('Thumbs', 'revslider');?></span></div><!--
			--><div id="gst_nav_6" data-select="#gst_nav_6" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_pprevima"]'><i class="material-icons">image</i><span class="gso_title"><?php RevLoader::_e('Prev Size', 'revslider');?></span></div><!--
			--><div id="gst_nav_7" data-select="#gst_nav_7" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_touch"]'><i class="material-icons">pan_tool</i><span class="gso_title"><?php RevLoader::_e('Touch', 'revslider');?></span></div><!--
			--><div id="gst_nav_8" data-select="#gst_nav_8" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_misc"]'><i class="material-icons">keyboard</i><span class="gso_title"><?php RevLoader::_e('Keyboard', 'revslider');?></span></div><!--
			--><div id="gst_nav_9" data-select="#gst_nav_9" data-unselect=".nav_submodule_trigger" class="nav_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_nav_mousescroll"]'><i class="material-icons">mouse</i><span class="gso_title"><?php RevLoader::_e('Mouse', 'revslider');?></span></div><!--
			--><div id="gst_nav_10" class="callEvent general_submodule_trigger openmodaltrigger" data-evt="openNavigationEditor"><i class="material-icons">games</i><span class="gso_title"><?php RevLoader::_e('Nav Editor', 'revslider');?></span></div>
	...
	<div class="form_collector sceneunavailable carouselavailable standardavailable slider_nav_layout_collector nav_collector" data-type="sliderconfig" data-pcontainer="#nav_settings" data-offset="#rev_builder_wrapper" id="nav_form_collector" >
		...
		<div id="form_nav_pbara" data-select="#gst_nav_1" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside">
			<div class="collectortabwrap"><div id="collectortab_form_pbara" class="collectortab form_menu_inside" data-forms='["#form_nav_pbara"]'><i class="material-icons">timelapse</i><?php RevLoader::_e('Progress Bar', 'revslider');?></div></div>
			<!--<div id="slider_pb_settings_arrow" class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<div class="form_inner">
				<div class="form_inner_header"><i class="material-icons">timelapse</i><?php RevLoader::_e('Progress Bar', 'revslider');?></div>
				...
				<div id="slider_pb_settings" class="collapsable" style="display:block">
					<label_a><?php RevLoader::_e('Based On', 'revslider');?></label_a><select data-evt="sliderProgressUpdate" id="sr_pb_basedon" data-show=".progressgaps_*val*" data-hide=".progressgaps" class="sliderinput tos2 nosearchbox easyinit"  data-r="general.progressbar.basedon"><option value="slide"><?php RevLoader::_e('Current Slide Progress', 'revslider');?></option><option value="module"><?php RevLoader::_e('Module Progress', 'revslider');?></option></select><span class="linebreak"></span>					
					<label_a><?php RevLoader::_e('Style', 'revslider');?></label_a><select data-evt="sliderProgressUpdate" id="sr_pb_style" class="sliderinput tos2 nosearchbox easyinit"  data-r="general.progressbar.style" data-show=".progressoffsets_*val*" data-hide=".progressoffsets"><option value="horizontal"><?php RevLoader::_e('Horizontal', 'revslider');?></option><option value="vertical"><?php RevLoader::_e('Vertical', 'revslider');?></option><option value="cw"><?php RevLoader::_e('Circle CW', 'revslider');?></option><option value="ccw"><?php RevLoader::_e('Circle CCW', 'revslider');?></option></select><span class="linebreak"></span>
					<div class="progressoffsets progressoffsets_horizontal progressoffsets_vertical">
						<div class="progressgaps progressgaps_module">
							<label_a><?php RevLoader::_e('Gap', 'revslider');?></label_a><input type="checkbox" class="easyinit sliderinput" data-evt="sliderProgressUpdate" id="sr_pb_separator" data-showhide=".separatorpb" data-showhidedep="true" data-r="general.progressbar.gap"><span class="linebreak"></span>						
							<div class="separatorpb">
								<label_a><?php RevLoader::_e('Gap Size', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-numeric="true" data-allowed="" data-evt="sliderProgressUpdate" data-r="general.progressbar.gapsize" type="text" id="sr_pb_gaps" ><span class="linebreak"></span>						
								<label_a><?php RevLoader::_e('Gap Color', 'revslider');?></label_a><input type="text" data-editing="Gap Color" data-evt="sliderProgressUpdate" name="progressgapcolor" data-visible="true" id="progressgapcolor" class="my-color-field sliderinput" data-r="general.progressbar.gapcolor" value="transparent">							
							</div>
						</div>
					</div>
					<div class="div5"></div>										
					<label_a><?php RevLoader::_e('Progress Bar', 'revslider');?></label_a><input type="text" data-editing="Progressbar Color" data-evt="sliderProgressUpdate" name="sliderprogresscolor" data-visible="true" id="sliderprogresscolor" class="my-color-field sliderinput" data-r="general.progressbar.color" value="transparent">
					<label_a><?php RevLoader::_e('Background', 'revslider');?></label_a><input type="text" data-editing="Progressbar Color BG" data-evt="sliderProgressUpdate" name="sliderprogresscolorbg" data-visible="true" id="sliderprogresscolorbg" class="my-color-field sliderinput" data-r="general.progressbar.bgcolor" value="transparent">
					<div class="div5"></div>
					...
					<div class="div5"></div>										
					<label_a><?php RevLoader::_e('Strength', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-allowed="px,%" data-numeric="true" data-evt="sliderProgressUpdate" data-r="general.progressbar.size" type="text" id="sr_pb_size" ><span class="linebreak"></span>
					<div class="progressoffsets progressoffsets_ccw progressoffsets_cw"><label_a><?php RevLoader::_e('Radius', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-evt="sliderProgressUpdate" data-r="general.progressbar.radius" type="text" id="sr_pb_radius" ></div>
					<label_a><?php RevLoader::_e('Reset', 'revslider');?></label_a><select class="sliderinput tos2 nosearchbox easyinit"  data-r="general.progressbar.reset"><option value="reset"><?php RevLoader::_e('No Animation', 'revslider');?></option><option value="animate"><?php RevLoader::_e('Animate', 'revslider');?></option></select><span class="linebreak"></span>
					<div class="div5"></div>
					<row class="directrow">
		...
		<div id="form_nav_arrows" data-select="#gst_nav_2" data-unselect=".nav_submodule_trigger" class="formcontainer carouselenable standardenable herodisable collapsed form_menu_inside">
			<div class="collectortabwrap"><div id="collectortab_form_nav_arr" class="collectortab form_menu_inside" data-forms='["#form_nav_arrows"]'><i class="material-icons">swap_horiz</i><?php RevLoader::_e('Arrows', 'revslider');?></div></div>
			...
			<ul class="form_menu_level_1">
				<li data-target="#form_nav_arrows_mainstyle" class="form_menu_level_1_li" id="sr_na_arr_0"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_nav_arrows_visi" class="form_menu_level_1_li" id="sr_na_arr_1"><?php RevLoader::_e('Visibility', 'revslider');?></li>
				<li data-target="#form_nav_arrows_left" class="form_menu_level_1_li" id="sr_na_arr_12"><?php RevLoader::_e('Left Arrow', 'revslider');?></li>
				<li data-target="#form_nav_arrows_right" class="form_menu_level_1_li" id="sr_na_arr_13"><?php RevLoader::_e('Right Arrow', 'revslider');?></li>
				<li data-target="#form_nav_arrows_style" class="form_menu_level_1_li" id="sr_na_arr_2"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_slide_nav_arrows" class="form_menu_level_1_li" id="sr_na_arr_21"><?php RevLoader::_e('Style on Slide', 'revslider');?></li>
			</ul>
			<div id="form_nav_arrows_mainstyle" class="form_inner open" >
				<div class="form_inner_header"><i class="material-icons">opacity</i><?php RevLoader::_e('Arrow Type', 'revslider');?></div>
				...
				<div id="arrow_main_style_collaps" class="collapsable">
					<label_a><?php RevLoader::_e('Arrow Style', 'revslider');?></label_a><select id="sr_arrows_style"  data-evt="sliderNavUpdate" data-evtparam="arrows" data-r="nav.arrows.style" class="sliderinput tos2 nosearchbox easyinit sr_nav_style_tos" >
						<option value=""><?php RevLoader::_e('No Style', 'revslider');?></option>
			...
			<div id="form_nav_arrows_left" class="form_inner open" >
				<div class="form_inner_header"><i class="material-icons">arrow_back</i><?php RevLoader::_e('Left Arrow', 'revslider');?></div>
				...
				<div class="collapsable">
					...
					<label_a><?php RevLoader::_e('Aligned by', 'revslider');?></label_a>
					<div class="radiooption">
						<div><input class="sliderinput easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="arrows" type="radio" value="slider" name="sr_leftarralign" data-r="nav.arrows.left.align"><label_sub><?php RevLoader::_e('Module Dimension', 'revslider');?></label_sub></div>
						<div><input class="sliderinput easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="arrows" type="radio" value="grid" name="sr_leftarralign" data-r="nav.arrows.left.align"><label_sub><?php RevLoader::_e('Content', 'revslider');?></label_sub></div>
					</div>
					<div class="div20"></div>
					...
					<label_a><?php RevLoader::_e('Animation', 'revslider');?></label_a><select  id="sr_arrowleft_animation"  data-r="nav.arrows.left.anim" class="sliderinput tos2 nosearchbox easyinit">						
						<option value="fade"><?php RevLoader::_e('Fade', 'revslider');?></option>
						<option value="left"><?php RevLoader::_e('From Left', 'revslider');?></option>
						<option value="right"><?php RevLoader::_e('From Right', 'revslider');?></option>
						<option value="top"><?php RevLoader::_e('From Top', 'revslider');?></option>
						<option value="bottom"><?php RevLoader::_e('From Bottom', 'revslider');?></option>
						<option value="zoomin"><?php RevLoader::_e('Zoom In', 'revslider');?></option>
						<option value="zoomout"><?php RevLoader::_e('Zoom Out', 'revslider');?></option>
					</select>					
				</div>
			</div>

			<div id="form_nav_arrows_right" class="form_inner open" >
				<div class="form_inner_header"><i class="material-icons">arrow_forward</i><?php RevLoader::_e('Right Arrow', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_arr_13"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">					
					<label_a><?php RevLoader::_e('Aligned by', 'revslider');?></label_a>
					<div class="radiooption">
						<div><input class="sliderinput easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="arrows" type="radio" value="slider" name="sr_rightarralign" data-r="nav.arrows.right.align"><label_sub><?php RevLoader::_e('Module Dimension', 'revslider');?></label_sub></div>
						<div><input class="sliderinput easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="arrows" type="radio" value="grid" name="sr_rightarralign" data-r="nav.arrows.right.align"><label_sub><?php RevLoader::_e('Content', 'revslider');?></label_sub></div>
					</div>
					<div class="div20"></div>
					...
					<div class="div20"></div>
					<label_a><?php RevLoader::_e('Animation', 'revslider');?></label_a><select  id="sr_arrowright_animation"  data-r="nav.arrows.right.anim" class="sliderinput tos2 nosearchbox easyinit">						
						<option value="fade"><?php RevLoader::_e('Fade', 'revslider');?></option>
						<option value="left"><?php RevLoader::_e('From Left', 'revslider');?></option>
						<option value="right"><?php RevLoader::_e('From Right', 'revslider');?></option>
						<option value="top"><?php RevLoader::_e('From Top', 'revslider');?></option>
			...
			<div id="form_nav_arrows_visi" class="form_inner open" >
				...
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_arr_1"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">					
					<label_a><?php RevLoader::_e('RTL Direction', 'revslider');?></label_a><input type="checkbox"  id="sr_arrowrtl" class="sliderinput easyinit" data-r="nav.arrows.rtl"/><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Show Speed', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-numeric="true" data-allowed="ms" data-r="nav.arrows.animSpeed" data-min="1" data-max="10000" type="text" id="nav_arrow_animSpeed"><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Show Delay', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-numeric="true" data-allowed="ms" data-r="nav.arrows.animDelay" data-min="1" data-max="10000" type="text" id="nav_arrow_animDelay"><span class="linebreak"></span>
					<row class="directrow">
						<onelong><label_a><?php RevLoader::_e('Show Always', 'revslider');?></label_a><input type="checkbox"  id="sr_arrowsalwshow" class="sliderinput easyinit" data-r="nav.arrows.alwaysOn" data-showhide="#nav_arrows_alwaysshow" data-showhidedep="false"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Under', 'revslider');?></label_a><input type="checkbox"  id="sr_arrowshideunder" class="sliderinput easyinit" data-r="nav.arrows.hideUnder" data-showhide="#nav_arrows_hideunderlimit_wr" data-showhidedep="true"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Over', 'revslider');?></label_a><input type="checkbox"  id="sr_arrowshideover" class="sliderinput easyinit" data-r="nav.arrows.hideOver" data-showhide="#nav_arrows_hideoverlimit_wr" data-showhidedep="true"/></onelong>
			...
			<div id="form_nav_arrows_style" class="form_inner open">
				<div class="form_inner_header"><i class="material-icons">palette</i><?php RevLoader::_e('Navigation Style', 'revslider');?></div>
				<div class="collapsable">
			...
			<div id="form_nav_arrows_style" class="form_inner open">
				<div class="form_inner_header"><i class="material-icons">palette</i><?php RevLoader::_e('Global Style Presets', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_arr_2"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Preset', 'revslider');?></label_a><select id="sr_arrows_style_preset" data-r="nav.arrows.preset" class="sliderinput tos2" ></select><span class="linebreak"></span>
					<label_a></label_a><div data-evt="sliderNavPreset" data-evtparam="arrows" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Load', 'revslider');?></div>
					<div data-evt="saveNavPreset" data-evtparam="arrows" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Save', 'revslider');?></div><span class="linebreak"></span>
					<label_a></label_a><div data-evt="deleteNavPreset" data-evtparam="arrows" class="callEventButton basic_action_button autosize"><i class="material-icons">delete</i><?php RevLoader::_e('Delete', 'revslider');?></div>
				</div>
			</div>

			<!-- SLIDE LOCAL ARROWS SETTING -->
			<div id="form_slide_nav_arrows" class="form_inner open form_menu_inside">
				<div class="form_inner_header"><i class="material-icons">texture</i><?php RevLoader::_e('Override Style on Slide', 'revslider');?></div>
		...
		<div id="form_nav_bullets" data-select="#gst_nav_3" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside carouselenable standardenable herodisable collapsed">
			<div class="collectortabwrap"><div id="collectortab_form_nav_bull" class="collectortab form_menu_inside" data-forms='["#form_nav_bullets"]'><i class="material-icons">more_horiz</i><?php RevLoader::_e('Bullets', 'revslider');?></div></div>
			<!--<div id="nav_bullets_settings_arrow" class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<ul class="form_menu_level_1">
				<li data-target="#form_nav_bullets_mainstyle" class="form_menu_level_1_li" id="sr_na_bul_0"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_nav_bullets_visi" class="selected form_menu_level_1_li" id="sr_na_bul_1"><?php RevLoader::_e('Visibility', 'revslider');?></li>
				<li data-target="#form_nav_bullets_posi" class="selected form_menu_level_1_li" id="sr_na_bul_11"><?php RevLoader::_e('Position', 'revslider');?></li>
				<li data-target="#form_nav_bullets_style" class="form_menu_level_1_li" id="sr_na_bul_2"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_slide_nav_bullets" class="form_menu_level_1_li" id="sr_na_bul_21"><?php RevLoader::_e('Style', 'revslider');?></li>
			</ul>

			<div id="form_nav_bullets_mainstyle" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">opacity</i><?php RevLoader::_e('Bullets Type', 'revslider');?></div>
				...
				<div id="bullets_style_collapsable" class="collapsable">
					<label_a><?php RevLoader::_e('Bullets Style', 'revslider');?></label_a><select  id="sr_bullets_style"  data-evt="sliderNavUpdate" data-evtparam="bullets" data-r="nav.bullets.style"  class="sliderinput tos2 nosearchbox easyinit sr_nav_style_tos">
						<option value=""><?php RevLoader::_e('No Style', 'revslider');?></option>
					</select>
				</div>
			</div>
			...
			<div id="form_nav_bullets_posi" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">open_with</i><?php RevLoader::_e('Position', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_bul_11"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Gap', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="bullets" data-r="nav.bullets.space" data-min="-100" data-max="500" type="text" id="nav_bullets_space" ><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Orientation', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_bulletdirection" data-evt="sliderNavPositionUpdate" data-evtparam="bullets" data-r="nav.bullets.direction" value="horizontal"><label_sub><?php RevLoader::_e('Horizontal', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_bulletdirection" data-evt="sliderNavPositionUpdate" data-evtparam="bullets" data-r="nav.bullets.direction" value="vertical"><label_sub><?php RevLoader::_e('Vertical', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>
					...
					<label_a><?php RevLoader::_e('Aligned by', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_bulletsalign" data-evt="sliderNavPositionUpdate" data-evtparam="bullets" data-r="nav.bullets.align" value="slider"><label_sub><?php RevLoader::_e('Module Dimension', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_bulletsalign" data-evt="sliderNavPositionUpdate" data-evtparam="bullets" data-r="nav.bullets.align" value="grid"><label_sub><?php RevLoader::_e('Content', 'revslider');?></label_sub>
					</div>
					<div class="div20"></div>
			...
			<div id="form_nav_bullets_visi" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">visibility</i><?php RevLoader::_e('Bullets Visibility', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_bul_1"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Animation', 'revslider');?></label_a><select  id="sr_bullets_animation"  data-r="nav.bullets.anim" class="sliderinput tos2 nosearchbox easyinit">						
						<option value="fade"><?php RevLoader::_e('Fade', 'revslider');?></option>
						<option value="left"><?php RevLoader::_e('From Left', 'revslider');?></option>
						<option value="right"><?php RevLoader::_e('From Right', 'revslider');?></option>
						<option value="top"><?php RevLoader::_e('From Top', 'revslider');?></option>
					...
					<label_a><?php RevLoader::_e('Show Speed', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-numeric="true" data-allowed="ms" data-r="nav.bullets.animSpeed" data-min="1" data-max="10000" type="text" id="nav_bullet_animSpeed"><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Show Delay', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-numeric="true" data-allowed="ms" data-r="nav.bullets.animDelay" data-min="1" data-max="10000" type="text" id="nav_bullet_animDelay"><span class="linebreak"></span>
					<div class="div10"></div>
					<label_a><?php RevLoader::_e('RTL Direction', 'revslider');?></label_a><input type="checkbox"  id="sr_bulletrtl" class="sliderinput easyinit" data-r="nav.bullets.rtl"/><span class="linebreak"></span>
					<row class="directrow">
						<onelong><label_a><?php RevLoader::_e('Show Always', 'revslider');?></label_a><input type="checkbox"  id="sr_bulletsalwshow" class="sliderinput easyinit" data-r="nav.bullets.alwaysOn" data-showhide="#nav_bullets_alwaysshow" data-showhidedep="false"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Under', 'revslider');?></label_a><input type="checkbox"  id="sr_bulletshideunder" class="sliderinput easyinit" data-r="nav.bullets.hideUnder" data-showhide="#nav_bullets_hideunderlimit_wr" data-showhidedep="true"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Over', 'revslider');?></label_a><input type="checkbox"  id="sr_bulletshideover" class="sliderinput easyinit" data-r="nav.bullets.hideOver" data-showhide="#nav_bullets_hideoverlimit_wr" data-showhidedep="true"/></onelong>
			...
			<div id="form_nav_bullets_style" class="form_inner open">
				...
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_arr_2"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Preset', 'revslider');?></label_a><select id="sr_bullets_style_preset" data-r="nav.bullets.preset" class="sliderinput tos2" ></select>
					<label_a></label_a><div data-evt="sliderNavPreset" data-evtparam="bullets" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Load', 'revslider');?></div>
					<div data-evt="saveNavPreset" data-evtparam="bullets" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Save', 'revslider');?></div><span class="linebreak"></span>
					<label_a></label_a><div data-evt="deleteNavPreset" data-evtparam="bullets" class="callEventButton basic_action_button autosize"><i class="material-icons">delete</i><?php RevLoader::_e('Delete', 'revslider');?></div>
				</div>
			</div>
		...
		<div id="form_nav_tabs" data-select="#gst_nav_4" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside carouselenable standardenable herodisable collapsed">
			<div class="collectortabwrap"><div id="collectortab_form_nav_tab" class="collectortab form_menu_inside" data-forms='["#form_nav_tabs"]'><i class="material-icons">view_column</i><?php RevLoader::_e('Tabs', 'revslider');?></div></div>

			<!--<div id="nav_tabs_settings_arrow" class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<ul class="form_menu_level_1">
				<li data-target="#form_nav_tabs_mainstyle" class="selected form_menu_level_1_li" id="sr_na_tab_0"><?php RevLoader::_e('Main Style', 'revslider');?></li>
				<li data-target="#form_nav_tabs_visi" class="selected form_menu_level_1_li" id="sr_na_tab_1"><?php RevLoader::_e('Visibility', 'revslider');?></li>
				<li data-target="#form_nav_tabs_posi" class="selected form_menu_level_1_li" id="sr_na_tab_11"><?php RevLoader::_e('Position', 'revslider');?></li>
				<li data-target="#form_nav_tabs_size" class="selected form_menu_level_1_li" id="sr_na_tab_12"><?php RevLoader::_e('Size', 'revslider');?></li>
				<li data-target="#form_nav_tabs_wrap" class="selected form_menu_level_1_li" id="sr_na_tab_13"><?php RevLoader::_e('Wrapper', 'revslider');?></li>
				<li data-target="#form_nav_tabs_style" class="form_menu_level_1_li" id="sr_na_tab_2"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_slide_nav_tabs" class="form_menu_level_1_li" id="sr_na_tab_21"><?php RevLoader::_e('Style', 'revslider');?></li>
			</ul>

			<div id="form_nav_tabs_mainstyle" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">opacity</i><?php RevLoader::_e('Tabs Type', 'revslider');?></div>
				...
				<div id="tabs_style_collapsable" class="collapsable">
					<label_a><?php RevLoader::_e('Tabs Style', 'revslider');?></label_a><select  id="sr_tabs_style"  data-evt="sliderNavUpdate" data-evtparam="tabs" data-r="nav.tabs.style" class="sliderinput tos2 nosearchbox easyinit sr_nav_style_tos">
						<option value=""><?php RevLoader::_e('No Style', 'revslider');?></option>
					</select>
				</div>
			</div>
			...
			<div id="form_nav_tabs_posi" class="form_inner form_menu_inside open">
				...
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Orientation', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_tabsdirection" data-evt="sliderNavPositionUpdate" data-evtparam="tabs" data-r="nav.tabs.direction" value="horizontal"><label_sub><?php RevLoader::_e('Horizontal', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_tabsdirection" data-evt="sliderNavPositionUpdate" data-evtparam="tabs" data-r="nav.tabs.direction" value="vertical"><label_sub><?php RevLoader::_e('Vertical', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>
					...
					<label_a><?php RevLoader::_e('Aligned by', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_tabsalign" data-evt="sliderNavPositionUpdate" data-evtparam="tabs" data-r="nav.tabs.align" value="slider"><label_sub><?php RevLoader::_e('Module Dimension', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_tabsalign" data-evt="sliderNavPositionUpdate" data-evtparam="tabs" data-r="nav.tabs.align" value="grid"><label_sub><?php RevLoader::_e('Content', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>


					<label_a><?php RevLoader::_e('Inner / Outer', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_tabsinnerouter" data-evt="navinnerouter" data-evtparam="tabs" data-r="nav.tabs.innerOuter" value="inner"><label_sub><?php RevLoader::_e('Inner', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_tabsinnerouter" data-evt="navinnerouter" data-evtparam="tabs" data-r="nav.tabs.innerOuter" value="outer-vertical"><label_sub><?php RevLoader::_e('Outer Vertical', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_tabsinnerouter" data-evt="navinnerouter" data-evtparam="tabs" data-r="nav.tabs.innerOuter" value="outer-horizontal"><label_sub><?php RevLoader::_e('Outer Horizontal', 'revslider');?></label_sub>
					</div>
					...
					<label_a><?php RevLoader::_e('Visible amount', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="tabs" data-r="nav.tabs.amount" data-min="1" data-max="100" type="text" id="nav_tabs_amount" >
				</div>
			</div>
			...
			<div id="form_nav_tabs_size" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">photo_size_select_large</i><?php RevLoader::_e('Size', 'revslider');?></div>
			...
			<div id="form_nav_tabs_wrap" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">more</i><?php RevLoader::_e('Wrapper', 'revslider');?></div>
				...
				<div class="collapsable">
					...
					<label_a><?php RevLoader::_e('Span', 'revslider');?></label_a><input type="checkbox" id="sr_tabspan" class="sliderinput easyinit" data-r="nav.tabs.spanWrapper" data-evt="sliderNavPositionUpdate" data-evtparam="tabs"/>
				</div>
			</div>

			<div id="form_nav_tabs_visi" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">visibility</i><?php RevLoader::_e('Tabs Visibility', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_tab_1"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Animation', 'revslider');?></label_a><select  id="sr_tabs_animation"  data-r="nav.tabs.anim" class="sliderinput tos2 nosearchbox easyinit">						
						<option value="fade"><?php RevLoader::_e('Fade', 'revslider');?></option>
						<option value="left"><?php RevLoader::_e('From Left', 'revslider');?></option>
						<option value="right"><?php RevLoader::_e('From Right', 'revslider');?></option>
						<option value="top"><?php RevLoader::_e('From Top', 'revslider');?></option>
					...
					<label_a><?php RevLoader::_e('Show Speed', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-numeric="true" data-allowed="ms" data-r="nav.tabs.animSpeed" data-min="1" data-max="10000" type="text" id="nav_tab_animSpeed"><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Show Delay', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-numeric="true" data-allowed="ms" data-r="nav.tabs.animDelay" data-min="1" data-max="10000" type="text" id="nav_tab_animDelay"><span class="linebreak"></span>					
					<label_a><?php RevLoader::_e('RTL Direction', 'revslider');?></label_a><input type="checkbox"  id="sr_tabsrtl" class="sliderinput easyinit" data-r="nav.tabs.rtl"/><span class="linebreak"></span>
					<row class="directrow">
						<onelong><label_a><?php RevLoader::_e('Show Always', 'revslider');?></label_a><input type="checkbox"  id="sr_tabsalwshow" class="sliderinput easyinit" data-r="nav.tabs.alwaysOn" data-showhide="#nav_tabs_alwaysshow" data-showhidedep="false"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Under', 'revslider');?></label_a><input type="checkbox"  id="sr_tabshideunder" class="sliderinput easyinit" data-r="nav.tabs.hideUnder" data-showhide="#nav_tabs_hideunderlimit_wr" data-showhidedep="true"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Over', 'revslider');?></label_a><input type="checkbox"  id="sr_tabshideover" class="sliderinput easyinit" data-r="nav.tabs.hideOver" data-showhide="#nav_tabs_hideoverlimit_wr" data-showhidedep="true"/></onelong>
			...
			<div id="form_nav_tabs_style" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">palette</i><?php RevLoader::_e('Style Global', 'revslider');?></div>
				<div class="collapsable">
			...
			<div id="form_nav_tabs_style" class="form_inner open">
				<div class="form_inner_header"><i class="material-icons">palette</i><?php RevLoader::_e('Global Style Presets', 'revslider');?></div>
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Preset', 'revslider');?></label_a><select id="sr_tabs_style_preset" data-r="nav.tabs.preset" class="sliderinput tos2" ></select>
					<label_a></label_a><div data-evt="sliderNavPreset" data-evtparam="tabs" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Load', 'revslider');?></div>
					<div data-evt="saveNavPreset" data-evtparam="tabs" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Save', 'revslider');?></div><span class="linebreak"></span>
					<label_a></label_a><div data-evt="deleteNavPreset" data-evtparam="tabs" class="callEventButton basic_action_button autosize"><i class="material-icons">delete</i><?php RevLoader::_e('Delete', 'revslider');?></div>
				</div>
			</div>
		...
		<div id="form_nav_thumbs" data-select="#gst_nav_5" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside carouselenable standardenable herodisable collapsed">
			<div class="collectortabwrap"><div id="collectortab_form_nav_thumb" class="collectortab form_menu_inside" data-forms='["#form_nav_thumbs"]'><i class="material-icons">filter_frames</i><?php RevLoader::_e('Thumbs', 'revslider');?></div></div>
			<!--<div id="nav_thumbs_settings_arrow" class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<ul class="form_menu_level_1">
				<li data-target="#form_nav_thumbs_mainstyle" class="selected form_menu_level_1_li" id="sr_na_thumb_0"><?php RevLoader::_e('Main Style', 'revslider');?></li>
				<li data-target="#form_nav_thumbs_visi" class="selected form_menu_level_1_li" id="sr_na_thumb_1"><?php RevLoader::_e('Visibility', 'revslider');?></li>
				<li data-target="#form_nav_thumbs_posi" class="selected form_menu_level_1_li" id="sr_na_thumb_11"><?php RevLoader::_e('Position', 'revslider');?></li>
				<li data-target="#form_nav_thumbs_size" class="selected form_menu_level_1_li" id="sr_na_thumb_12"><?php RevLoader::_e('Size', 'revslider');?></li>
				<li data-target="#form_nav_thumbs_wrap" class="selected form_menu_level_1_li" id="sr_na_thumb_13"><?php RevLoader::_e('Wrapper', 'revslider');?></li>
				<li data-target="#form_nav_thumbs_style" class="form_menu_level_1_li" id="sr_na_thumb_2"><?php RevLoader::_e('Style', 'revslider');?></li>
				<li data-target="#form_slide_nav_thumbs" class="form_menu_level_1_li" id="sr_na_thumb_21"><?php RevLoader::_e('Style', 'revslider');?></li>
			</ul>

			<div id="form_nav_thumbs_mainstyle" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">opacity</i><?php RevLoader::_e('Thumb Type', 'revslider');?></div>
				...
				<div id="thumbs_style_collapsable" class="collapsable">
					<label_a><?php RevLoader::_e('Thumbs Style', 'revslider');?></label_a><select  id="sr_thumbs_style"  data-evt="sliderNavUpdate" data-evtparam="thumbs" data-r="nav.thumbs.style" class="sliderinput tos2 nosearchbox easyinit sr_nav_style_tos">
						<option value=""><?php RevLoader::_e('No Style', 'revslider');?></option>
					</select>
				</div>
			</div>
			...
			<div id="form_nav_thumbs_posi" class="form_inner form_menu_inside open">
				...
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Orientation', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsdirection" data-evt="sliderNavPositionUpdate" data-evtparam="thumbs" data-r="nav.thumbs.direction" value="horizontal"><label_sub><?php RevLoader::_e('Horizontal', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsdirection" data-evt="sliderNavPositionUpdate" data-evtparam="thumbs" data-r="nav.thumbs.direction" value="vertical"><label_sub><?php RevLoader::_e('Vertical', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>
					...
					<label_a><?php RevLoader::_e('Aligned by', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsalign" data-evt="sliderNavPositionUpdate" data-evtparam="thumbs" data-r="nav.thumbs.align" value="slider"><label_sub><?php RevLoader::_e('Slider', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsalign" data-evt="sliderNavPositionUpdate" data-evtparam="thumbs" data-r="nav.thumbs.align" value="grid"><label_sub><?php RevLoader::_e('Content', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>
					...
					<label_a><?php RevLoader::_e('Inner / Outer', 'revslider');?></label_a>
					<div class="radiooption">
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsinnerouter" data-evt="navinnerouter" data-evtparam="thumbs" data-r="nav.thumbs.innerOuter" value="inner"><label_sub><?php RevLoader::_e('Inner', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsinnerouter" data-evt="navinnerouter" data-evtparam="thumbs" data-r="nav.thumbs.innerOuter" value="outer-vertical"><label_sub><?php RevLoader::_e('Outer Vertical', 'revslider');?></label_sub><span class="linebreak"></span>
						<input class="sliderinput easyinit" type="radio" name="sr_thumbsinnerouter" data-evt="navinnerouter" data-evtparam="thumbs" data-r="nav.thumbs.innerOuter" value="outer-horizontal"><label_sub><?php RevLoader::_e('Outer Horizontal', 'revslider');?></label_sub>
					</div>
					...
					<label_a><?php RevLoader::_e('Visible amount', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-evt="sliderNavPositionUpdate" data-evtparam="thmbs" data-r="nav.thumbs.amount" data-min="1" data-max="100" type="text" id="nav_thumbs_amount" >
				</div>
			</div>
			...
			<div id="form_nav_thumbs_wrap" class="form_inner form_menu_inside open">
				...
				<div class="collapsable">
					...
					<span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Span', 'revslider');?></label_a><input type="checkbox" id="sr_thumbspan" class="sliderinput easyinit" data-r="nav.thumbs.spanWrapper" data-evt="sliderNavPositionUpdate" data-evtparam="thumbs"/>
				</div>
			</div>

			<div id="form_nav_thumbs_visi" class="form_inner form_menu_inside open">
				<div class="form_inner_header"><i class="material-icons">visibility</i><?php RevLoader::_e('Thumbs Visibility', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_thumb_1"><i class="material-icons">arrow_drop_down</i></div>-->
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Animation', 'revslider');?></label_a><select  id="sr_thumbs_animation"  data-r="nav.thumbs.anim" class="sliderinput tos2 nosearchbox easyinit">						
						<option value="fade"><?php RevLoader::_e('Fade', 'revslider');?></option>
						<option value="left"><?php RevLoader::_e('From Left', 'revslider');?></option>
						<option value="right"><?php RevLoader::_e('From Right', 'revslider');?></option>
						<option value="top"><?php RevLoader::_e('From Top', 'revslider');?></option>
					...
					<label_a><?php RevLoader::_e('Show Speed', 'revslider');?></label_a><input class="sliderinput valueduekeyboard  easyinit" data-numeric="true" data-allowed="ms" data-r="nav.thumbs.animSpeed" data-min="1" data-max="10000" type="text" id="nav_thumb_animSpeed"><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Show Delay', 'revslider');?></label_a><input class="sliderinput valueduekeyboard easyinit" data-numeric="true" data-allowed="ms" data-r="nav.thumbs.animDelay" data-min="1" data-max="10000" type="text" id="nav_thumb_animDelay"><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('RTL Direction', 'revslider');?></label_a><input type="checkbox"  id="sr_thumbsrtl" class="sliderinput easyinit" data-r="nav.thumbs.rtl"/><span class="linebreak"></span>
					<row class="directrow">
						<onelong><label_a><?php RevLoader::_e('Show Always', 'revslider');?></label_a><input type="checkbox"  id="sr_thumbsalwshow" class="sliderinput easyinit" data-r="nav.thumbs.alwaysOn" data-showhide="#nav_thumbs_alwaysshow" data-showhidedep="false"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Under', 'revslider');?></label_a><input type="checkbox"  id="sr_thumbshideunder" class="sliderinput easyinit" data-r="nav.thumbs.hideUnder" data-showhide="#nav_thumbs_hideunderlimit_wr" data-showhidedep="true"/></onelong>
					...
					<row class="direktrow">
						<onelong><label_a><?php RevLoader::_e('Hide Over', 'revslider');?></label_a><input type="checkbox"  id="sr_thumbshideover" class="sliderinput easyinit" data-r="nav.thumbs.hideOver" data-showhide="#nav_thumbs_hideoverlimit_wr" data-showhidedep="true"/></onelong>
			...
			<div id="form_nav_thumbs_style" class="form_inner open">
				<div class="form_inner_header"><i class="material-icons">palette</i><?php RevLoader::_e('Global Style Presets', 'revslider');?></div>
				<div class="collapsable">
					<label_a><?php RevLoader::_e('Preset', 'revslider');?></label_a><select id="sr_thumbs_style_preset" data-r="nav.thumbs.preset" class="sliderinput tos2" ></select>
					<label_a></label_a><div data-evt="sliderNavPreset" data-evtparam="thumbs" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Load', 'revslider');?></div>
					<div data-evt="saveNavPreset" data-evtparam="thumbs" class="callEventButton basic_action_button autosize"><i class="material-icons">save</i><?php RevLoader::_e('Save', 'revslider');?></div><span class="linebreak"></span>
					<label_a></label_a><div data-evt="deleteNavPreset" data-evtparam="thumbs" class="callEventButton basic_action_button autosize"><i class="material-icons">delete</i><?php RevLoader::_e('Delete', 'revslider');?></div>
				</div>
			</div>
		...
		<div id="form_nav_pprevima" data-select="#gst_nav_6" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside collapsed">
			<div class="collectortabwrap"><div id="collectortab_form_pprevima" class="collectortab form_menu_inside" data-forms='["#form_nav_pprevima"]'><i class="material-icons">image</i><?php RevLoader::_e('Nav Image Dimensions', 'revslider');?></div></div>
			<!--<div class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<div class="form_inner">
				<div class="form_inner_header"><i class="material-icons">image</i><?php RevLoader::_e('Preview Image', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_thumb_11"><i class="material-icons">arrow_drop_down</i></div>				-->
				<div class="collapsable" style="display:block;padding-bottom:0px">
					
					<!--<longoption><i class="material-icons">language</i><label_a ><?php RevLoader::_e('Image from Stream if exists', 'revslider');?></label_a><input type="checkbox" class="easyinit slideinput" data-r="thumb.fromStream"></longoption>-->
					<row>
		...
		<div id="form_nav_touch" data-select="#gst_nav_7" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside collapsed carouselenable standardenable herodisable">
			<div class="collectortabwrap"><div id="collectortab_form_touch" class="collectortab form_menu_inside" data-forms='["#form_nav_touch"]'><i class="material-icons">pan_tool</i><?php RevLoader::_e('Swipe Settings', 'revslider');?></div></div>
			<!--<div class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<div class="form_inner">
				<div class="form_inner_header"><i class="material-icons">pan_tool</i><?php RevLoader::_e('Touch', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_thumb_11"><i class="material-icons">arrow_drop_down</i></div>				-->
				<div class="collapsable" style="display:block;padding-bottom:0px">
					<div class="carouselunavailable standardavailable sceneavailable">
						<longoption><i class="material-icons"></i><label_a><?php RevLoader::_e('Mobile Swipe Enabled', 'revslider');?></label_a><input type="checkbox"  id="sr_usetouch" class="sliderinput easyinit" data-r="nav.swipe.set"/></longoption>
						<longoption><i class="material-icons"></i><label_a><?php RevLoader::_e('Desktop Swipe Enabled', 'revslider');?></label_a><input type="checkbox"  id="sr_usetouchdesktop" class="sliderinput easyinit" data-r="nav.swipe.setOnDesktop"/></longoption>
					</div>
					<div class="carouselavailable standardunavailable sceneunavailable">
						<longoption><i class="material-icons"></i><label_a><?php RevLoader::_e('Mobile Carousel Swipe', 'revslider');?></label_a><input type="checkbox"  id="sr_usetouch" class="sliderinput easyinit" data-r="nav.swipe.setMobileCarousel"/></longoption>
						<longoption><i class="material-icons"></i><label_a><?php RevLoader::_e('Desktop Carousel Swipe', 'revslider');?></label_a><input type="checkbox"  id="sr_usetouch" class="sliderinput easyinit" data-r="nav.swipe.setDesktopCarousel"/></longoption>
					</div>
					<longoption><i class="material-icons"></i><label_a><?php RevLoader::_e('Block Scroll', 'revslider');?></label_a><input type="checkbox"  id="sr_blockDragVertical" class="sliderinput easyinit" data-r="nav.swipe.blockDragVertical"/></longoption>
					<div class="div15"></div>					
					<label_a><?php RevLoader::_e('Velocity', 'revslider');?></label_a><input class="sliderinput valueduekeyboard smallinput easyinit"  data-r="nav.swipe.velocity" data-min="0" data-max="75" type="text" id="nav_swipe_velocity" ><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Min. Finger', 'revslider');?></label_a><input class="sliderinput valueduekeyboard smallinput easyinit"  data-r="nav.swipe.minTouch" data-min="0" data-max="10" type="text" id="nav_swipe_minTouch" ><span class="linebreak"></span>
					<div class="div15"></div>
					<label_a><?php RevLoader::_e('Swipe Dir', 'revslider');?></label_a>
					<div class="radiooption">
						<input type="radio" name="sr_swipedirection" class="sliderinput easyinit" data-r="nav.swipe.direction" value="horizontal"><label_sub><?php RevLoader::_e('Horizontal', 'revslider');?></label_sub><span class="linebreak"></span>
						<input type="radio" name="sr_swipedirection" class="sliderinput easyinit" data-r="nav.swipe.direction" value="vertical"><label_sub><?php RevLoader::_e('Vertical', 'revslider');?></label_sub><span class="linebreak"></span>
					</div>
					<div class="div20"></div>
				</div>
			</div>
		...
		<div id="form_nav_misc" data-select="#gst_nav_8" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside collapsed carouselenable standardenable herodisable">
			<div class="collectortabwrap"><div id="collectortab_form_misc" class="collectortab form_menu_inside" data-forms='["#form_nav_misc"]'><i class="material-icons">keyboard</i><?php RevLoader::_e('Keyboard Settings', 'revslider');?></div></div>
			<!--<div class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<div class="form_inner">
				<div class="form_inner_header"><i class="material-icons">keyboard</i><?php RevLoader::_e('Keyboard Arrow Navigation', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_thumb_11"><i class="material-icons">arrow_drop_down</i></div>				-->
				<div class="collapsable" style="display:block">
					<label_a><?php RevLoader::_e('Enabled', 'revslider');?></label_a><input type="checkbox"  id="sr_usekeyboard" class="sliderinput easyinit" data-r="nav.keyboard.set"/><span class="linebreak"></span>
					<label_a><?php RevLoader::_e('Direction', 'revslider');?></label_a>
					<div class="radiooption">
						<input type="radio" name="sr_keyboarddirection" class="sliderinput easyinit" data-r="nav.keyboard.direction" value="horizontal"><label_sub><?php RevLoader::_e('Left/Right Arrow Keys', 'revslider');?></label_sub><span class="linebreak"></span>
						<input type="radio" name="sr_keyboarddirection" class="sliderinput easyinit" data-r="nav.keyboard.direction" value="vertical"><label_sub><?php RevLoader::_e('Up/Down Arrow Keys', 'revslider');?></label_sub><span class="linebreak"></span>
					</div>
				</div>
			</div>
		...
		<div id="form_nav_mousescroll" data-select="#gst_nav_9" data-unselect=".nav_submodule_trigger" class="formcontainer form_menu_inside collapsed carouselenable standardenable herodisable">
			<div class="collectortabwrap"><div id="collectortab_form_misc" class="collectortab form_menu_inside" data-forms='["#form_nav_mousescroll"]'><i class="material-icons">mouse</i><?php RevLoader::_e('Mouse Scroll Settings', 'revslider');?></div></div>
			<!--<div class="form_intoaccordion"><i class="material-icons">arrow_drop_down</i></div>-->
			<div class="form_inner">
				<div class="form_inner_header"><i class="material-icons">mouse</i><?php RevLoader::_e('Mouse Scroll Navigation', 'revslider');?></div>
				<!--<div class="form_intoaccordion" data-trigger="#sr_na_thumb_11"><i class="material-icons">arrow_drop_down</i></div>				-->
				<div class="collapsable" style="display:block">
					<label_a><?php RevLoader::_e('Enabled', 'revslider');?></label_a>
					<div class="radiooption">
						<input type="radio" name="sr_mousenavigation" class="sliderinput easyinit" data-r="nav.mouse.set" value="on"><label_sub><?php RevLoader::_e('On', 'revslider');?></label_sub><span class="linebreak"></span>
						<input type="radio" name="sr_mousenavigation" class="sliderinput easyinit" data-r="nav.mouse.set" value="off"><label_sub><?php RevLoader::_e('Off', 'revslider');?></label_sub><span class="linebreak"></span>
						<input type="radio" name="sr_mousenavigation" class="sliderinput easyinit" data-r="nav.mouse.set" value="carousel"><label_sub><?php RevLoader::_e('Carousel', 'revslider');?></label_sub>
					</div>
					<div class="div10"></div>
					<label_a><?php RevLoader::_e('Reverse Scroll', 'revslider');?></label_a>
					<div class="radiooption">
						<input type="radio" name="sr_reversemousenavigation" class="sliderinput easyinit" data-r="nav.mouse.reverse" value="reverse"><label_sub><?php RevLoader::_e('Reverse', 'revslider');?></label_sub><span class="linebreak"></span>
						<input type="radio" name="sr_reversemousenavigation" class="sliderinput easyinit" data-r="nav.mouse.reverse" value="default"><label_sub><?php RevLoader::_e('Default', 'revslider');?></label_sub>
					</div>
