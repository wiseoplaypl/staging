CREATE TABLE IF NOT EXISTS PREFIXmodule_seoimg_rules (
...
CREATE TABLE IF NOT EXISTS PREFIXmodule_seoimg_objects (
	id_rule int(11) unsigned NOT NULL,
	id_obj int(11) unsigned NOT NULL,
	PRIMARY KEY (id_rule, id_obj)
) ENGINE=ENGINE_DEFAULT DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS PREFIXmodule_seoimg_patterns (
	id_rule int(11) unsigned NOT NULL,
	field VARCHAR(100),
	pattern VARCHAR(250),
