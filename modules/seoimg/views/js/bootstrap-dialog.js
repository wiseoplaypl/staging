...
(function($) {
	...
	BootstrapDialog.TYPE_DEFAULT = 'type-default bootstrap';
	BootstrapDialog.TYPE_INFO = 'type-info bootstrap';
	BootstrapDialog.TYPE_PRIMARY = 'type-primary bootstrap';
	BootstrapDialog.TYPE_SUCCESS = 'type-success bootstrap';
	BootstrapDialog.TYPE_WARNING = 'type-warning bootstrap';
	BootstrapDialog.TYPE_DANGER = 'type-danger bootstrap';
    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function() {
			var sizeModal = '';
			if(this.getSizeModal() === 'SIZE_XLARGE') {
				sizeModal = ' modal-lg';
			}
			return $('<div class="modal-dialog'+sizeModal+'"></div>');
        },
		...
		getSizeModal: function() {
			return this.options.sizeModal;
		},
		setSizeModal: function(sizeModal) {
			this.options.size = sizeModal;
            return this;
        },
