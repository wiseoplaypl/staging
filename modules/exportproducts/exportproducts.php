...
class ExportProducts extends Module
{
    ...
    public function install()
    {
        ...
        $this->changeCoreImport();
        return parent::install();
    }

    public function changeCoreImport()
    {
        $data = file('../controllers/admin/AdminImportController.php');
        function replace_a_line($data)
        {
            if (stristr($data, 'if (!isset($product->id_category_default) || !$product->id_category_default) {'))
            {
                return 'if (!isset($product->id_category_default) || !$product->id_category_default || 1==1) {'."\n";
            }
            return $data;
        }

        $data = array_map('replace_a_line', $data);
        file_put_contents('../controllers/admin/AdminImportController.php', implode('', $data));
        return true;
    }

    public function getContent()
    {
        $this->context->controller->informations[] = $this->l('To manage export form, open this page:')." <a href='".$this->context->link->getAdminLink('AdminExportProducts', true)."'/>".$this->l('Export products')."</a>";
        ...
        if ($form == 1) {
            ...
            if (defined('_PS_ADMIN_DIR_')) {
                ...
                if (Configuration::get('mypresta_updates') != 0 || (bool)Configuration::get('mypresta_updates') != false) {
                    ...
                    if (exportproductsUpdate::version($this->version) < exportproductsUpdate::version(Configuration::get('updatev_' . $this->name)) && Tools::getValue('ajax', 'false') == 'false') {
