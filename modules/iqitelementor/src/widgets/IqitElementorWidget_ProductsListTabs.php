    ...
    public function getForm()
    {
        ...
        return [
            ...
            'tabs' => [
                ...
                'fields' => [
                    ...
                    [   'name' => 'products_ids',
                        ...
                        'placeholder' => IqitElementorWpHelper::__( 'Product name  ref', 'elementor' ),
            ...
            'tab_border_color' => [
                ...
                'section' => 'section_style_tabs',
                'selectors' => [
                    '{{WRAPPER}} .nav-tabs .nav-link.active, {{WRAPPER}} .nav-tabs .nav-link:hover, {{WRAPPER}} .nav-tabs .nav-link:focus' => 'border-color: {{VALUE}};',
                ],
            ],
            ...
            'product_text_color' => [
                ...
                'section' => 'section_style_product',
                'selectors' => [
                    '{{WRAPPER}} .product-miniature, {{WRAPPER}} .product-miniature a:link:not(.nav-link):not(.btn), {{WRAPPER}} .product-miniature a:visited:not(.nav-link):not(.btn)' => 'color: {{VALUE}};',
                ],
            ],
            'product_price_color' => [
            ...
            'product_text_color_h' => [
                ...
                'section' => 'section_style_product_h',
                'selectors' => [
                    '{{WRAPPER}} .product-miniature:hover, {{WRAPPER}} .product-miniature:hover a:link:not(.nav-link):not(.btn), {{WRAPPER}} .product-miniature:hover a:visited:not(.nav-link):not(.btn)' => 'color: {{VALUE}};',
                ],
            ],
    ...
    public function parseOptions($optionsSource, $preview = false)
    {
        ...
        foreach ($optionsSource['tabs'] as $tab){
            ...
            if ($source == 'ms') {
                ...
                $products = $this->getProducts($source, $tab['products_limit'], $tab['order_by'], $tab['order_way'], $tab['brand_list']);
            }
            ...
            if ($tab['view'] == 'grid' || $tab['view'] == 'grid_s'){
                ...
                $cls_fix_classes[] = 'desktop-swiper-cls-fix-' . IqitElementorWpHelper::absint( $tab['slides_to_show'] ) . ' swiper-cls-row-fix-' . IqitElementorWpHelper::absint( $tab['items_per_column'] );
                $cls_fix_classes[] = 'tablet-swiper-cls-fix-' . IqitElementorWpHelper::absint( $tab['slides_to_show_tablet'] );
                $cls_fix_classes[] = 'mobile-swiper-cls-fix-' . IqitElementorWpHelper::absint( $tab['slides_to_show_mobile']);

                $parsedTab['cls_fix_classes'] = implode( ' ', $cls_fix_classes);
