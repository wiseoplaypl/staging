...
class Widget_Accordion extends Widget_Base {
	...
	protected function render( $instance = [] ) {
        ...
        <?php $faq = ($instance['faq'] == 'yes') ? true : false;; ?>


		<div class="elementor-accordion" data-active-first="<?php echo $instance['active_first']; ?>" <?php if ($faq){ echo 'itemscope itemtype="https://schema.org/FAQPage"'; }  ?>  >
			<?php $counter = 1; ?>
			<?php foreach ( $instance['tabs'] as $item ) : ?>
				<div class="elementor-accordion-item" <?php if ($faq){ echo 'itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"'; }  ?> >
					<div class="elementor-accordion-title" data-section="<?php echo $counter; ?>">
                        ...
                        <span <?php if ($faq){ echo 'itemprop="name"'; }  ?> > <?php echo $item['tab_title']; ?></span>
					</div>
					<div class="elementor-accordion-content" data-section="<?php echo $counter; ?>" <?php if ($faq){ echo 'itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"'; }  ?> >
                        <div <?php if ($faq){ echo 'itemprop="text"'; }  ?> ><?php echo $this->parse_text_editor( $item['tab_content'], $item ); ?></div>
                    </div>
				</div>
			<?php
				$counter++;
