...
class Widget_Banner extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            'desc_visibility',
            [
                'label' => \IqitElementorWpHelper::__( 'Description visibility', 'elementor' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'block' => \IqitElementorWpHelper::__( 'Visible', 'elementor' ),
                    'none' => \IqitElementorWpHelper::__( 'Hidden', 'elementor' ),
                ],
                'label_block' => true,
                'default' => 'block',
                'section' => 'section_style_content',
                'tab' => self::TAB_STYLE,
                'selectors' => [
                    '{{WRAPPER}} .elementor-iqit-banner .elementor-iqit-banner-description' => 'display: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render( $instance = [] ) {
        $has_content = ! empty( $instance['title_text'] ) || ! empty( $instance['description_text'] ) || ! empty( $instance['above_title_text'] ) || ! empty( $instance['button_text'] );
    ...
    protected function content_template() {
        ...
        if ( settings.image.url ) {
            ...
            html += '<figure class="elementor-iqit-banner-img"><span class="elementor-iqit-banner-overlay"></span>' + imageHtml + '</figure>';
                ...
                var hasContent = !! ( settings.title_text || settings.description_text || settings.button_text || settings.above_title_text);
