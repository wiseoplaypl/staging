...
function tinySetup(config) {
  ...
  var default_config = {
    selector: ".rte",
    plugins: "align colorpicker link image filemanager table placeholder lists advlist code table",
...
function openPsFileManager($fieldId = 'elementor-control-media-field', type = 1) {
  $.fancybox({
    'width'		: 900,
    'href': baseAdminDir + 'filemanager/dialog.php?type=' + type + '&field_id=' + $fieldId,
    'height'	: 600,
    'type'		: 'iframe',
    'autoScale' : false,
