...
class IqitThemeEditorForm
{
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 8,
                                    'name' => $this->module->l('Style 8', 'IqitThemeEditorForm'),
                                    'img' => 'desktop-headers/style8.png'
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    */
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('User/login', 'IqitThemeEditorForm'),
                        'size' => 30,
                    ),
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Dropdown user menu', 'IqitThemeEditorForm'),
                        'desc' => $this->module->l('Show dropdown menu with main account links after user login', 'IqitThemeEditorForm'),
                        'name' => 'h_user_dropdown',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 1,
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Mobile menu content', 'IqitThemeEditorForm'),
                        'name' => 'mm_content',
                        'desc' => $this->module->l('Separate mobile menu - it will take mobile menu selected links from iqitmegamenu module mobile configuration, Same as on desktop - it will transform horizontal desktop tabs into mobile friendly format', 'IqitThemeEditorForm'),
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'accordion',
                                    'name' => $this->module->l('Separate accordion menu content - simple selector', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'panel',
                                    'name' => $this->module->l('Separate panel menu content - simple selector', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'separate',
                                    'name' => $this->module->l('Separate mobile menu - drag&drop menu', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'desktop',
                                    'name' => $this->module->l('From desktop menu: horizontal or vertical(only in sidebar header layout', 'IqitThemeEditorForm'),
                                ),
                                
                                array(
                                   'id_option' => 'desktop-vertical',
                                    'name' => $this->module->l('From vertical menu', 'IqitThemeEditorForm'),
                               ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Expand trigger', 'IqitThemeEditorForm'),
                        'name' => 'mm_expand_trigger',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'entire-link',
                                    'name' => $this->module->l('Entire link', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'arrow',
                                    'name' => $this->module->l('Only icon arrow', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Header and footer', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'border_top' => true
                    ),
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Show footer', 'IqitThemeEditorForm'),
                        'name' => 'mm_hf_footer_visibilty',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 1,
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Show header', 'IqitThemeEditorForm'),
                        'name' => 'mm_hf_header_visibilty',
                        'condition' => array(
                            'mm_content' => '==accordion'
                        ),
                        'options' => array(
                            'query' => array(
                                array(
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Arrow icon', 'IqitThemeEditorForm'),
                        'size' => 30,
                    ),

                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Visibilty', 'IqitThemeEditorForm'),
                        'name' => 'mm_arrow_icon_status',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 0,
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Color', 'IqitThemeEditorForm'),
                        'name' => 'mm_arrow_icon_color',
                        'size' => 30,
                    ),

                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Accordion sub levels tabs', 'IqitThemeEditorForm'),
                        'desc' => $this->module->l('Only on accordion menu type', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'condition' => array(
                            'mm_content' => '==accordion'
                        ),
                    ...
                    array(
                        'type' => 'number',
                        'label' => $this->module->l('Padding', 'IqitThemeEditorForm'),
                        'name' => 'mm_accordion_tab2_padding',
                        'size' => 30,
                        'min' => 0,
                        'class' => 'width-150',
                        'step' => 1,
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Legends', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'condition' => array(
                            'mm_content' => '<=desktop,separate,desktop-vertical',
                        ),
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Submenu', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'border_top' => true,
                        'condition' => array(
                            'mm_content' => '<=desktop,separate,desktop-vertical',
                    ...
                    array(
                        'type' => 'font',
                        'label' => $this->module->l('Column title', 'IqitThemeEditorForm'),
                        'name' => 'mm_submenu_title_typo',
                        'size' => 30,
                        'class' => 'width-150',
                        'min' => 1,
                        'suffix' => 'px',
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Column title color', 'IqitThemeEditorForm'),
                        'name' => 'mm_submenu_title_color',
                        'size' => 30,
                        'condition' => array(
                            'mm_content' => '<=desktop,separate,desktop-vertical',
                        ),
                    ...
                    array(
                        'type' => 'range',
                        'label' => $this->module->l('Column spacing', 'IqitThemeEditorForm'),
                        'name' => 'mm_submenu_column_spacing',
                        'size' => 30,
                        'min' => 0,
                        'max' => 60,
                        'step' => 1,
                    ...
                    array(
                        'type' => 'range',
                        'label' => $this->module->l('Title spacing', 'IqitThemeEditorForm'),
                        'name' => 'mm_submenu_title_spacing',
                        'size' => 30,
                        'min' => 0,
                        'max' => 80,
                        'step' => 1,
                    ...
                    array(
                        'type' => 'range',
                        'label' => $this->module->l('Link spacing', 'IqitThemeEditorForm'),
                        'name' => 'mm_submenu_link_spacing',
                        'size' => 30,
                        'min' => 0,
                        'max' => 60,
                        'step' => 1,
        ...
        return array(
            'form' => array(
                'childForms' => array(
                    ...
                    'iqit-checkout-page'  => $this->module->l('Checkout page', 'IqitThemeEditorForm'),
                ),
                'legend' => array(
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Accordion', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'border_top' => true
                    ),
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Title color', 'IqitThemeEditorForm'),
                        'name' => 'c_accordion_txt',
                        'size' => 30,
                    ),
                    array(
                        'type' => 'font',
                        'label' => $this->module->l('Title font', 'IqitThemeEditorForm'),
                        'name' => 'c_accordion_typo',
                        'size' => 30,
                        'class' => 'width-150',
                        'min' => 1,
                        'suffix' => 'px'
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => '<strong style="color: red">' . $this->module->l('If enabled Faceted search will be showed above product list. 
                                  It is great for one column layouts. If you enable this you should unhook ps_facetedsearch from displayLeftColumn hook
                                  or enable full width layout for category controller') . '</strong>',
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 1,
                                    'name' => $this->module->l('Yes - entire filtering as collapse block', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 2,
                                    'name' => $this->module->l('Yes - each option as dropdown', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Checkbox/radio design', 'IqitThemeEditorForm'),
                        'name' => 'pl_faceted_checkbox_radio',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'default',
                                ...
                                array(
                                    'id_option' => 'button',
                                    'name' => $this->module->l('As buttons', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Hover/active bg', 'IqitThemeEditorForm'),
                        'name' => 'pl_faceted_checkbox_radio_bg',
                        'size' => 30,
                        'condition' => array(
                            'pl_faceted_checkbox_radio' => '==button'
                        ),
                    ),
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Hover/active text color', 'IqitThemeEditorForm'),
                        'name' => 'pl_faceted_checkbox_radio_color',
                        'size' => 30,
                        'condition' => array(
                            'pl_faceted_checkbox_radio' => '==button'
                        ),
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Force equal height', 'IqitThemeEditorForm'),
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 1,
                                    'name' => $this->module->l('Grouped at bottom of thumb ', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 2,
                                    'name' => $this->module->l('Circles in right-top corner', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 'below',
                                    'name' => $this->module->l('Below product list(together with elementor content)', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'above',
                                    'name' => $this->module->l('Above product list (together with elementor  content)', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'above-d',
                                    'name' => $this->module->l('Default description above, elementor content below product list', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'below-d',
                                    'name' => $this->module->l('Default description below, elementor content above product list', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'above-s',
    ...
    public function getCheckoutPageForm()
    {
        return array(
            'form' => array(
                'child' => true,
                'legend' => array(
                    'title' => $this->module->l('Checkout page', 'IqitThemeEditorForm'),
                    'icon' => 'icon-cogs',
                    'id' => 'iqit-checkout-page'
                ),
                'input' => array(
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Header', 'IqitThemeEditorForm'),
                        'name' => 'checkout_header',
                        'desc' => $this->module->l('NOTE: In simple header background, text colors etc are inherit from default header', 'IqitThemeEditorForm'),
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'default',
                                    'name' => $this->module->l('Default - same as on other pages', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'simple',
                                    'name' => $this->module->l('Simple - just logo', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Footer', 'IqitThemeEditorForm'),
                        'name' => 'checkout_footer',
                        'desc' => $this->module->l('NOTE: In simple header background, text colors etc are inherit from default Footer. You can hook modules like elementor, iqithtmlandbanners or iqitlinksmanager in displayCheckoutFooter', 'IqitThemeEditorForm'),
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'default',
                                ...
                                array(
                                    'id_option' => 'simple',
                                    'name' => $this->module->l('Simple - just displayCheckoutFooter hook', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'hidden',
                                    'name' => $this->module->l('Hidden', 'IqitThemeEditorForm'),
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Boxes background', 'IqitThemeEditorForm'),
                        'name' => 'checkout_colors_bg_box',
                        'size' => 30,
                        'condition' => array(
                            'checkout_colors' => '==1'
                        ),
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Boxes txt', 'IqitThemeEditorForm'),
                        'name' => 'checkout_colors_txt_box',
                        'size' => 30,
                        'condition' => array(
                            'checkout_colors' => '==1'
                        ),
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Image layout', 'IqitThemeEditorForm'),
                        'name' => 'pp_image_layout',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'carousel',
                                    'name' => $this->module->l('Carousel with thumbs', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'column',
                                    'name' => $this->module->l('Column', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Images per column', 'IqitThemeEditorForm'),
                        'name' => 'pp_image_column_nb',
                        'condition' => array(
                            'pp_image_layout' => '==column'
                        ),
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 1,
                                    'name' => $this->module->l('1', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 2,
                                    'name' => $this->module->l('2', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 'modal',
                                    'name' => $this->module->l('Modal without inner zoom', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'none',
                                    'name' => $this->module->l('None', 'IqitThemeEditorForm'),
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Add to cart on mobile devices', 'IqitThemeEditorForm'),
                        'name' => 'pp_cart_mobile',
                        'options' => array(
                            'query' => array(
                                array(
                                ...
                                array(
                                    'id_option' => 'float',
                                    'name' => $this->module->l('Float', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Floating add-to-cart area background', 'IqitThemeEditorForm'),
                        'name' => 'pp_cart_mobile_bg',
                        'size' => 30,
                        'condition' => array(
                            'pp_cart_mobile' => '==float'
                        ),
                    ),
                    array(
                        'type' => 'boxshadow',
                        'label' => $this->module->l('Floating add-to-cart area boxshadow', 'IqitThemeEditorForm'),
                        'name' => 'pp_cart_mobile_boxshadow',
                        'size' => 30,
                        'condition' => array(
                            'pp_cart_mobile' => '==float'
                        ),
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 'footer',
                                    'name' => $this->module->l('Product Footer hook', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 'sidebar',
                                    'name' => $this->module->l('Sidebar(desktop), Product Footer hook(mobile)', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Details data', 'IqitThemeEditorForm'),
                        'size' => 30,
                    ),
                    array(
                        'type' => 'select',
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    'id_option' => 'accordion',
                                    'name' => $this->module->l('Accordion', 'IqitThemeEditorForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Position on page', 'IqitThemeEditorForm'),
                        'name' => 'pp_tabs_placement',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'footer',
                                ...
                                array(
                                    ...
                                    'name' => $this->module->l('Right column below add cart', 'IqitThemeEditorForm'),
                                ),
                                     array(
                                    'id_option' => 'leftcolumn',
                                    'name' => $this->module->l('Left column below product images', 'IqitThemeEditorForm'),
                                )
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
        ...
        return array(
            'form' => array(
                'childForms' => array(
                    ...
                    'iqit-compare' => $this->module->l('Products compare', 'IqitThemeEditorForm'),
                ),
                'legend' => array(
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->module->l('Twitter(x) url', 'IqitThemeEditorForm'),
                        'name' => 'sm_twitter',
                        'size' => 30,
                    ),
                    array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->module->l('Tiktok url', 'IqitThemeEditorForm'),
                        'name' => 'sm_tiktok',
                        'size' => 30,
                    ),
                    array(
    ...
    public function getIqitCompareForm()
    {

        $float = $this->basicColorsFields('cp', 'float');

        return array(
            'form' => array(
                'child' => true,
                'legend' => array(
                    'title' => $this->module->l('Products compare', 'IqitThemeEditorForm'),
                    'icon' => 'icon-cogs',
                    'id' => 'iqit-compare'
                ),
                'input' => array(
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 2,
                                    'name' => $this->module->l('DisplayNav only', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 1,
                                    'name' => $this->module->l('Both', 'IqitThemeEditorForm'),
                                ),
                                array(
                                    'id_option' => 0,
                                    'name' => $this->module->l('Float', 'IqitThemeEditorForm'),
    ...
    public function getLabelsForm()
    {
        ...
        $outstock_oosp_l = $this->basicColorsFields('lp', 'outstock_oosp_l');
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'subtitle_separator',
                        'label' => $this->module->l('Out of stock with allowed ordering -Label', 'IqitThemeEditorForm'),
                        'size' => 30,
                    ),
                    $outstock_oosp_l['bg'],
                    $outstock_oosp_l['txt'],
    ...
    public function getCodesForm()
    {
        ...
        $customGoogleDesc = '<div class="alert alert-info">' . $this->module->l('You should to fill only one google tag field. You can decide beetwent Gtag.js and Google tag manager', 'IqitThemeEditorForm') . '<br><a href="https://support.google.com/tagmanager/answer/7582054?hl=EN">
       Read more about diffrence
        </a>
        </div>';
        ...
        return array(
            'form' => array(
                'legend' => array(
                    'title' => $this->module->l('Custom Css/Js/Codes/Google Gtag', 'IqitThemeEditorForm'),
                    'icon' => 'icon-cogs',
                    'id' => 'iqit-codes'
                ),
                'input' => array(
                    array(
                        'type' => 'title_separator',
                        'label' => $this->module->l('Google inntegraton', 'IqitThemeEditorForm'),
                        'size' => 30,
                    ),
                    array(
                        'type' => 'text',
                        'label' => $this->module->l('Google Gtag.js id(GA_MEASUREMENT_ID)', 'IqitThemeEditorForm'),
                        'desc' =>  $customGoogleDesc,
                        'size' => 30,
                        'name' =>  'codes_gtag',
                    ),
                    array(
                        'type' => 'text',
                        'label' => $this->module->l('Google Ggtm.js -  GOOGLE TAG MANAGER ID', 'IqitThemeEditorForm'),
                        'desc' => $this->module->l('if filled it will add google gtag code in head with code', 'IqitThemeEditorForm'),
                        'size' => 30,
                        'name' =>  'codes_gtm',
                    ),
                    array(
                        'type' => 'title_separator',
                        'label' => $this->module->l('Codes', 'IqitThemeEditorForm'),
                        'size' => 30,
