        ...
        <div class="info-tabs">
            ...
            <div class="theme-info">
                ...
                <iframe width="100%" height="180px"
                        src="//iqit-commerce.com/iframe/lastnews/news17.php?product=warehouse&psversion={$ps_version|escape:'html':'UTF-8'}&version={$theme_version|escape:'html':'UTF-8'}"
...
{block name="input_row"}
    ...
    {if $input.type == 'title_separator'}
        ...
        {if isset($input.label)}
            <div class="col-lg-12 title-reparator">{$input.label}</div>{/if}
    ...
    {elseif $input.type == 'subtitle_separator'}
        ...
        <div class="col-lg-8 subtitle-reparator">{$input.label} </div>
    {elseif $input.type == 'wrapper_start'}
        <div class="clearfix">
            <div class="col-lg-4"></div>
            <div class="background-wrapper col-lg-8 clearfix">
...
{block name="input"}
    ...
    {elseif $input.type == 'color2'}
        <div class="form-group">
            <div class="col-lg-4" style="max-width: 170px;">
                <div class="row">
                    <div class="input-group colorpicker-component">
