		...
		{if $post_type == 'gallery' && $post->gallery|@count}
            ...
            <div class="post-gallery__gallery-js">
                {foreach $post->gallery as $image}
                    <a rel="post-gallery-{$post->id_simpleblog_post}" class="blog-fancybox gallery-js__elem" href="{$gallery_dir}{$image.image}.jpg" title="{l s='View full' mod='ph_simpleblog'}"><img src="{$gallery_dir}{$image.image}-thumb.jpg" class="img-responsive" /></a>
                {/foreach}
            </div><!-- .post-gallery -->
					{else}
            <div class="post-gallery__row">
                ...
                <div class="{$galleryCols} col-xs-6 post-gallery__elem">
                    <a rel="post-gallery-{$post->id_simpleblog_post}" class="blog-fancybox" href="{$gallery_dir}{$image.image}.jpg" title="{l s='View full' mod='ph_simpleblog'}"><img src="{$gallery_dir}{$image.image}-square.jpg" class="img-responsive" /></a>
                </div>
                {/foreach}
            </div><!-- .post-gallery -->
					{/if}
