            ...
            {if $node.type==2}
                                            ...
                                            <div class="cbp-category-link-w"><a href="{$category.href}"
                                                ...
                                                {if isset($category.thumb) && $category.thumb != ''}<a
                                                    href="{$category.href}" class="cbp-category-thumb"><img
                                                            class="replace-2x img-fluid" src="{$category.thumb}" loading="lazy"
                ...
                {elseif $node.contentType==6}
                    ...
                    {if isset($node.content.source)}
                        ...
                        <img src="{$node.content.source}" loading="lazy" class="img-fluid cbp-banner-image"
                             {if isset($node.content.alt)}alt="{$node.content.alt}"{/if}
                                {if isset($node.content.size)} {if isset($node.content.size.w)} width="{$node.content.size.w}"{/if} {if isset($node.content.size.h)}height="{$node.content.size.h}"{/if} {/if} />
                ...
                {elseif $node.contentType==7}
                    <ul class="cbp-manufacturers cbp-suppliers row">
                        {foreach from=$node.content.ids item=supplier}
                            ...
                            {if file_exists($myfile)}
                                <li class="col-{$node.content.line} transition-opacity-300">
                                    <a href="{Context::getContext()->link->getSupplierLink($supplier)}"
                                       title="{supplier::getNameById($supplier)}">
                                        <img loading="lazy" src="{$urls.img_sup_url}{$supplier}-small_default.jpg"
                                             ...
                                             alt="{supplier::getNameById($supplier)}"/>
                                    </a>
                                </li>
                            {/if}
                        {/foreach}
