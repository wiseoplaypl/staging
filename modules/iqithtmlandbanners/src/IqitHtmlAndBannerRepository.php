...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayFooter', 'displayCheckoutFooter', 'displayAboveMobileMenu', 'displayHeaderButtons', 'displayHeaderButtonsMobile', 'displayBelowMobileMenu', 'displayFooterBefore', 'displayFooterProduct', 'displayFooterAfter',
            'displayLeftColumn', 'displayRightColumn',  'displayWrapperTopInContainer', 'displayWrapperTop', 'displayNavCenter', 'displayWrapperBottom', 'displayWrapperBottomInContainer',
            'displayCartAjaxInfoModal', 'displayCartAjaxInfoBlock',
            'displayMyAccountDashboard', 'displayReassurance', 'displayRightColumnProduct', 'displayAfterProductThumbs2', 'displayNav1', 'displayNav2', 'displayProductAdditionalInfo',
            'displayTop', 'displayNavFullWidth', 'displayBelowHeader'];
    ...
    public function getDisplayHooksForHelperBanner()
    {
        ...
        $usableHooks = ['displayFooter', 'displayCheckoutFooter',
            'displayCartAjaxInfoModal', 'displayCartAjaxInfoBlock',
            'displayAboveMobileMenu', 'displayBelowMobileMenu', 'displayFooterBefore','displayFooterProduct', 'displayFooterAfter',
            'displayLeftColumn', 'displayRightColumn',   'displayWrapperTopInContainer', 'displayWrapperTop', 'displayWrapperBottom',
            'displayWrapperBottomInContainer',  'displayMyAccountDashboard',  'displayReassurance', 'displayRightColumnProduct', 'displayAfterProductThumbs2', 'displayBanner', 'displayProductAdditionalInfo', 'displayTop', 'displayNavFullWidth', 'displayBelowHeader'];
