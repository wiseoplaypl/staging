...
{else}
    <div id="iqithtmlandbanners-block-{$block.id}" class="iqithtmlandbanners-block iqithtmlandbanners-block-banner swiper-container iqithtmlandbanners-block-banner-slider js-iqithtmlandbanners-block-banner-slider mb-4">
