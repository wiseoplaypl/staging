...
<div class="lg-block">
    <div class="row">
        ...
        {/if}
                    " target="_blank">
                    <img src="{$lg_base_url|escape:'htmlall':'UTF-8'}views/img/publi/banner_miravia_lg_{$lg_iso_code|escape:'htmlall':'UTF-8'}.png"/>
                </a>
            </div>
        </div>
        <div class="col-lg-1">
            <div class="lg-background-image">
                <span class="lg-vertical-text">
                    <a href="{l s='https://www.lineagrafica.es/en/prestashop-modules/' mod='lggooglereviews'}" target="_blank">
