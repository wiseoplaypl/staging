...
<div class="lg-block">
    <div class="pull-left">
        <div class="lg-block-icon">
            <a class="support" href="{l s='https://addons.prestashop.com/en/contact-us' mod='lggooglereviews'}?id_product=85924" target="_blank">
        ...
        <div class="lg-block-icon">
            <a class="opinion" href="{l s='https://addons.prestashop.com/en/ratings.php' mod='lggooglereviews'}" target="_blank">
    ...
    <div class="pull-right">
        ...
        <div class="lg-block-icon right">
            <a class="see-modules" href="{l s='https://addons.prestashop.com/en/22_linea-grafica' mod='lggooglereviews'}" target="_blank">
