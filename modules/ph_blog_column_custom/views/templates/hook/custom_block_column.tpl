{if $hookName =='displayFooter'}
        ...
        <div class="col col-md block block-toggle block-phblogcustom js-block-toggle">
            <h5 class="block-title"><span>{$title}</span></h5>
            <div class="block-content {if $layout == 'list'}products-block{elseif $layout == 'simple_list'}list-block{else}{/if}">
                <ul>
