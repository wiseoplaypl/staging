    ...
    <div class="translations tabbable" id="iqitadditionaltabs_title">
        ...
        <div class="translationsFields tab-content ">
            {foreach from=$languages item=language}
                {if $language.active}
                <div data-locale="{$language.iso_code}" class="translationsFields-iqitadditionaltabs_title_{$language.id_lang} tab-pane{if $id_language == $language.id_lang} show active{/if} translation-field  translation-label-{$language.iso_code}">
...
<fieldset class="form-group">
    ...
    <div class="translations tabbable" id="iqitadditionaltabs_description">
        ...
        <div class="translationsFields tab-content ">
            {foreach from=$languages item=language}
                {if $language.active}
                <div data-locale="{$language.iso_code}" class="iqitadditionaltabs_description translationsFields-iqitadditionaltabs_description_{$language.id_lang} tab-pane{if $id_language == $language.id_lang} show active{/if} translation-field  translation-label-{$language.iso_code}"
                        ...
                        <div class="float-left">
                            ...
                            #{$tab.id_iqitadditionaltab} -
                                    <div class="translations tabbable d-inline-block">
                                        ...
                                        {foreach from=$languages item=language}
                                            {if $language.active}
                                                <div data-locale="{$language.iso_code}" class="translationsFields-iqitadditionaltabs_title_p_{$tab.id_iqitadditionaltab}_{$language.id_lang} {if $id_language == $language.id_lang} show active{/if}   translation-field  translation-label-{$language.iso_code}">{$tab.title[$language.id_lang]}</div>
                                            {/if}
                                        {/foreach}
                                        </div>
                                    </div>
