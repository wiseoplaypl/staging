...
class ControlsManager
{
     ...
     *
     * @return Group_Control_Base|Group_Control_Base[]|null
     */
     ...
     *
     * @return array|null A list of stacks
     */
     ...
     * @param ControlsStack $controls_stack Controls stack
     *
     * @return array|null Stack data if it exist, `null` otherwise
     */
     ...
     *
     * This method adds a new control for the "Custom CSS" feature.
     *
     * @since 1.0.0
     *
     ...
     * @param string $tab
     */
    public function addCustomCssControls(ControlsStack $controls_stack, $tab = self::TAB_ADVANCED)
    {
    ...
    // public function addCustomAttributesControls(ControlsStack $controls_stack)
}
