...
class gmfeed extends Module
{
    ...
    {
        if (Tools::getValue('controller') == 'AdminExportProductsFeedGoogle') {
    ...
    public function installsql()
    {
        ...
        $statements[] = "CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "gms` (
        `id_gms` int(5) unsigned NOT NULL AUTO_INCREMENT,
        `name` VARCHAR(250) NULL,
        `conf` TEXT NULL,
        KEY `idtoskey` (`id_gms`)) ENGINE=" . _MYSQL_ENGINE_ . " DEFAULT CHARSET=utf8;";
