...
{if !isset($active)}
<a class="grid_prod_setting button btn btn-default" href="{Context::getContext()->link->getAdminLink('AdminProductGrid', true)|escape:'quotes':'UTF-8'}">{l s='Back to the module' mod='dgridproductslite'}</a>
