...
{if isset($display_multishop_checkboxes) && $display_multishop_checkboxes}
	<div class="panel clearfix">
		<label class="control-label col-lg-3">
			<i class="icon-sitemap"></i> {l s='Multistore' mod='dgridproductslite'}
		</label>
		<div class="col-lg-9">
			<div class="row">
				<div class="col-lg-4">
			...
			<div class="row">
				<div class="col-lg-12">
					<p class="help-block">
						<strong>{l s='Check / Uncheck all' mod='dgridproductslite'}</strong> {l s='(If you are editing this page for several shops, some fields may be disabled. If you need to edit them, you will need to check the box for each field)' mod='dgridproductslite'}
					</p>
				</div>
			</div>
		</div>
