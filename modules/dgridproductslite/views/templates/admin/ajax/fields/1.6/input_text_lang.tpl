...
{if isset($maxchar)}
  ...
  <span id="{$input_name|escape:'quotes':'UTF-8'}_{$language.id_lang|escape:'quotes':'UTF-8'}_counter"
        class="input-group-addon">
				<span class="text-count-down">{$maxchar|escape:'quotes':'UTF-8'}</span>
			</span>
{/if}
  <input type="text"
         data-name="{$data[$language.id_lang]|htmlentitiesUTF8|default:''|no_escape}"
