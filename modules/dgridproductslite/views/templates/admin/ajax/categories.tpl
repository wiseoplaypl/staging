...
<div class="title_product">{l s='Edit product' mod='dgridproductslite'}: {$product->name|escape:'quotes':'UTF-8'}
</div>
...
<div class="form-group">
	<label class="control-label col-lg-4" for="id_category_default">
                                <span class="label-tooltip label-category" data-toggle="tooltip" title="{l s='The default category is the main category for your product, and is displayed by default.' mod='dgridproductslite'}">
                                    {l s='Default category' mod='dgridproductslite'}
                                </span>
	</label>
	<div class="col-lg-5">
		<select class="custom-select" id="id_category_default_{$product->id|intval}" name="id_category_default">
