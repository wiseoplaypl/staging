...
<script>
    ...
    var snap_the_child_categories = "{l s='snap_the_child_categories' mod='dgridproductslite'}";
    var only_default = "{l s='only_default' mod='dgridproductslite'}";

    function snapTheChildCategories() {
        $.alert(snap_the_child_categories);
        setTimeout(function() {
...
{if isset($view_header) && $view_header && isset($root) && $root}
	<div class="tree_categories_header col-lg-12 form-group">
		<a class="collapse_all btn btn-default button" href="#" style="display: none;">
			<i class="icon-collapse-alt"></i>
			{l s='Collapse all' mod='dgridproductslite'}
		</a>
		<a class="expand_all btn btn-default button" href="#">
			<i class="icon-expand-alt"></i>
			{l s='Expand all' mod='dgridproductslite'}
		</a>
		<a class="check_all_associated_categories btn btn-default button" href="#">
			<i class="icon-check-sign"></i>
			{l s='Check all' mod='dgridproductslite'}
		</a>
		<a class="uncheck_all_associated_categories btn btn-default button" href="#">
			<i class="icon-check-empty"></i>
			{l s='Uncheck all' mod='dgridproductslite'}
		</a>
			<span class="wrapp_search_category margin-right">
				<input type="text" class="search_category fixed-width-md">
			</span>

		<div class="wrap_snap_category">
			<div>
				<label class="control-label">
					<input class="form-group" type="checkbox" id="bind_child" /> {l s='Snap the child categories' mod='dgridproductslite'}
				</label>
				<span onclick="snapTheChildCategories()" class="help-box"></span>
			</div>
			<div>
				<label class="control-label">
					<input class="form-group" type="checkbox" id="search_default_categories"{if Tools::getValue('search_default_categories')} checked{/if} /> {l s='Only default' mod='dgridproductslite'}
				</label>
...
{elseif $root}
	{l s='Not categories' mod='dgridproductslite'}
{/if}