                ...
                {/if}
                    {if isset($tr.$key)}
                        ...
                        {/if}
                            ...
                            {if $params.table == 'specific_price' && $tr.$key == -1}
                            {else}
        ...
        <div class="form_edit_field{if $ps_v < 1.6} v15{/if}">
            {if $params.type == 'datepicker'}
                <input
                        ...
                        class="type_{if isset($params.validate) && $params.validate}{$params.validate|escape:'quotes':'UTF-8'}{else}{$params.type|escape:'quotes':'UTF-8'}{/if}" value="{if array_key_exists("`$key`_no_format", $tr)}{$tr["`$key`_no_format"]|escape:'quotes':'UTF-8'}{else}{if isset($tr.$key) && $tr.$key}{if isset($params.validate) && $params.validate == price}{$tr.$key|replace:' ':''|replace:',':'.'|floatval}{else}{$tr.$key|escape:'quotes':'UTF-8'}{/if}{/if}{/if}">
            {else}
                <textarea
                    ...
                    data-field-lang="{$params.lang|escape:'quotes':'UTF-8'}"
                    {if isset($rate) && in_array($params.field, ['price', 'price_final'])}data-rate="{$rate|escape:'quotes':'UTF-8'}"{/if}
                    class="type_{if isset($params.validate) && $params.validate}{$params.validate|escape:'quotes':'UTF-8'}{else}{$params.type|escape:'quotes':'UTF-8'}{/if}">{if isset($params.validate) && $params.validate == 'select'}{$tr[$params.query.editable_value]|escape:'quotes':'UTF-8'}{else}{if array_key_exists("`$key`_no_format", $tr)}{$tr["`$key`_no_format"]|escape:'quotes':'UTF-8'}{else}{if isset($tr.$key) && $tr.$key}{if isset($params.validate) && $params.validate == price}{$tr.$key|replace:' ':''|replace:',':'.'|floatval}{else}{$tr.$key|escape:'quotes':'UTF-8'}{/if}{/if}{/if}{/if}</textarea>
