...
*}
<a class="SMPro_settings button btn btn-default" href="{Context::getContext()->link->getAdminLink('AdminSiteMapPro', true)|escape:'quotes':'UTF-8'}">{l s='Back' mod='sitemappro'}</a>
<div class="form-group tab_manager clearfix custom_bootstrap">
    <div class="col-lg-3">
        <div class="panel">
