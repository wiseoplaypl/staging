...
class ConfSMP
{
    protected static $module_prefix = 'SMP';
    ...
    public static function getConf($name, $id_lang = null, $id_shop_group = null, $id_shop = null)
    {
        return Configuration::get(self::formatConfName($name), $id_lang, $id_shop_group, $id_shop);
    }
    ...
    public static function setConf($name, $values, $html = false, $id_shop_group = null, $id_shop = null)
    {
