...
{block name="input_row"}
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-lg-3">
                {l s='New window' mod='iqitlinksmanager'}
            </label>
            <div class="col-lg-7">
                <select class="link-window">
                    <option value="0">{l s='No' mod='iqitlinksmanager'}</option>
                    <option value="1" {if isset($page.window) && $page.window} selected="selected"{/if}>{l s='Yes' mod='iqitlinksmanager'}</option>
                </select>
            </div>
        </div>
    {/strip}
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <select class="link-window">
                    <option value="0">{l s='No' mod='iqitlinksmanager'}</option>
                    <option value="1">{l s='Yes' mod='iqitlinksmanager'}</option>
                </select>
            </div>
        </div>
    </div>
