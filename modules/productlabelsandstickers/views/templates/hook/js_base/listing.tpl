...
$('#stickers_{/literal}{$id|escape:'htmlall':'UTF-8'}{literal}').parent().parent().find('.product_img_link')
    .append("{/literal}<span {if !empty($stick.title) && $stick.text_status > 0}class='fmm_title_text_sticker fmm_sticker_base_span'{else}class='fmm_sticker_base_span' {/if}style='{if !empty($stick.title) && $stick.text_status > 0}text-align:{$stick.x_align|escape:'htmlall':'UTF-8'};{/if}{if empty($stick.sticker_image) && $stick.text_status > 0}width:auto;{/if}display: inline-block; z-index: 9;position: absolute;{if $stick.x_align == 'center' && $stick.y_align == 'center'}left:0%; width: 100%; text-align: center;top: {$stick.axis|escape:'htmlall':'UTF-8'}%;{elseif $stick.x_align == 'center' && $stick.y_align == 'top'}left:0%; width: 100%; text-align: center;top: 1%;{elseif $stick.x_align == 'center' && $stick.y_align == 'bottom'}left:0%; width: 100%; text-align: center;bottom: 1%;{elseif $stick.x_align == 'left' && $stick.y_align == 'center'}left:0%; top: {$stick.axis|escape:'htmlall':'UTF-8'}%; text-align: left;{elseif $stick.x_align == 'right' && $stick.y_align == 'center'}right:0%; text-align: right; top: {$stick.axis|escape:'htmlall':'UTF-8'}%;{/if} {if !empty($stick.title) && $stick.text_status > 0}width:{$stick.sticker_size|escape:'htmlall':'UTF-8'}%;{/if}'>{if !empty($stick.title) && $stick.text_status > 0}<span class='sticker-text' style='{if !empty($stick.title) && $stick.text_status > 0 && $stick.sticker_type == 'text'}background-color:{$stick.bg_color|escape:'htmlall':'UTF-8'}{/if};color:{$stick.color|escape:'htmlall':'UTF-8'};font-family:{$stick.font|escape:'htmlall':'UTF-8'};font-size:{if $current_page == "index"}{$stick.font_size|escape:'htmlall':'UTF-8'}{elseif $current_page == "category"}{$stick.font_size_listing|escape:'htmlall':'UTF-8'}{else}{$stick.font_size_product|escape:'htmlall':'UTF-8'}{/if}px;'>{/if}{if !empty($stick.sticker_image)}<img style='box-shadow:unset;{if $stick.text_status <= 0}width:{$stick.sticker_size|escape:'htmlall':'UTF-8'}%{/if};{if $stick.sticker_type == 'image'}width:{if $stick.page_type == 'listing'}{$stick.sticker_size_list|escape:'htmlall':'UTF-8'}{/if}{if $stick.page_type == 'product'}{$stick.sticker_size|escape:'htmlall':'UTF-8'}{/if}{if $stick.page_type == 'index'}{$stick.sticker_size_home|escape:'htmlall':'UTF-8'}{/if}% !important{/if};' src='{$base_image|escape:'htmlall':'UTF-8'}{$stick.sticker_image|escape:'htmlall':'UTF-8'}' />{/if}{if !empty($stick.sticker_image)}<br>{/if}{if !empty($stick.title) && $stick.text_status > 0 && $stick.sticker_type == 'text'}<i>{$stick.title|escape:'htmlall':'UTF-8'}</i>{/if}{if !empty($stick.title) && $stick.text_status > 0}</span>{/if}{if $stick.tip > 0}<span class='fmm_hinter {if $stick.tip_pos > 0}fmm_hinter_l{if $stick.text_status > 0}_txt{/if}{else}fmm_hinter_r{if $stick.text_status > 0}_txt{/if}{/if}' style='color: {$stick.tip_color|escape:'htmlall':'UTF-8'}; background: {$stick.tip_bg|escape:'htmlall':'UTF-8'};'><b style='color: {$stick.tip_bg|escape:'htmlall':'UTF-8'};'></b>{$stick.tip_txt|escape:'htmlall':'UTF-8'}</span>{/if}</span>");
{/if}
</script>
{/foreach}
</div>
