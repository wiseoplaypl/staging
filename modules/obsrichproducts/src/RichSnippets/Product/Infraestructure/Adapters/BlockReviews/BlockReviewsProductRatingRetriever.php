...
class BlockReviewsProductRatingRetriever implements ProductRatingRetrieverInterface
{
    /**
     * @return bool
     */
    ...
    public function getProductRating(ProductInterface $product)
    {
        ...
        $countReviews = $obj_reviewshelp->getCountReviews(
            array(
                'id_product' => (int) $product->getId(),
            )
        );
        $avgRating = $obj_reviewshelp->getAvgReview(
            array(
                'id_product' => (int) $product->getId(),
            )
        );
