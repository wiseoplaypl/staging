...
namespace OBSolutions\RichSnippets\Product\Infraestructure\MyPrestaComments;
...
class MyPrestaCommentsProductReviewRetriever implements ProductReviewRetrieverInterface
{
    /**
     * @return bool
     */
    public static function enabled()
    {
        ...
        return is_callable('MyprestaComment', 'getByProduct');
    }
    ...
    public function getProductReviews(ProductInterface $product)
    {
        ...
        $comments = MyprestaComment::getByProduct($product->getId());
