...
var u_ajax_url = '../index.php?fc=module&module=ultimateimagetool&controller=ajax';
...
function trigger_product_regenerate_images(image_typer, convert)
{
		...
		var max_products = parseFloat(jQuery('#products_max').html());
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: action,  token: uit_token, image_type: image_typer, image_quality: quality  }, 
			async: true,
...
jQuery(document).ready(function(){
	    ...
	    'data' : {
	      ...
	      'data' : function (node) {
	      	...
	      	if(typeof node.li_attr !== "undefined")
	      		...
	      		folder = '';
	        return { action: 'get_subfolders',token: uit_token, folder:  folder };
	      }
	    }
	  }
	});
	...
	jQuery('body').on('click','#uit_convert_custom .jstree li a', function(){
		...
		selected_el.notify("Getting images from subfolders. Please wait", "info");
			...
			var response_z = $.ajax({ 
				...
				dataType : 'html',
				cache: false,
				data: {  action: 'get_subfolders_and_images',  folder: rel, token: uit_token}, 
				async: true,
				success: function(msg) {
					obj = JSON.parse(msg);
	...
	jQuery('body').on('click','.UltimateImageTool_supplierreset', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size',  token: uit_token, image_type: type, type: 'supplier' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_manufacturerreset', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size',  token: uit_token, image_type: type, type: 'manufacturer' }, 
			async: true,
			success: function(msg) {
	...
	function regenerate_image_size()
	{
		...
		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'regenerate_image_sizes',  token: uit_token, regenerate_type: regenerate_type, regenerate_size: regenerate_size, offset: regeneration_offset}, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_supplierresetConvert', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size_convert',  token: uit_token, image_type: type, type: 'supplier' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_manufacturerresetConvert', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size_convert',  token: uit_token, image_type: type, type: 'manufacturer' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_categoryresetConvert', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size_convert',  token: uit_token, image_type: type, type: 'category' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_categoryreset', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size',  token: uit_token, image_type: type, type: 'category' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_productreset', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size',  token: uit_token, image_type: type, type: 'product' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_productresetConvert', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size_convert',  token: uit_token, image_type: type, type: 'product' }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.UltimateImageTool_categoryreset', function(){
		...
		var type = parent.find('.hidden_image_type').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'reset_image_size',  token: uit_token, image_type: type }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.switch_logs', function(){
		...
		var val = jQuery(this).attr('page');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'get_logs',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
	...
	function delete_image()
	{
		...
		var response_z = $.ajax({ 
					...
					dataType : 'html',
					cache: false,
					data: {  action: 'delete_images',  token: uit_token, type: type, size: size, offset: delete_offset  }, 
					async: true,
					success: function(msg) {
						var  obj = JSON.parse(msg);
		...
		function doneTyping () 
		{
			...
			var val  = $('#alt_syntax').val();
	  		var response_z = $.ajax({ 
				...
				dataType : 'html',
				cache: false,
				data: {  action: 'update_alt_syntax',  token: uit_token, val: val  }, 
				async: true,
				success: function(msg) {
	...
	jQuery('body').on('change','#uit_webp', function(){
		...
		var el = jQuery(this);
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'update_wepb_status',  token: uit_token, val: val  }, 
			async: true,
			success: function(msg) {
				var  obj = JSON.parse(msg);
				 if(obj.error == 0)
	...
	jQuery('body').on('change','#uit_auto_webp', function(){
		...
		var el = jQuery(this);
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'update_uit_auto_webp',  token: uit_token, val: val  }, 
			async: true,
			success: function(msg) {
				var  obj = JSON.parse(msg);
				 if(obj.error == 0)
	...
	jQuery('body').on('change','#delete_type', function(){
		...
		jQuery('.type_delete').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'get_image_sizes',  token: uit_token, val: val  }, 
			async: true,
			success: function(msg) {
				var  obj = JSON.parse(msg);
				 if(obj.error == 0)
	...
	jQuery('body').on('change','#image_quality, #image_quality_cat, #image_quality_theme, #image_quality_sup, #image_quality_theme,#image_quality_cms,  #image_quality_module', function(){
		...
		var type = jQuery(this).attr('rel');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'image_quality',  token: uit_token, val: val, type: type  }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('change','#lazy_load_active', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'lazy_load_status',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#sitemap_image_size', function(){
		...
		jQuery('.sitemap_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'sitemap_image_type',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#cron_image_quality', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'cron_image_quality',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#product_per_excution', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'product_per_excution',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_hover_image_type', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'mouse_hover_image_type',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_mouse_hover_thumb', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'uit_mouse_hover_thumb',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_mouse_hover_ts', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'uit_mouse_hover_ts',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_mouse_hover_ps', function(){
		...
		jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'uit_mouse_hover_ps',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_mouse_hover', function(){
		...
		//jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'mouse_hover_status',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#alt_tags_auto', function(){
		...
		//jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'alt_tags_auto',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('change','#uit_image_position', function(){
		...
		//jQuery('.lazy_html').addClass('hidden');
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'mouse_hover_position',  token: uit_token, val: val }, 
			async: true,
			success: function(msg) {
				 	var  obj = JSON.parse(msg);
					 if(obj.is_end == 1)
	...
	jQuery('body').on('click','.get_cms_images_webp', function(){
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'search_and_optimize_in_folder',  token: uit_token,  path:  jQuery(this).attr('rel'), webp: 1 }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.get_cms_images', function(){
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'search_and_optimize_in_folder',  token: uit_token,  path:  jQuery(this).attr('rel') }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.get_theme_images_webp', function(){
		...
		current_el.notify("Tag generation started, please wait", "info");
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'generate_tags',  token: uit_token,  alt_syntax:  jQuery('#alt_syntax').val(), alt_apply:  jQuery('#alt_apply').val() }, 
			async: true,
			success: function(msg) {
	...
	function convert_file_image(el, type, quality)
	{
		...
		if(file.length == 0)
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'convert_in_folder',  token: uit_token,  path:  file.attr('rel'), url:  file.attr('url'), quality: quality, type: type  }, 
			async: true,
			success: function(msg) {
	...
	function compress_file_image(el, type,quality )
	{
		...
		if(file.length == 0)
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'optimize_in_folder',  token: uit_token,  path:  file.attr('rel'), url:  file.attr('url'), quality: quality, type: type  }, 
			async: true,
			success: function(msg) {
	...
	jQuery('body').on('click','.generate_test', function(){
		...
		var test_quality = jQuery('#test_quality').val();
  		...
  		var response_z = $.ajax({ 
			...
			dataType : 'html',
			cache: false,
			data: {  action: 'generate_test',  token: uit_token, test_quality: test_quality }, 
			async: true,
			success: function(msg) {
				...
				jQuery('#img_test').html('<img src="'+img+'" />');
	...
	jQuery('body').on('change','.update_config_select', function(){
		...
		var current_el =  jQuery(this);
	  		...
	  		var response_z = $.ajax({ 
				...
				dataType : 'html',
				cache: false,
				data: {  action: 'update_configuration',  token: uit_token, variable: current_el.attr('rel'), value: current_el.val() }, 
				async: true,
				success: function(msg) {


					current_el.notify("Updated", "success");
					//$.notify("Updated value", "success");
					//obj = JSON.parse(msg);
					//var img = obj.path;
	...
	jQuery('body').on('click','.prestashop-switch label', function(){

		var current_el =  jQuery(this);
		var el = current_el.attr('for');
		...
		if(!jQuery('#'+el).attr('rel'))
			return ;
	  		...
	  		var response_z = $.ajax({ 
				...
				dataType : 'html',
				cache: false,
				data: {  action: 'update_configuration',  token: uit_token, variable: jQuery('#'+el).attr('rel'), value: jQuery('#'+el).val() }, 
				async: true,
				success: function(msg) {
