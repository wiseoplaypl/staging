	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select class="image_quality" id="image_quality_module" name="image_quality_module" rel="module" style="width:70px;">
		    			<option value="60" {if $uit_quality_module == 60} selected="selected" {/if}>{l s='60' mod='ultimateimagetool'}</option>
		    			<option value="70" {if $uit_quality_module == 70} selected="selected" {/if}>{l s='70' mod='ultimateimagetool'}</option>
		    			<option value="80" {if $uit_quality_module == 80} selected="selected" {/if}>{l s='80' mod='ultimateimagetool'}</option>
		    			<option value="90" {if $uit_quality_module == 90} selected="selected" {/if}>{l s='90' mod='ultimateimagetool'}</option>
		    			<option value="100" {if $uit_quality_module == 100} selected="selected" {/if}>{l s='100' mod='ultimateimagetool'}</option>
		    		</select>
