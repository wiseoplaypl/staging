	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select id="image_quality_manuf_convert" name="image_quality_manuf" rel="manufacturer">
		    			<option value="70" {if $uit_quality_manuf == 70} selected="selected" {/if}>{l s='70' mod='ultimateimagetool'}</option>
		    			<option value="80" {if $uit_quality_manuf == 80} selected="selected" {/if}>{l s='80' mod='ultimateimagetool'}</option>
		    			<option value="85" {if $uit_quality_manuf == 85} selected="selected" {/if}>{l s='85' mod='ultimateimagetool'}</option>
		    			<option value="90" {if $uit_quality_manuf == 90} selected="selected" {/if}>{l s='90' mod='ultimateimagetool'}</option>
		    			<option value="95" {if $uit_quality_manuf == 95} selected="selected" {/if}>{l s='95' mod='ultimateimagetool'}</option>
		    			<option value="100" {if $uit_quality_manuf == 100} selected="selected" {/if}>{l s='100' mod='ultimateimagetool'}</option>
