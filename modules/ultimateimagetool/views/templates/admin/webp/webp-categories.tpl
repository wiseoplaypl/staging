	    	...
	    	<tr>
	    		...
	    		<td>
		    		...
		    		<select id="image_quality_cat_convert" name="image_quality_cat" rel="product">
		    			...
		    			<option value="85" {if $uit_quality_cat == 85} selected="selected" {/if}>{l s='85' mod='ultimateimagetool'}</option>
		    			<option value="90" {if $uit_quality_cat == 90} selected="selected" {/if}>{l s='90' mod='ultimateimagetool'}</option>
		    			<option value="95" {if $uit_quality_cat == 95} selected="selected" {/if}>{l s='95' mod='ultimateimagetool'}</option>
