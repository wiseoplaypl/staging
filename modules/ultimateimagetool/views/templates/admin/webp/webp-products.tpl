	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select id="image_quality_convert" name="image_quality_cat" rel="product">
		    			<option value="70" {if $uit_quality == 70} selected="selected" {/if}>{l s='70' mod='ultimateimagetool'}</option>
		    			<option value="80" {if $uit_quality == 80} selected="selected" {/if}>{l s='80' mod='ultimateimagetool'}</option>
		    			<option value="85" {if $uit_quality == 85} selected="selected" {/if}>{l s='85' mod='ultimateimagetool'}</option>
		    			<option value="90" {if $uit_quality == 90} selected="selected" {/if}>{l s='90' mod='ultimateimagetool'}</option>
		    			<option value="95" {if $uit_quality == 95} selected="selected" {/if}>{l s='95' mod='ultimateimagetool'}</option>
		    			<option value="100" {if $uit_quality == 100} selected="selected" {/if}>{l s='100' mod='ultimateimagetool'}</option>
		    		</select>
