...
class IqitProductTags extends Module implements WidgetInterface
{
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        if (preg_match('/^displayProductAdditionalInfo\d*$/', $hookName)) {
            $idProduct = (int) $configuration['product']['id_product'];
        } else{
            $idProduct = $configuration['smarty']->tpl_vars['product']->value['id'];
        }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (preg_match('/^displayProductAdditionalInfo\d*$/', $hookName)) {
            ...
            $tags = Tag::getProductTags((int) $configuration['smarty']->tpl_vars['product']->value['id']);
        }
