        ...
        <div class="content-lists--child extras">
            <h3>
                <i class="fas fa-network-wired mr-1"></i>
                 {l s='Lists' mod='pshubspot'}
            </h3>

            <div class="table table-responsive p-3">
                <table class="table-striped w-100 text-left">
                    <thead>
                    <tr>
                        <th class="px-1">{l s='Name' mod='pshubspot'}</th>
                     ...
                     {foreach $lists as $list}
                        <tr>
                            ...
                            <td class="text-center">
                                 ...
                                 {else}
                                    <form method="POST" id="form_{$list.id|escape:'htmlall':'UTF-8'}">
                                        <input type="hidden" name="id" value="{$list.id|escape:'htmlall':'UTF-8'}}"/>
                                        <button name="ps-hubspot_sync_list" id="ps-hubspot_sumbit_btn"
                                                class="button-custom px-1 py-1 ml-0 mr-0 mb-0" type="submit" onclick="hs_sync_list({$list.id|escape:'htmlall':'UTF-8'})">
