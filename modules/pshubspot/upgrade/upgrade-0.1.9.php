 ...
 */
function upgrade_module_0_1_9($module)
{
    $sql = [];
    /*
    ...
    ("deal","cart_products_html","cart_details","' . $module->l('Abandoned Cart Products HTML') . '","string","textarea",0,"","");';

    $sql[] = 'INSERT IGNORE INTO `' . _DB_PREFIX_ . 'tiralineas_available_groups`
    (`object_type`,`name`,`label`) VALUES
    ("deal","cart_details","' . $module->l('Cart Details') . '");';
