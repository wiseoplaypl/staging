...
class LscPkHeader extends LscIntegration
{
    const NAME = 'pspagebuilder';

    protected function init()
    {
        $confData = [
            EsiConf::FLD_PRIV => 1,
            EsiConf::FLD_TAG => 'pkheader',
            EsiConf::FLD_PURGE_CONTROLLERS => 'CartController?id_product, pkfavoritesActionsModuleFrontController',
            EsiConf::FLD_HOOK_METHODS => 'hookdisplayHeaderBuilder',
        ];
