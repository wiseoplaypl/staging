...
{/if}
	...
	{foreach $product['customizedDatas'] as $customizationPerAddress}
		{foreach $customizationPerAddress as $customizationId => $customization}
			{capture name="htmlFileNoCustomer"}{$smarty.const._PS_IMG_DIR_}scenes/ndkcf/pdf/0/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
			
			{capture name="htmlFile"}{$smarty.const._PS_IMG_DIR_}scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
			
			{capture name="recipientPdf"}{$smarty.const._PS_IMG_DIR_}scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_WEB{$order->reference}.pdf{/capture}
			{capture name="recipientPdf_new"}{$smarty.const._PS_IMG_DIR_}scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_{$customizationId}_WEB{$order->reference}.pdf{/capture}	
					
			{if Tools::file_exists_no_cache($smarty.capture.htmlFile)}
			
				{capture name="htmlLink"}../img/scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
				
			{elseif Tools::file_exists_no_cache($smarty.capture.htmlFileNoCustomer)}
				
				{capture name="htmlLink"}../img/scenes/ndkcf/pdf/0/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
			...
			{if Tools::file_exists_no_cache($smarty.capture.recipientPdf)}
				{capture name="recipientLink"}../img/scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_WEB{$order->reference}.pdf{/capture}
			{elseif Tools::file_exists_no_cache($smarty.capture.recipientPdf_new)}
				{capture name="recipientLink"}../img/scenes/ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_{$customizationId}_WEB{$order->reference}.pdf{/capture}
