...
{/if}
	...
	{foreach $product['customizedDatas'] as $customizationPerAddress}
		{foreach $customizationPerAddress as $customizationId => $customization}
			...
			{capture name="htmlFileNoCustomer"}{$smarty.const._PS_SCENE_IMG_DIR_}ndkcf/pdf/0/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
			
			{capture name="htmlFile"}{$smarty.const._PS_SCENE_IMG_DIR_}ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}/{$customizationId|intval}/render.html{/capture}
			
			{capture name="recipientPdf"}{$smarty.const._PS_SCENE_IMG_DIR_}ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_WEB{$order->reference}.pdf{/capture}
			{capture name="recipientPdf_new"}{$smarty.const._PS_SCENE_IMG_DIR_}ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_{$customizationId}_WEB{$order->reference}.pdf{/capture}
