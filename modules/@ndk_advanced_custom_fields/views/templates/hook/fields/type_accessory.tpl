	...
	>{$field.name|escape:'htmlall'}
		...
		<div class="fieldPane clearfix">
			...
			<ul class="ndk_accessory_list">
				{include file='module:ndk_advanced_custom_fields/views/templates/hook/values/type_accessory.tpl'}
			</ul>
