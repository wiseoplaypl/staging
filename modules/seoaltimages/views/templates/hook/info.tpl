...
<div class="panel" id="fmm_promo_panel">
  <div class="col-lg-3">
    <ul>
      <li><a href="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/seoaltimages/readme_en.pdf" target="_blank" title="Need Help">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE887;</i>{else}<i class="icon-question-circle"></i>{/if}Help?</a></li>
      <li class="color_red"><a href="https://addons.prestashop.com/contact-form.php?id_product=00000" target="_blank" title="Need Support">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE0C6;</i>{else}<i class="icon-comments"></i>{/if}Support</a></li>
      <li class="color_blue"><a href="https://addons.prestashop.com" target="_blank" title="Need Details">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE8F4;</i>{else}<i class="icon-eye"></i>{/if}Details</a></li>
  ...
  <div class="col-lg-7 fmm_promo_modules">
    <ol>
      ...
      <li><a href="https://addons.prestashop.com/en/seo-natural-search-engine-optimization/17273-seo-optimizer-add-meta-sitemap-robots-url-redirect.html" target="_blank" title="Advance SEO"><img src="https://www.fmemodules.com/365-home_default/advance-seo.jpg" alt="" /><i>Advance SEO Module</i></a></li>
      <li><a href="https://addons.prestashop.com/en/url-redirects/21856-url-redirects-301-302-303-redirects-404-urls.html" target="_blank" title="URL Redirects"><img src="https://www.fmemodules.com/1352-home_default/prestashop-url-redirects-301-302-303.jpg" alt="" /><i>URL Redirects Module</i></a></li>
    </ol>
  </div>
