    ...
    <div class="col-md-6 clearfix">
      ...
      {block name='page_header_container'}
        {block name='page_header'}
          <h1 class="h1 prdouct-title mb-0" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
          <span style="opacity:0.6">Reference:</span> <span class="product-reference" style="font-weight:bold">{$product.reference}</span>
    ...
    {if $accessories}
      <section class="product-accessories section-margin-top clearfix">
        <div class="section-box clearfix">
          <h2 class="products-section-title"><span>{l s='Related Products' d='Shop.Theme.Catalog'}</span></h2>
          <div class="row">
