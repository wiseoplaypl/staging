        ...
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
            ...
            <div class="condition-label">
                  <label class="js-terms" for="conditions_to_approve[terms-and-conditions]"> I agree to the <a href="/content/terms-and-conditions-of-use" id="cta-terms-and-conditions-0">terms of service</a></label>
                {* $condition nofilter *}
            </div>
          </li>
        {/foreach}
