        ...
        <nav class="breadcrumb">
          <ol>
              ...
              <li>
                ...
                <span>{l s='All Post' d='ModulesSmartblogArchivecategory'}</span>
                </a>
              </li>
                {if $year}
                  <li>
...
{block name='page_content'}
    {capture name=path}<a href="{smartblog::GetSmartBlogLink('smartblog')|escape:'htmlall':'UTF-8'}">{l s='All Blog News' d='ModulesSmartblogArchivecategory'}</a>
         {if $title_category != ''}
        <span class="navigation-pipe">{$navigationPipe|escape:'htmlall':'UTF-8'}</span>{$title_category|escape:'htmlall':'UTF-8'}{/if}{/capture}
        {if $postcategory == ''}
                 <p class="error">{l s='No Post in Archive' d='ModulesSmartblogArchivecategory'}</p>
        {else}   
