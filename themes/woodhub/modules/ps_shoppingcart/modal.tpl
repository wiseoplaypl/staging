        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {/if}
              <p><span class="label">{l s='Total products:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="value">{$cart.subtotals.products.value}</span></p>
              <p><span class="label">{l s='Total shipping:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="value">{$cart.subtotals.shipping.value} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</span></p>
              {if $cart.subtotals.tax}
              	<p><span class="label">{$cart.subtotals.tax.label}</span>&nbsp;<span class="value">{$cart.subtotals.tax.value}</span></p>
              {/if}
              <p class="product-total"><span class="label">{l s='Total:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="value">{$cart.totals.total.value} {$cart.labels.tax_short}</span></p>
