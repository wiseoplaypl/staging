...
<section class="featured-products section-margin-top clearfix">
  <div class="container">
    <h2 class="h2 products-section-title">
      <span>{l s='Bestsellers' d='Shop.Theme.Catalog'}</span>
    </h2>
    <div class="row">
      ...
      <a class="all-product-link float-xs-left float-md-right h4 hidden-md-up hidden-sm-down" href="{$allBestSellers}">
