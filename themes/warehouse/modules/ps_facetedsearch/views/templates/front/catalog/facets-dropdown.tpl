  ...
  <div id="search_filters" class="dropdown-search-filters mt-4 mb-4">
    ...
    {foreach from=$displayedFacets item="facet"}
      <aside class="facet clearfix facet-dropdown dropdown">
          ...
          <h4 class="form-control facet-title facet-title-dropdown" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>{$facet.label}</span> <i class="fa fa-angle-down drop-icon" aria-hidden="true"></i></h4>
          {/if}
        ...
        {if in_array($facet.widgetType, ['radio', 'checkbox'])}
          {block name='facet_item_other'}
              <ul id="facet_{$_expand_id}" class="facet-type-{$facet.widgetType}{if isset($facet.filters[0].properties.color) || isset($facet.filters[0].properties.texture)} facet_color{/if} dropdown-menu dropdown-menu-facet">
