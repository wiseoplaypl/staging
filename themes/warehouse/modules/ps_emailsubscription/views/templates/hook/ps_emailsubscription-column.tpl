...
*}
    ...
    <div class="block block-toggle block-categories block-links js-block-toggle ps-emailsubscription-block">
        <h5 class="block-title"><span>{l s='Get our latest news and special sales' d='Shop.Theme.Global'}</span> </h5>
