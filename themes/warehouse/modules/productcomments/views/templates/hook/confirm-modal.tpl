      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-12  col-sm-12 post-comment-buttons">
            <button type="button" class="btn btn-secondary btn-comment-inverse btn-comment-huge refuse-button" data-bs-dismiss="modal" aria-label="{l s='No' d='Modules.Productcomments.Shop'}">
              {l s='No' d='Modules.Productcomments.Shop'}
            </button>
            <button type="button" class="btn btn-primary btn-comment btn-comment-huge confirm-button" data-bs-dismiss="modal" aria-label="{l s='Yes' d='Modules.Productcomments.Shop'}">
