                    ...
                    <label for="delivery_option_{$carrier.id}" class="col-sm-11 delivery-option-2">
                      <div class="row">
                        <div class="col-sm-5 col-xs-12">
                          <div class="row {if $carrier.logo} carrier-hasLogo{/if}">
                            {if $carrier.logo}
                            <div class="col-xs-3">
          ...
          <div class="order-options">
            ...
            {if $gift.allowed}
              <div class="mt-3">
                ...
                <div id="gift" class="collapse{if $gift.isGift} in show{/if} mt-2">
                  <label for="gift_message" class="text-muted">{l s='If you\'d like, you can add a note to the gift:' d='Shop.Theme.Checkout'}</label>
