            ...
            <div class="row no-gutters align-items-center row-mobile-header">
                ...
                <div id="mobile-btn-search" class="col col-auto col-mobile-btn col-mobile-btn-search">
                    <span  class="m-nav-btn" data-bs-toggle="dropdown" data-bs-display="static"><i class="fa fa-search" aria-hidden="true"></i>
                        <span>{l s='Search' d='Shop.Theme.Global'}</span></span>
                ...
                <div class="col col-auto col-mobile-btn col-mobile-btn-account">
                    <a href="{$urls.pages.my_account}" class="m-nav-btn" aria-label="{l s='Login' d='Shop.Theme.Global'}"><i class="fa fa-user" aria-hidden="true"></i>
                ...
                <div
                    ...
                    <div id="mobile-cart-wrapper">
                        <span id="mobile-cart-toogle" class="m-nav-btn" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown"><i class="fa fa-shopping-bag mobile-bag-icon" aria-hidden="true"><span id="mobile-cart-products-count" class="cart-products-count cart-products-count-btn">
                            ...
                            <span>{l s='Cart' d='Shop.Theme.Checkout'}</span></span>
                ...
                <div class="col col-auto col-mobile-btn col-mobile-btn-menu col-mobile-menu-{$iqitTheme.mm_type}">
                    <span class="m-nav-btn js-m-nav-btn-menu" data-bs-toggle="dropdown" data-bs-display="static"><i class="fa fa-bars" aria-hidden="true"></i>
                        <span>{l s='Menu' d='Shop.Theme.Global'}</span></span>
